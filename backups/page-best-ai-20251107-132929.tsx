...
// 1) Declare + export the data ONCE
export const blogPosts = [
  /* your existing array of post objects, including the last one whose body ends with:
     ` ... </p>` then closes the template literal `, then the object `}`, then the array `];`
  */
];

// 2) Page component is the default export
