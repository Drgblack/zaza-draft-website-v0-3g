...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: String.raw, extension tasks, and personalized feedback.</p>
    ...
    `,
    contentDe: String.raw, den Unterricht für unterschiedliche Lernende zu individualisieren – mit Hilfestellungen, Erweiterungsaufgaben und personalisiertem Feedback.</p>
