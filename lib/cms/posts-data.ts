...
<p>AI can help teachers differentiate instructionÃ¢â‚¬â€supporting students who need scaffolds, providing on-grade practice, and challenging advanced learners with extension tasksÃ¢â‚¬â€without multiplying planning time. This guide gives you a concrete, repeatable routine you can use this week.</p>
...
<ol>
  ...
  <li><strong>Coach the move:</strong> teach students how to move from Entry Ã¢â€ â€™ Core Ã¢â€ â€™ Stretch using your rubric language.</li>
...
<ul>
  ...
  <li>Pre-teach 3Ã¢â‚¬â€œ5 key words with examples and non-examples.</li>
...
<h2>Final thought</h2>
<p>Differentiation is a design choice, not three different lessons. With tight prompts and one shared rubric, AI helps you build just-right on-ramps and true stretchÃ¢â‚¬â€while you stay focused on feedback and relationships.</p>
`,
    contentDe: String.raw`<h2>EinfÃƒÂ¼hrung</h2>
<p>KI kann die Differenzierung im Unterricht erleichtern: Lernende mit UnterstÃƒÂ¼tzungsbedarf erhalten GerÃƒÂ¼ste, die Mitte der Klasse ÃƒÂ¼bt auf dem passenden Niveau, Fortgeschrittene bekommen herausfordernde Aufgaben Ã¢â‚¬â€œ ohne dass die Vorbereitungszeit explodiert. Diese Anleitung zeigt einen konkreten Ablauf, den Sie sofort einsetzen kÃƒÂ¶nnen.</p>
...
<ul>
  ...
  <li><strong>PrÃƒÂ¤zise Prompts Ã¢â€ â€™ brauchbare EntwÃƒÂ¼rfe:</strong> Zielgruppe, LÃƒÂ¤nge, Lesestufe, FachwÃƒÂ¶rter und Erfolgskriterien festlegen.</li>
...
<ol>
  ...
  <li><strong>ÃƒÅ“bergang lehren:</strong> Mit Rubrik-Sprache zeigen, wie man von Einstieg Ã¢â€ â€™ Kern Ã¢â€ â€™ Erweiterung wechselt.</li>
...
<ul>
  ...
  <li>3Ã¢â‚¬â€œ5 SchlÃƒÂ¼sselwÃƒÂ¶rter vorentlasten (Beispiele/Nicht-Beispiele).</li>
...
<p>Differenzierung bedeutet nicht drei separate Stunden, sondern kluge Varianten derselben Kompetenz. Mit prÃƒÂ¤zisen Prompts und einer gemeinsamen Rubrik liefert KI passende ZugÃƒÂ¤nge und echte Herausforderung Ã¢â‚¬â€œ Sie investieren Ihre Zeit in Feedback und Beziehung.</p>
`,
...
<p>Every student deserves materials they can access the first time they see themÃ¢â‚¬â€without waiting for a special version. This guide shows how to use AI to produce inclusive handouts, slides, and tasks in minutes: plain-language rewrites, dyslexia-friendly formats, visuals with alt text, translation notes, and choice-based assessments.</p>
...
<pre><code>Rewrite the following instructions in plain language for grades [xÃ¢â‚¬â€œy]. 
Ã¢â‚¬Â¢ Keep meaning the same. 
Ã¢â‚¬Â¢ Use short sentences, high-frequency words, and concrete verbs. 
Ã¢â‚¬Â¢ Add numbered steps with one action per step. 
Ã¢â‚¬Â¢ Provide 3 sentence starters and a worked example. 
Text: [paste]</code></pre>

<h2>Dyslexia-friendly formatting (what to ask AI for)</h2>
<ul class="blog-ul">
  <li class="blog-li">Use a sans-serif font, 12Ã¢â‚¬â€œ14pt equivalent, 1.5 line spacing.</li>
  <li class="blog-li">Left align; avoid full justification; keep line length ~60Ã¢â‚¬â€œ80 characters.</li>
...
Ã¢â‚¬Â¢ Short sentences, left-aligned bullets, clear headings. 
Ã¢â‚¬Â¢ Replace jargon; define key words with simple examples. 
Ã¢â‚¬Â¢ Output as sections: Title, Goal, Steps (numbered), Example, Vocabulary (student-friendly), Check for Understanding (3 items). 
Text: [paste]</code></pre>
...
Ã¢â‚¬Â¢ 1 sentence each, purpose-first, no Ã¢â‚¬Å“image ofÃ¢â‚¬Â phrasing. 
Ã¢â‚¬Â¢ Mention data labels if essential; omit if decorative. 
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Sentence frames:</strong> Offer 2Ã¢â‚¬â€œ3 per task level (Entry/Core/Stretch).</li>
</ul>

<h2>Prompt: bilingual handout pack</h2>
<pre><code>Translate and align this handout into [target language]. 
Ã¢â‚¬Â¢ Keep headings identical in both languages. 
Ã¢â‚¬Â¢ Add a bilingual glossary (10 terms) with part of speech and a simple example sentence. 
Ã¢â‚¬Â¢ Include sentence starters for describing, explaining, and comparing. 
...
Ã¢â‚¬Â¢ 3 tasks aligned to the same criteria. 
Ã¢â‚¬Â¢ Task A (Entry): guided fill-in with sentence starters. 
Ã¢â‚¬Â¢ Task B (Core): short written or labeled diagram. 
Ã¢â‚¬Â¢ Task C (Stretch): application or transfer to a new context. 
...
Ã¢â‚¬Â¢ Entry: 4thÃ¢â‚¬â€œ5th grade readability, definitions inline. 
Ã¢â‚¬Â¢ Core: grade-level, paragraphs under 6 lines. 
Ã¢â‚¬Â¢ Stretch: includes one counterexample and a why-it-matters paragraph. 
...
Ã¢â‚¬Â¢ Example 1: fully worked with callouts (why each step). 
Ã¢â‚¬Â¢ Example 2: partially worked; students complete 2 missing steps. 
...
<p><em>Design once, include everyone.</em> AI helps you generate accessible versions fastÃ¢â‚¬â€your expertise keeps them accurate, humane, and aligned to the goal.</p>
`,
contentDe: String.raw`
<h1>Mit KI inklusive Unterrichtsmaterialien erstellen</h1>
<p>Alle Lernenden sollen Materialien beim ersten Lesen verstehenÃ¢â‚¬â€ohne auf Sonderversionen warten zu mÃƒÂ¼ssen. Hier erfÃƒÂ¤hrst du, wie du mit KI in Minuten inklusive ArbeitsblÃƒÂ¤tter, Folien und Aufgaben erzeugst: Klartext-Fassungen, dyslexiefreundliche Formate, Bilder mit Alt-Text, ÃƒÅ“bersetzungshilfen und Wahlaufgaben mit gemeinsamer Bewertung.</p>

<h2>GrundsÃƒÂ¤tze (kompakt)</h2>
<ul class="blog-ul">
  <li class="blog-li"><strong>UDL als Standard:</strong> Mehrere ZugÃƒÂ¤nge, mehrere Ausdrucksformen, WahlmÃƒÂ¶glichkeiten.</li>
  <li class="blog-li"><strong>Klartext:</strong> Kurze SÃƒÂ¤tze, hÃƒÂ¤ufige WÃƒÂ¶rter, konkrete Verben.</li>
  <li class="blog-li"><strong>Chunking:</strong> ÃƒÅ“berschriften, AufzÃƒÂ¤hlungen, WeiÃƒÅ¸raum, eine Handlung pro Schritt.</li>
...
<pre><code>Formuliere diese Anleitung in klarer Sprache fÃƒÂ¼r Klassenstufe [xÃ¢â‚¬â€œy] um. 
Ã¢â‚¬Â¢ Bedeutung gleich lassen. 
Ã¢â‚¬Â¢ Kurze SÃƒÂ¤tze, hÃƒÂ¤ufige WÃƒÂ¶rter, konkrete Verben. 
Ã¢â‚¬Â¢ Nummerierte Schritte mit je einer Handlung. 
Ã¢â‚¬Â¢ 3 SatzanfÃƒÂ¤nge + ein durchgerechnetes Beispiel. 
Text: [einfÃƒÂ¼gen]</code></pre>

<h2>Dyslexiefreundlich (darauf achtet die KI)</h2>
<ul class="blog-ul">
  <li class="blog-li">Serifenlose Schrift, 12Ã¢â‚¬â€œ14pt, 1,5 Zeilenabstand.</li>
  <li class="blog-li">Links bÃƒÂ¼ndig; kein Blocksatz; ZeilenlÃƒÂ¤nge ca. 60Ã¢â‚¬â€œ80 Zeichen.</li>
  <li class="blog-li">Fettdruck statt Kursiv/KAPITÃƒâ€žLCHEN; Tabellen sparsam einsetzen.</li>
...
Ã¢â‚¬Â¢ Kurze SÃƒÂ¤tze, linksbÃƒÂ¼ndige Bullets, klare ÃƒÅ“berschriften. 
Ã¢â‚¬Â¢ FachwÃƒÂ¶rter ersetzen; SchlÃƒÂ¼sselbegriffe einfach erklÃƒÂ¤ren. 
Ã¢â‚¬Â¢ Gliedere in: Titel, Ziel, Schritte (nummeriert), Beispiel, Wortschatz (schÃƒÂ¼lernah), VerstÃƒÂ¤ndnis-Check (3 Items). 
Text: [einfÃƒÂ¼gen]</code></pre>

<h2>Visuelle StÃƒÂ¼tzen & Alt-Text</h2>
<p>FÃƒÂ¼ge bei Bildern kurzen Alt-Text hinzu, der den <em>Zweck</em> beschreibt (nicht die Deko).</p>
<pre><code>Erstelle Alt-Text fÃƒÂ¼r diese Bilder in einer Unterrichtsreihe zu AggregatzustÃƒÂ¤nden. 
Ã¢â‚¬Â¢ 1 Satz pro Bild, zweckorientiert, ohne Ã¢â‚¬Å¾Bild vonÃ¢â‚¬Å“. 
Ã¢â‚¬Â¢ Datenlabels nur nennen, wenn nÃƒÂ¶tig; Deko weglassen. 
Bilderliste: [beschreiben oder Dateinamen + Notizen]</code></pre>

<h2>Sprachbildung & Mehrsprachigkeit</h2>
<ul class="blog-ul">
  <li class="blog-li"><strong>Nebeneinander:</strong> Deutsch + Herkunftssprache mit identischen ÃƒÅ“berschriften.</li>
  <li class="blog-li"><strong>Wortschatz:</strong> Zweisprachiges Glossar mit Wortart und Beispielsatz.</li>
  <li class="blog-li"><strong>Satzstarter:</strong> 2Ã¢â‚¬â€œ3 pro Niveaustufe (Einstieg/Kern/Erweiterung).</li>
</ul>

<h2>Prompt: Zweisprachiges Paket</h2>
<pre><code>ÃƒÅ“bersetze und gleiche dieses Arbeitsblatt in [Zielsprache] ab. 
Ã¢â‚¬Â¢ ÃƒÅ“berschriften in beiden Sprachen identisch. 
Ã¢â‚¬Â¢ Zweisprachiges Glossar (10 Begriffe) mit Wortart + einfachem Beispielsatz. 
Ã¢â‚¬Â¢ Satzstarter zum Beschreiben, ErklÃƒÂ¤ren, Vergleichen. 
Gib zurÃƒÂ¼ck: DE-Version, [Sprache]-Version, Glossar-Tabelle, Starter-Liste.
Text: [einfÃƒÂ¼gen]</code></pre>
...
Ã¢â‚¬Â¢ 3 Aufgaben mit identischen Erfolgskriterien. 
Ã¢â‚¬Â¢ A (Einstieg): angeleitet mit Satzstartern. 
Ã¢â‚¬Â¢ B (Kern): kurzer Text oder beschriftetes Diagramm. 
Ã¢â‚¬Â¢ C (Erweiterung): Anwendung/Transfer. 
FÃƒÂ¼ge eine gemeinsame Rubric und kurze Bildbeschreibungen fÃƒÂ¼r AAC hinzu.</code></pre>

<h2>Lesestufen & GerÃƒÂ¼ste</h2>
<pre><code>Erzeuge drei Lesestufen zu diesem Text (~500 WÃƒÂ¶rter):
Ã¢â‚¬Â¢ Einstieg: 4.Ã¢â‚¬â€œ5. Klasse, Begriffe im Satz erklÃƒÂ¤rt. 
Ã¢â‚¬Â¢ Kern: Niveaustufe, AbsÃƒÂ¤tze unter 6 Zeilen. 
Ã¢â‚¬Â¢ Erweiterung: ein Gegenbeispiel + Ã¢â‚¬Å¾Darum ist es wichtigÃ¢â‚¬Å“-Absatz. 
Gib zurÃƒÂ¼ck: Titel, grobe Lesestufe, AbsÃƒÂ¤tze, je 3 VerstÃƒÂ¤ndnisfragen.</code></pre>

<h2>Barrierearme Folien</h2>
<ul class="blog-ul">
  <li class="blog-li">Eine ÃƒÅ“berschrift pro Folie; wenig Text; Lesereihenfolge prÃƒÂ¼fen.</li>
  <li class="blog-li">Bedeutung nie nur ÃƒÂ¼ber Farbe; Labels/Pattern nutzen.</li>
  <li class="blog-li">Videos untertiteln; Audios mit Transkript bereitstellen.</li>
</ul>

<h2>Prompt: Notizen + Transkript</h2>
<pre><code>Erzeuge aus dieser Folienstruktur (Gliederung einfÃƒÂ¼gen) PrÃƒÂ¤sentatornotizen in klarer Sprache und ein SchÃƒÂ¼ler-Handout mit denselben ÃƒÅ“berschriften. 
FÃƒÂ¼ge ein Transkript in Lesereihenfolge (oben Ã¢â€ â€™ unten) hinzu.</code></pre>
...
<ul class="blog-ul">
  ...
  <li class="blog-li">Hilfsmittel/Interaktiv-Ãƒâ€žquivalente; Achsen/Einheiten beschriften.</li>
  <li class="blog-li">Durchgerechnetes + teilweise gelÃƒÂ¶stes Beispiel mit Hinweisen.</li>
</ul>

<h2>Prompt: Beispiel-Paar</h2>
<pre><code>Erstelle zwei Beispiele fÃƒÂ¼r [Fertigkeit]. 
Ã¢â‚¬Â¢ Beispiel 1: durchgerechnet mit Hinweisen (Warum-Schritte). 
Ã¢â‚¬Â¢ Beispiel 2: teilweise gelÃƒÂ¶st; 2 Schritte fehlen. 
FÃƒÂ¼ge 3 Kurz-Checks und typische Fehler hinzu.</code></pre>

<h2>SchnellprÃƒÂ¼fung vor dem Teilen</h2>
<ul class="blog-ul">
  ...
  <li class="blog-li">Zweisprachige StÃƒÂ¼tze oder Herkunftssprache verfÃƒÂ¼gbar.</li>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Vorlage:</strong> Zweisprachiges Glossar (Begriff, Wortart, SchÃƒÂ¼lerbeispiel)</li>
  ...
  <li class="blog-li"><strong>Checkliste:</strong> Inklusive Materialien Ã¢â‚¬â€œ Kurzcheck</li>
</ul>

<h2>Heute ausprobieren (12 Minuten)</h2>
<ol class="blog-ol">
  <li class="blog-li-numbered">Ein Arbeitsblatt dieser Woche auswÃƒÂ¤hlen.</li>
  <li class="blog-li-numbered">Klartext-Prompt ausfÃƒÂ¼hren und einfÃƒÂ¼gen.</li>
  <li class="blog-li-numbered">Zwei Bilder mit Alt-Text + 3 Satzstarter ergÃƒÂ¤nzen.</li>
  <li class="blog-li-numbered">Zweisprachige Version erzeugen und im LMS teilen.</li>
  <li class="blog-li-numbered">Choice Board mit gemeinsamer Rubric verÃƒÂ¶ffentlichen.</li>
</ol>

<p><em>Einmal gestalten, alle mitnehmen.</em> KI liefert schnelle VersionenÃ¢â‚¬â€du sorgst fÃƒÂ¼r Richtigkeit, Fairness und Zielklarheit.</p>
`,
...
<h2>Step 1 Ã¢â‚¬â€ Collect quick evidence</h2>
<p>Skim your recent artifacts (2Ã¢â‚¬â€œ5 bullets max): quiz item, draft paragraph, exit ticket trend, observation note. Copy those bullets into the prompt so the model grounds to real work.</p>

<h2>Step 2 Ã¢â‚¬â€ Draft with a tone primer</h2>
...
<strong>Next steps:</strong> 2Ã¢â‚¬â€œ3 concrete actions (teacher + student), each 10Ã¢â‚¬â€œ14 words.
CONSTRAINTS: Avoid vague adjectives. Use student-friendly words. Keep to ~120Ã¢â‚¬â€œ150 words.</code></pre>

<h2>Step 3 Ã¢â‚¬â€ Personalize and anchor to examples</h2>
...
<h2>Step 4 Ã¢â‚¬â€ Translate/Plain-language add-on (optional)</h2>
...
<h2>Micro-case</h2>
<p><strong>Context:</strong> Grade 8 science lab reports. <strong>Problem:</strong> Reports were inconsistent and took 12Ã¢â‚¬â€œ15 mins each. <strong>Change:</strong> Using the template + prompts above with 3 evidence bullets. <strong>Result:</strong> Drafts in 3Ã¢â‚¬â€œ4 mins, final in 6Ã¢â‚¬â€œ7 mins, tone stayed warm and specific.</p>
...
<pre><code>Make 3 bullets from my notes that are <em>observable</em> (no labels), each 6Ã¢â‚¬â€œ10 words:
...
<p>Kurze, evidenzbasierte Berichte entstehen in wenigen Minuten, wenn du eine klare Vorlage mit prÃƒÂ¤zisen Prompts kombinierst. Ziel ist nicht, dass Ã¢â‚¬Å¾die KI sprichtÃ¢â‚¬Å“, sondern dass sie das <em>Entwerfen</em> beschleunigtÃ¢â‚¬â€deine fachliche Entscheidung bleibt maÃƒÅ¸geblich.</p>
...
<h2>Schritt 1 Ã¢â‚¬â€ Kurze Evidenz sammeln</h2>
<p>2Ã¢â‚¬â€œ5 Stichpunkte aus aktuellen Arbeiten: Testaufgabe, Textauszug, Exit-Ticket-Trend, Beobachtung. Diese Stichpunkte in den Prompt kopierenÃ¢â‚¬â€so bleibt der Text am echten Lernprodukt.</p>

<h2>Schritt 2 Ã¢â‚¬â€ Entwurf mit Ton-Primer</h2>
...
<strong>NÃƒÂ¤chste Schritte:</strong> 2Ã¢â‚¬â€œ3 konkrete Aktionen (Lehrkraft + SchÃƒÂ¼ler), je 10Ã¢â‚¬â€œ14 WÃƒÂ¶rter.
REGELN: Keine vagen Adjektive. SchÃƒÂ¼lergerechte Sprache. ~120Ã¢â‚¬â€œ150 WÃƒÂ¶rter.</code></pre>

<h2>Schritt 3 Ã¢â‚¬â€ Personalisieren & Beispiele einfÃƒÂ¼gen</h2>
...
<h2>Schritt 4 Ã¢â‚¬â€ ÃƒÅ“bersetzung/Klartext (optional)</h2>
...
<h2>Mikro-Fall</h2>
<p><strong>Kontext:</strong> Naturwissenschaft 8. Klasse. <strong>Problem:</strong> 12Ã¢â‚¬â€œ15 Min. pro Bericht. <strong>Umstellung:</strong> Vorlage + Prompts mit 3 Evidenz-Stichpunkten. <strong>Ergebnis:</strong> Entwurf 3Ã¢â‚¬â€œ4 Min., final 6Ã¢â‚¬â€œ7 Min., Ton blieb warm und spezifisch.</p>
...
<pre><code>Forme aus meinen Notizen 3 <em>beobachtbare</em> Stichpunkte (keine Etiketten), 6Ã¢â‚¬â€œ10 WÃƒÂ¶rter:
...
<p><em>Fazit:</em> KI beschleunigt den EntwurfÃ¢â‚¬â€du bringst Urteilskraft, Menschlichkeit und Standard-Bezug ein.</p>
    `,
...
<p>AI can speed up planning, feedback, and communicationÃ¢â‚¬â€but only if we protect student data. This guide gives you a clear, teacher-friendly workflow to use AI responsibly: what to share, what to never paste, how to de-identify, how to vet a vendor, and copy-paste templates for notices and requests.</p>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Yellow (needs de-identification + caution):</strong> student work excerpts, parent messages, behavior scenariosÃ¢â‚¬â€only after removing direct/indirect identifiers.</li>
...
<ol class="blog-ol">
  ...
  <li class="blog-li-numbered">Incident response: 24Ã¢â‚¬â€œ72h notice SLA? Named contact? Root-cause reports?</li>
...
<h2>Final thought</h2>
<p>Use AI for patterns and planningÃ¢â‚¬â€never for raw student identities. De-identify, minimize, and use approved tools so you gain time without increasing risk.</p>
    `,
    contentDe: String.raw`
<h1>SchÃƒÂ¼lerdaten schÃƒÂ¼tzen beim Einsatz von KI-Tools</h1>
<p>KI beschleunigt Planung, Feedback und KommunikationÃ¢â‚¬â€aber nur, wenn wir SchÃƒÂ¼lerdaten wirksam schÃƒÂ¼tzen. Dieser Leitfaden zeigt einen klaren, praxisnahen Ablauf: Was darf hinein, was niemals; wie man Texte anonymisiert; wie man Anbieter prÃƒÂ¼ft; plus Vorlagen fÃƒÂ¼r Elterninfo und Anfragen.</p>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Gelb (nur anonymisiert):</strong> SchÃƒÂ¼lertexte, Elternmails, VerhaltensszenarienÃ¢â‚¬â€erst nach Entfernen direkter/indirekter Identifikatoren.</li>
...
<ol class="blog-ol">
  ...
  <li class="blog-li-numbered">Vorfallmanagement: Meldung binnen 24Ã¢â‚¬â€œ72 h, fester Kontakt, Ursachenanalyse?</li>
...
<ul class="blog-ul">
  <li class="blog-li">Namen Ã¢â€ â€™ neutrale Labels (SchÃƒÂ¼ler A/B).</li>
  <li class="blog-li">Daten Ã¢â€ â€™ relative Angaben (Ã¢â‚¬Å¾letzte WocheÃ¢â‚¬Å“).</li>
  <li class="blog-li">Orte Ã¢â€ â€™ generische Begriffe (Ã¢â‚¬Å¾MensaÃ¢â‚¬Å“).</li>
...
Liebe Familien,
Wir nutzen gelegentlich KI-Tools, um Unterrichtsmaterial und Feedback schneller zu erstellen. Wir laden keine Namen, IDs, Kontaktdaten, FÃƒÂ¶rder-/Gesundheitsdaten oder Fotos hoch. Bei Analysen von Texten entfernen wir alle PersonenbezÃƒÂ¼ge (z. B. Ã¢â‚¬Å¾SchÃƒÂ¼ler AÃ¢â‚¬Å“). Freigegebene Systeme und Einstellungen verhindern, dass Daten ÃƒÂ¶ffentliche Modelle trainieren. Bei Fragen melden Sie sich gernÃ¢â‚¬â€ich erklÃƒÂ¤re unsere SchutzmaÃƒÅ¸nahmen.
...
<ol class="blog-ol">
  ...
  <li class="blog-li-numbered"><strong>Dokumentieren:</strong> Was, wann, wo, werÃ¢â‚¬â€kurz festhalten.</li>
...
<h2>Schlussgedanke</h2>
<p>Nutze KI fÃƒÂ¼r Muster und PlanungÃ¢â‚¬â€nicht fÃƒÂ¼r Rohdaten mit Personenbezug. Anonymisieren, minimieren, genehmigte Tools verwendenÃ¢â‚¬â€so gewinnst du Zeit ohne zusÃƒÂ¤tzliches Risiko.</p>
    `,
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Small:</strong> Takes 2Ã¢â‚¬â€œ3 minutes to complete; 30Ã¢â‚¬â€œ60 seconds to scan.</li>
...
<h2>Prompt 1 Ã¢â‚¬â€ Draft a 3-question exit ticket for todayÃ¢â‚¬â„¢s objective</h2>
...
Ã¢â‚¬Â¢ 1 self-rating (confidence 1Ã¢â‚¬â€œ4) that names the skill in student-friendly language.
Return items and an answer key. Avoid jargon.</code></pre>

<h2>Prompt 2 Ã¢â‚¬â€ Turn todayÃ¢â‚¬â„¢s worked example into a quick CFU</h2>
...
<h2>Prompt 3 Ã¢â‚¬â€ Catch the most likely misconception</h2>
...
<h2>Prompt 4 Ã¢â‚¬â€ Make it language-aware (supports multilingual learners)</h2>
...
<h2>Prompt 5 Ã¢â‚¬â€ Build tomorrowÃ¢â‚¬â„¢s small groups automatically</h2>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Self-rating:</strong> I can solve two-step equations (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Self-rating:</strong> I can explain energy changes during melting (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Self-rating:</strong> I can explain theme with evidence (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Self-rating:</strong> I can evaluate a sourceÃ¢â‚¬â„¢s reliability (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Self-rating:</strong> I can form the past tense (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  <li class="blog-li"><strong>Group A (Reteach):</strong> missed MCQ or confidence Ã¢â€°Â¤2; run the 20-second reteach plus a guided example.</li>
  <li class="blog-li"><strong>Group B (Practice):</strong> mixed performance; assign 2Ã¢â‚¬â€œ3 near-transfer problems with feedback.</li>
  <li class="blog-li"><strong>Group C (Extend):</strong> correct + confidence Ã¢â€°Â¥3; give an application or challenge task.</li>
</ul>

<h2>Templates you can copy</h2>
<h3>3-Item Exit Ticket (universal)</h3>
<pre><code>1) MCQ (common misconception)
2) Explain your reasoning (1Ã¢â‚¬â€œ2 sentences)
3) Confidence check (I can [skill] 1Ã¢â‚¬â€œ4)</code></pre>
...
Q3 (Confidence 1Ã¢â‚¬â€œ4): [I canÃ¢â‚¬Â¦ statement]</code></pre>
...
<p>Exit Tickets prÃƒÂ¼fen das VerstÃƒÂ¤ndnis in den letzten 3Ã¢â‚¬â€œ5 Minuten. Mit KI erzeugst du gezielte Checks, die zum Lernziel passen, typische Fehlvorstellungen sichtbar machen und dir morgen beim Gruppieren helfen. Nutze die Prompts und Vorlagen unten: kurz, auswertbar, handlungsleitend.</p>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Kurz:</strong> 2Ã¢â‚¬â€œ3 Minuten Bearbeitung, 30Ã¢â‚¬â€œ60 Sekunden Auswertung.</li>
...
<h2>Prompt 1 Ã¢â‚¬â€ 3-Fragen-Ticket zum Tagesziel</h2>
...
Ã¢â‚¬Â¢ 1 Kurzantwort (1Ã¢â‚¬â€œ2 SÃƒÂ¤tze), in der Lernende ihre BegrÃƒÂ¼ndung erklÃƒÂ¤ren.
Ã¢â‚¬Â¢ 1 SelbsteinschÃƒÂ¤tzung (1Ã¢â‚¬â€œ4) mit schÃƒÂ¼lernaher Ich-Kann-Formulierung.
Gib Aufgaben und LÃƒÂ¶sungsschlÃƒÂ¼ssel zurÃƒÂ¼ck. Keine Fachjargon.</code></pre>

<h2>Prompt 2 Ã¢â‚¬â€ Aus dem Musterbeispiel ein CFU bauen</h2>
...
<h2>Prompt 3 Ã¢â‚¬â€ HÃƒÂ¤ufigste Fehlvorstellung abfangen</h2>
...
<h2>Prompt 4 Ã¢â‚¬â€ Sprachsensibel (mehrsprachige Lernende)</h2>
...
<h2>Prompt 5 Ã¢â‚¬â€ Morgen automatisch gruppieren</h2>
...
<ul class="blog-ul">
  <li class="blog-li"><strong>MC:</strong> Erster Schritt bei 3x + 5 = 17? <em>Verlockender Ablenker:</em> 17 Ã¢Ë†â€™ 3x (Operationen verwechselt).</li>
  <li class="blog-li"><strong>Kurzantwort:</strong> Warum zuerst 5 subtrahieren, bevor geteilt wird?</li>
  <li class="blog-li"><strong>SelbsteinschÃƒÂ¤tzung:</strong> Ich kann Zweischritt-Gleichungen lÃƒÂ¶sen (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>SelbsteinschÃƒÂ¤tzung:</strong> Ich kann EnergieÃƒÂ¤nderungen beim Schmelzen erklÃƒÂ¤ren (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>SelbsteinschÃƒÂ¤tzung:</strong> Ich kann ein Thema mit Belegen erklÃƒÂ¤ren (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>SelbsteinschÃƒÂ¤tzung:</strong> Ich kann die VerlÃƒÂ¤sslichkeit einer Quelle bewerten (1Ã¢â‚¬â€œ4).</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>SelbsteinschÃƒÂ¤tzung:</strong> Ich kann die Vergangenheitsform bilden (1Ã¢â‚¬â€œ4).</li>
</ul>

<h2>Schnell auswerten & gruppieren</h2>
<ul class="blog-ul">
  <li class="blog-li"><strong>Gruppe A (Reteach):</strong> MC falsch oder Selbstwert Ã¢â€°Â¤2; 20-Sekunden-ErklÃƒÂ¤rung + angeleitete Aufgabe.</li>
  <li class="blog-li"><strong>Gruppe B (ÃƒÅ“ben):</strong> gemischte Leistung; 2Ã¢â‚¬â€œ3 Nahtransfer-Aufgaben mit Feedback.</li>
  <li class="blog-li"><strong>Gruppe C (Erweitern):</strong> korrekt + Selbstwert Ã¢â€°Â¥3; Anwendungs- oder Knobelaufgabe.</li>
</ul>

<h2>Vorlagen zum Kopieren</h2>
<h3>3-Teile-Exit-Ticket (universal)</h3>
<pre><code>1) MC (hÃƒÂ¤ufige Fehlvorstellung)
2) BegrÃƒÂ¼ndung (1Ã¢â‚¬â€œ2 SÃƒÂ¤tze)
3) Ich-Kann-Check (1Ã¢â‚¬â€œ4)</code></pre>
...
F3 (Selbstwert 1Ã¢â‚¬â€œ4): [Ich kann Ã¢â‚¬Â¦]</code></pre>
...
<p>Good rubrics make grading faster, feedback clearer, and revision purposeful. This guide gives you ship-ready rubric patterns and copy-paste prompts to generate, refine, and apply rubrics with AIÃ¢â‚¬â€without losing your professional judgment.</p>
...
<h2>Analytic rubric example (Argument paragraph, Grades 6Ã¢â‚¬â€œ9)</h2>
<table>
  <thead>
    <tr>
...
<pre><code>From this rubric, create 6 Ã¢â‚¬Å“GlowÃ¢â‚¬â€œGrowÃ¢â‚¬â€œGoÃ¢â‚¬Â comment tiles that name the criterion and suggest one concrete next action. Student-friendly language. 2 sentences max per tile.</code></pre>
...
Ã¢â‚¬Å“From standard [paste], produce 3Ã¢â‚¬â€œ4 observable criteria with verbs a teacher can see.Ã¢â‚¬Â
...
5) Comment tiles
Ã¢â‚¬Å“From this rubric, output 8 GlowÃ¢â‚¬â€œGrowÃ¢â‚¬â€œGo tiles that each name a criterion and give one next step.Ã¢â‚¬Â</code></pre>
...
<p><em>AI drafts; teacher crafts.</em> Let the model build structure and phrasingÃ¢â‚¬â€your expertise sets the criteria, examples, and boundaries.</p>
    `,
    contentDe: String.raw`
<h1>Prompts fÃƒÂ¼r bessere Bewertungsraster (Rubrics)</h1>
<p>Gute Rubrics machen Bewertung schneller, Feedback klarer und ÃƒÅ“berarbeitung zielgerichtet. Dieser Leitfaden liefert dir einsatzfertige Raster-Muster und Copy-Paste-Prompts, mit denen du Rubrics per KI entwirfst, verfeinerst und anwendestÃ¢â‚¬â€ohne deine professionelle Beurteilung aus der Hand zu geben.</p>
...
<h2>Beispiel (Argumentationsabsatz, Klassen 6Ã¢â‚¬â€œ9)</h2>
<table>
  <thead>
    <tr>
...
<pre><code>Aus diesem Standard [einfÃƒÂ¼gen] 3Ã¢â‚¬â€œ4 beobachtbare Kriterien ableiten. Verben verwenden, die man sieht (benennen, zitieren, erklÃƒÂ¤ren...).</code></pre>
...
<pre><code>Erzeuge aus dieser Rubric 6 Ã¢â‚¬Å“GlanzÃ¢â‚¬â€œWachstumÃ¢â‚¬â€œNÃƒÂ¤chster SchrittÃ¢â‚¬Â-Kacheln. Nenne jeweils das Kriterium und schlage eine konkrete nÃƒÂ¤chste Handlung vor. Maximal 2 SÃƒÂ¤tze pro Kachel.</code></pre>
...
3) Standard Ã¢â€ â€™ Kriterien
Ã¢â‚¬Å¾Aus Standard [einfÃƒÂ¼gen] 3Ã¢â‚¬â€œ4 beobachtbare Kriterien mit Verben bilden.Ã¢â‚¬Å“

4) Ein-Punkt-Rubric
Ã¢â‚¬Å¾Ein-Punkt-Rubric mit Ziel-Spalte und leeren Notizspalten Ã¢â‚¬Å¡Unter/ÃƒÅ“ber ZielÃ¢â‚¬Ëœ erstellen.Ã¢â‚¬Å“

5) Kommentar-Kacheln
Ã¢â‚¬Å¾Aus dieser Rubric 8 GlanzÃ¢â‚¬â€œWachstumÃ¢â‚¬â€œNÃƒÂ¤chster Schritt-Kacheln mit einer konkreten nÃƒÂ¤chsten Handlung generieren.Ã¢â‚¬Å“</code></pre>
...
<p><em>KI entwirft; Lehrkraft gestaltet.</em> Die Maschine liefert StrukturÃ¢â‚¬â€du setzt Kriterien, Beispiele und Grenzen.</p>
    `,
...
<p>When time is short, you need a fast way to see which skills most students are missingÃ¢â‚¬â€decoding, fluency, vocabulary, or evidence-based writing. This workflow turns small artifacts into clear patterns you can teach the next day.</p>
...
<h2>Quick data sources (pick 1Ã¢â‚¬â€œ2)</h2>
<ul class="blog-ul">
  <li class="blog-li">30Ã¢â‚¬â€œ60 word cold read with one question.</li>
  <li class="blog-li">Sentence-combining or cloze item (vocabulary/structure).</li>
  <li class="blog-li">3Ã¢â‚¬â€œ4 sentence written response with a quote.</li>
...
[Paste 8Ã¢â‚¬â€œ25 brief samples separated by ---]
TASKS:
1) Cluster students by the FIRST limiting skill (decoding, fluency, vocabulary, comprehension, evidence-based writing).
2) For each cluster list 2Ã¢â‚¬â€œ3 <em>observable features</em> from the samples.
3) Recommend a 10Ã¢â‚¬â€œ12 minute mini-lesson with a concrete routine and example.
...
B     | Evidence       | Quote missing or not linked | Two-column Ã¢â‚¬Å“claim Ã¢â€ â€™ quote Ã¢â€ â€™ becauseÃ¢â‚¬Â drill
...
<ul class="blog-ul">
  <li class="blog-li">Blend drill with target pattern (e.g., CVCe Ã¢â€ â€™ <em>make, time, late</em>).</li>
...
<ul class="blog-ul">
  ...
  <li class="blog-li">Do examples quote studentsÃ¢â‚¬â„¢ words or textÃ¢â‚¬â€not impressions?</li>
...
<p><em>Bottom line:</em> Small samples Ã¢â€ â€™ clear clusters Ã¢â€ â€™ tiny lessons that move the needle this week.</p>
    `,
    contentDe: String.raw`
<h1>Mit KI LernlÃƒÂ¼cken in der LesefÃƒÂ¶rderung schnell erkennen</h1>
<p>Wenn Zeit knapp ist, brauchst du einen schnellen Blick darauf, welche Fertigkeiten fehlenÃ¢â‚¬â€Dekodieren, FlÃƒÂ¼ssigkeit, Wortschatz oder evidenzbasiertes Schreiben. Dieser Ablauf macht aus kleinen Arbeitsproben klare Muster fÃƒÂ¼r den Unterricht am nÃƒÂ¤chsten Tag.</p>
...
<h2>Schnelle Datenquellen (1Ã¢â‚¬â€œ2 wÃƒÂ¤hlen)</h2>
<ul class="blog-ul">
  <li class="blog-li">30Ã¢â‚¬â€œ60 WÃƒÂ¶rter Lautlesen mit einer Frage.</li>
  <li class="blog-li">Satz verbinden oder LÃƒÂ¼ckentext (Wortschatz/Struktur).</li>
  <li class="blog-li">3Ã¢â‚¬â€œ4 SÃƒÂ¤tze Schreibantwort mit Zitat.</li>
  <li class="blog-li">HÃƒÂ¤ufigkeitswort-Probe (Primar) oder Morphem-Sort (Sek I/II).</li>
</ul>

<h2>Kern-Analyse-Prompt</h2>
<pre><code>ROLLE: Literacy-Coach. Analysiere Proben, um Muster zu erkennenÃ¢â‚¬â€ohne zu benoten.
EINGABE: Klasse [X], Textniveau [Y]. Proben:
[8Ã¢â‚¬â€œ25 Kurzproben, getrennt durch ---]
AUFTRÃƒâ€žGE:
...
2) FÃƒÂ¼r jedes Cluster 2Ã¢â‚¬â€œ3 <em>beobachtbare Merkmale</em> nennen.
3) Eine 10Ã¢â‚¬â€œ12-Minuten-Mini-Lektion mit Routine und Beispiel vorschlagen.
...
B      | Evidenz    | Zitat fehlt/ohne VerknÃƒÂ¼pfung | Tabelle Ã¢â‚¬Å¾Behauptung Ã¢â€ â€™ Zitat Ã¢â€ â€™ weilÃ¢â‚¬Å“
...
<ul class="blog-ul">
  <li class="blog-li">Blend-Drill mit Zielmuster (z. B. CVCe Ã¢â€ â€™ <em>miete, Rate, Sekunde</em> je nach Sprache).</li>
...
<p><em>Fazit:</em> Kleine Proben Ã¢â€ â€™ klare Cluster Ã¢â€ â€™ kurze Lektionen, die diese Woche Wirkung zeigen.</p>
    `,
...
<p>When time is tight, small wins compound. These five workflows convert repetitive tasks into fast, reliable routinesÃ¢â‚¬â€while keeping your professional judgment at the center.</p>
...
CONSTRAINTS: 80Ã¢â‚¬â€œ120 words total; avoid labels; use examples from the sample.</code></pre>
...
<h3>Micro-case</h3>
<p>Grade 8 essays: 26 students, 35 minutes to paste and batch. Editing + posting to LMS: 25 minutes. Time saved Ã¢â€°Ë† 2.5 hours vs. writing from scratch.</p>
...
<h3>Starter prompt</h3>
<pre><code>ROLE: Family liaison. Write a 90Ã¢â‚¬â€œ130 word parent summary.
EVIDENCE BULLETS: [3Ã¢â‚¬â€œ4 bullets].
...
<p>Generate aligned quizzes, tasks, and rubricsÃ¢â‚¬â€then trim and localize.</p>
...
Constraints: 35Ã¢â‚¬â€œ60 words; neutral tone; no labels; include 1 concrete action.</code></pre>
...
<h2>Extended checklist Ã¢â‚¬â€œ protect quality</h2>
<ul class="blog-ul">
...
<p>Kleine Zeitgewinne summieren sich. Diese fÃƒÂ¼nf Workflows verwandeln wiederkehrende Aufgaben in schnelle, verlÃƒÂ¤ssliche RoutinenÃ¢â‚¬â€mit deiner professionellen Haltung im Mittelpunkt.</p>
...
REGELN: 80Ã¢â‚¬â€œ120 WÃƒÂ¶rter; keine Etiketten; Beispiele aus der Probe nutzen.</code></pre>
...
<h3>Mikro-Fall</h3>
<p>Klasse 8 Essays: EinfÃƒÂ¼gen + Batch 35 Min. Redigieren + LMS 25 Min. Zeitgewinn Ã¢â€°Ë† 2,5 h.</p>
...
<h3>Starter-Prompt</h3>
<pre><code>ROLLE: Schul-Eltern-Liaison. Schreibe 90Ã¢â‚¬â€œ130 WÃƒÂ¶rter.
EVIDENZ: [3Ã¢â‚¬â€œ4 Stichpunkte].
...
<p>Ausgerichtete Quizzes, Aufgaben und Rubriken generierenÃ¢â‚¬â€danach kÃƒÂ¼rzen und anpassen.</p>
...
Regeln: 35Ã¢â‚¬â€œ60 WÃƒÂ¶rter; neutral; 1 konkrete Aktion angeben.</code></pre>
...
<p><em>Fazit:</em> Entwurf automatisieren, Botschaft personalisierenÃ¢â‚¬â€Zeit zurÃƒÂ¼ck in die Lernbegleitung.</p>
    `,
...
<p>When a behavior issue pops up, your first moveÃ¢â‚¬â€<em>call or email</em>Ã¢â‚¬â€shapes tone, trust, and follow-through. Use this field-tested decision tree, scripts, and follow-up routine to keep each contact calm, respectful, and actionable.</p>

<h2>The 60-Second Decision Tree</h2>
<p><strong>Ask:</strong> What outcome do I need in the next 24 hours?</p>
<ul class="blog-ul">
  <li class="blog-li"><strong>Safety or urgent disruption today?</strong> Ã¢â€ â€™ <strong>CALL</strong> now. Then send a 2-line recap email for the record.</li>
  <li class="blog-li"><strong>Pattern forming</strong> (2Ã¢â‚¬â€œ3 repeats) or tone likely to be misread? Ã¢â€ â€™ <strong>CALL</strong> first to align on facts/feelings, then recap by email.</li>
  <li class="blog-li"><strong>Minor first incident</strong> with a clear next step, no urgency? Ã¢â€ â€™ <strong>EMAIL</strong> with one fact + one next step + a check-in date.</li>
  <li class="blog-li"><strong>Need a searchable paper trail</strong> (plans, accommodations, previous contacts)? Ã¢â€ â€™ <strong>EMAIL</strong> (you can still call), documentation matters.</li>
  <li class="blog-li"><strong>Language/access needs</strong> (parent prefers phone, interpreter needed)? Ã¢â€ â€™ <strong>CALL</strong> (use interpreter), then send a brief bilingual recap.</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Offer choice:</strong> Ã¢â‚¬Å“We can try A or BÃ¢â‚¬â€what feels workable?Ã¢â‚¬Â</li>
...
<pre><code>Subject: Quick update about [Student] Ã¢â‚¬â€œ [Class/Date]
Hi [Parent],
...
Hi [Parent],
IÃ¢â‚¬â„¢ve noticed this pattern over [timeframe]: [2Ã¢â‚¬â€œ3 specific observations]. My goal is to support [Student] to [desired skill].
...
<pre><code>Subject: Thanks for speaking today Ã¢â‚¬â€œ recap for our records
...
<p><em>Bottom line:</em> Call to align humans, email to preserve the recordÃ¢â‚¬â€both in service of the student.</p>
  `,
    contentDe: String.raw`
<h1>Anruf oder E-Mail? Den richtigen Kanal bei Verhaltensfragen wÃƒÂ¤hlen</h1>
<p>Bei einem Vorfall entscheidet der erste SchrittÃ¢â‚¬â€<em>Anruf oder E-Mail</em>Ã¢â‚¬â€ÃƒÂ¼ber Ton, Vertrauen und Umsetzung. Mit diesem Entscheidungsbaum, Skripten und Follow-up-Routine bleiben Kontakte ruhig, respektvoll und wirksam.</p>
...
<ul class="blog-ul">
  <li class="blog-li"><strong>Sicherheit oder akute StÃƒÂ¶rung heute?</strong> Ã¢â€ â€™ <strong>ANRUF</strong> jetzt. Danach 2-Zeilen-Zusammenfassung per E-Mail fÃƒÂ¼r die Akte.</li>
  <li class="blog-li"><strong>Sich bildendes Muster</strong> (2Ã¢â‚¬â€œ3 Wiederholungen) oder Ton leicht missverstÃƒÂ¤ndlich? Ã¢â€ â€™ Zuerst <strong>ANRUF</strong> zur Abstimmung, danach kurze E-Mail.</li>
  <li class="blog-li"><strong>Kleiner Erstvorfall</strong> mit klarem nÃƒÂ¤chsten Schritt, keine Dringlichkeit? Ã¢â€ â€™ <strong>E-MAIL</strong> mit einer Tatsache + einem Schritt + Kontrolltermin.</li>
  <li class="blog-li"><strong>Durchsuchbare Dokumentation nÃƒÂ¶tig</strong> (PlÃƒÂ¤ne, Nachteilsausgleiche, frÃƒÂ¼here Kontakte)? Ã¢â€ â€™ <strong>E-MAIL</strong> (Anruf optional), Dokumentation zÃƒÂ¤hlt.</li>
  <li class="blog-li"><strong>Sprache/Zugang</strong> (Telefon bevorzugt, Dolmetschung nÃƒÂ¶tig)? Ã¢â€ â€™ <strong>ANRUF</strong> mit Dolmetscher, danach kurze zweisprachige Zusammenfassung.</li>
</ul>
...
<ul class="blog-ul">
  ...
  <li class="blog-li"><strong>Wahl anbieten:</strong> Ã¢â‚¬Å¾Wir kÃƒÂ¶nnen A oder B versuchenÃ¢â‚¬â€was passt besser?Ã¢â‚¬Å“</li>
...
<pre><code>Betreff: Kurzes Update zu [SchÃƒÂ¼ler] Ã¢â‚¬â€œ [Fach/Datum]
Guten Tag [Eltern],
...
Guten Tag [Eltern],
ÃƒÂ¼ber [Zeitraum] sehe ich dieses Muster: [2Ã¢â‚¬â€œ3 konkrete Beobachtungen]. Ziel ist, [SchÃƒÂ¼ler] bei [Fertigkeit] zu unterstÃƒÂ¼tzen.
...
<pre><code>Betreff: Danke fÃƒÂ¼r das GesprÃƒÂ¤ch Ã¢â‚¬â€œ kurze Zusammenfassung
...
<ul class="blog-ul">
  ...
  <li class="blog-li">Nie Ã¢â‚¬Å¾immer/nieÃ¢â‚¬Å“Ã¢â‚¬â€lieber aktuelle, beobachtbare Beispiele.</li>
...
<p><em>Fazit:</em> Telefonate stimmen Menschen ab, E-Mails sichern die AkteÃ¢â‚¬â€beides im Dienst des Kindes.</p>
  `,
  ...
  },
  {
    ...
    <p>Lesson planning is one of the most time-heavy and repetitive tasks teachers face. Every lesson must align with curriculum standards, engage diverse learners, and include assessmentsÃ¢â‚¬â€all while fitting into tight schedules. AI-powered lesson planning tools are now helping teachers design structured, creative, and standards-aligned lessons in minutes instead of hours.</p>

    <!-- PULL_QUOTE -->
    <p><strong>Key idea:</strong> The best AI lesson planning tools don't replace teacher creativityÃ¢â‚¬â€they provide the scaffolding that makes high-quality planning faster and more sustainable.</p>
    <!-- /PULL_QUOTE -->
    ...
    <h2>Bonus template pack Ã¢â‚¬â€œ lesson planning prompts</h2>
    <!-- CALLOUT:TEMPLATE -->
    <ul>
    ...
    <h2>Extended checklist Ã¢â‚¬â€œ AI lesson planning workflow</h2>
    <ul>
      <li>Ã¢Å“â€ Choose one subject and week to trial AI lesson planning.</li>
      <li>Ã¢Å“â€ Generate 3 draft lessons with objectives and timing.</li>
      <li>Ã¢Å“â€ Check drafts against curriculum standards.</li>
      <li>Ã¢Å“â€ Adapt drafts for different student groups.</li>
      <li>Ã¢Å“â€ Track time saved and student outcomes over a term.</li>
    </ul>

    <!-- CALLOUT:TIME_SAVER -->
    <p>Pro tip: If AI saves 5 hours a week on planning, that's 180+ hours per yearÃ¢â‚¬â€the equivalent of nearly a month of extra time.</p>
    <!-- /CALLOUT:TIME_SAVER -->
  ...
  `,
    ...
    <!-- PULL_QUOTE -->
    <p><strong>Kernaussage:</strong> Die besten KI-Tools ersetzen nicht die KreativitÃƒÂ¤tÃ¢â‚¬â€sie liefern das GerÃƒÂ¼st fÃƒÂ¼r schnelle, hochwertige Planung.</p>
    <!-- /PULL_QUOTE -->
    ...
    <ul>
      ...
      <li><strong>Wiederholung:</strong> Ãƒâ€žhnliche Stunden jedes Jahr.</li>
    </ul>
  ...
  },
  {
    ...
    <p>Providing feedback on student writing is one of the most valuableÃ¢â‚¬â€but also most time-consumingÃ¢â‚¬â€tasks teachers face. Effective feedback requires a balance of encouragement and constructive criticism, with suggestions tailored to each student's level. Doing this for dozens of essays, projects, or creative pieces can quickly overwhelm even the most experienced teacher. AI-powered writing feedback tools are changing this by giving teachers a faster, more consistent way to support student growth.</p>

    <!-- PULL_QUOTE -->
    <p><strong>Core insight:</strong> The best AI writing feedback tools act like a co-teacherÃ¢â‚¬â€highlighting areas for growth, reinforcing strengths, and giving teachers more time to focus on personalised instruction.</p>
    <!-- /PULL_QUOTE -->

    <h2>The challenges of giving writing feedback</h2>
    <ul>
      <li><strong>Time intensity:</strong> Each piece of writing can take 10Ã¢â‚¬â€œ20 minutes to review thoroughly.</li>
    ...
    <h2>Bonus template pack Ã¢â‚¬â€œ writing feedback prompts</h2>
    <!-- CALLOUT:TEMPLATE -->
    <ul>
    ...
    <h2>Extended checklist Ã¢â‚¬â€œ AI for writing feedback</h2>
    <ul>
      <li>Ã¢Å“â€ Start with one writing assignment to test AI tools.</li>
      <li>Ã¢Å“â€ Generate feedback in student-friendly language.</li>
      <li>Ã¢Å“â€ Compare AI suggestions with your rubric for accuracy.</li>
      <li>Ã¢Å“â€ Edit and personalise feedback before sharing.</li>
      <li>Ã¢Å“â€ Monitor whether students engage with and act on the feedback.</li>
    </ul>
  ...
  `,
    ...
    <!-- PULL_QUOTE -->
    <p><strong>Kernaussage:</strong> Gute KI-Tools sind wie Co-LehrkrÃƒÂ¤fteÃ¢â‚¬â€sie heben StÃƒÂ¤rken hervor, zeigen VerbesserungsmÃƒÂ¶glichkeiten und verschaffen LehrkrÃƒÂ¤ften Zeit fÃƒÂ¼r individuellen Unterricht.</p>
    <!-- /PULL_QUOTE -->

    <h2>Herausforderungen beim Feedback</h2>
    <ul>
      <li><strong>Zeitaufwand:</strong> 10Ã¢â‚¬â€œ20 Minuten pro Text.</li>
    ...
    <h2>Bonus Vorlagenpaket Ã¢â‚¬â€œ Feedback-Prompts</h2>
    <!-- CALLOUT:TEMPLATE -->
    <ul>
    ...
    <h2>Checkliste Ã¢â‚¬â€œ KI fÃƒÂ¼r Schreibfeedback</h2>
    <ul>
      <li>Ã¢Å“â€ Mit einer Aufgabe starten.</li>
      <li>Ã¢Å“â€ Feedback in schÃƒÂ¼lerfreundlicher Sprache generieren.</li>
      <li>Ã¢Å“â€ KI-VorschlÃƒÂ¤ge mit Rubrik abgleichen.</li>
      <li>Ã¢Å“â€ Feedback personalisieren.</li>
      <li>Ã¢Å“â€ Engagement der SchÃƒÂ¼ler prÃƒÂ¼fen.</li>
    </ul>
    ...
    <!-- PULL_QUOTE -->
    <p><strong>Schlussgedanke:</strong> KI ersetzt nicht die Stimme der LehrkraftÃ¢â‚¬â€sie entlastet und sorgt fÃƒÂ¼r klareres, nutzbares Feedback.</p>
    <!-- /PULL_QUOTE -->
  `,
  ...
  },
  {
    ...
    <p>Lesson planning is one of the most rewarding parts of teaching Ã¢â‚¬â€ but it's also one of the most time-consuming. Teachers want lessons that are engaging, standards-aligned, and adaptable for different learners. Yet the process of pulling resources, structuring objectives, designing activities, and writing assessments can consume hours each week. AI-powered tools offer a way to cut this workload dramatically while maintaining Ã¢â‚¬â€ and even enhancing Ã¢â‚¬â€ lesson quality.</p>

    <!-- PULL_QUOTE -->
    <p><strong>Key idea:</strong> AI doesn't replace teacher creativity Ã¢â‚¬â€ it provides the scaffolding that makes high-quality lesson planning faster and more sustainable.</p>
    <!-- /PULL_QUOTE -->
    ...
    <h2>Bonus template pack Ã¢â‚¬â€œ time-saving lesson prompts</h2>
    <!-- CALLOUT:TEMPLATE -->
    <ul>
    ...
    <h2>Extended checklist Ã¢â‚¬â€œ AI for faster lesson planning</h2>
    <ul>
      <li>Ã¢Å“â€ Choose one subject and week to trial AI lesson planning.</li>
      <li>Ã¢Å“â€ Generate 3 draft lessons with objectives and timing.</li>
      <li>Ã¢Å“â€ Check drafts against curriculum standards.</li>
    ...
    <!-- CALLOUT:TIME_SAVER -->
    <p>Pro tip: If AI saves 5 hours a week on planning, that's 200+ hours per year Ã¢â‚¬â€ the equivalent of five extra weeks of time for teachers.</p>
    <!-- /CALLOUT:TIME_SAVER -->
  ...
  `,
    ...
    <p>Unterrichtsplanung ist lohnend Ã¢â‚¬â€œ aber zeitintensiv. LehrkrÃƒÂ¤fte wollen spannende, standardgerechte und differenzierte Stunden. Doch Ressourcen zu sichten, Ziele zu formulieren, AktivitÃƒÂ¤ten zu entwerfen und PrÃƒÂ¼fungen vorzubereiten, kostet Stunden. KI-Tools verringern diese Last erheblich, ohne die QualitÃƒÂ¤t zu beeintrÃƒÂ¤chtigen.</p>

    <!-- PULL_QUOTE -->
    <p><strong>Kernaussage:</strong> KI ersetzt nicht die KreativitÃƒÂ¤t Ã¢â‚¬â€œ sie liefert das GerÃƒÂ¼st fÃƒÂ¼r schnelle, hochwertige Planung.</p>
    <!-- /PULL_QUOTE -->
    ...
    <h2>Bonus Vorlagenpaket Ã¢â‚¬â€œ Planungszeit sparen</h2>
    <!-- CALLOUT:TEMPLATE -->
    <ul>
    ...
    <h2>Checkliste Ã¢â‚¬â€œ KI fÃƒÂ¼r schnelle Planung</h2>
    <ul>
      <li>Ã¢Å“â€ Fach/Woche fÃƒÂ¼r Pilot wÃƒÂ¤hlen.</li>
      <li>Ã¢Å“â€ 3 EntwÃƒÂ¼rfe mit Zielen generieren.</li>
      <li>Ã¢Å“â€ Mit Standards abgleichen.</li>
      <li>Ã¢Å“â€ FÃƒÂ¼r SchÃƒÂ¼lergruppen anpassen.</li>
      <li>Ã¢Å“â€ Zeitersparnis und Wirkung dokumentieren.</li>
    </ul>

    <!-- CALLOUT:TIME_SAVER -->
    <p>Tipp: 5 Stunden wÃƒÂ¶chentlich sparen = 200+ Stunden pro Jahr Ã¢â‚¬â€œ fÃƒÂ¼nf Zusatzwochen fÃƒÂ¼r LehrkrÃƒÂ¤fte.</p>
    <!-- /CALLOUT:TIME_SAVER -->
  ...
  },
  {
    ...
    excerpt:
      "Parent emails can feel like walking a tightrope. Learn five proven email openers that lower tension, set a cooperative frame, and create space for solutionsÃ¢â‚¬â€with copy-paste templates for behavior, progress, attendance, and grading disputes.",
    content: String.raw`
