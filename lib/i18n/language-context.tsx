...
const translationsEn: Record<string, string> = {
  ...
  "pricing.faq.a5": "Yes – we have team and district plans. Contact sales for details.",
  ...
  // Footer Features
  "footer.tagline": "The writing partner for teachers. Beat the blank page, save hours, and stay in control for parent emails, student reports, and staff notes.",
  ...
  "footer.learning.reduceStressWritingParentMessages": "Reduce Stress Writing Parent Messages",
  "footer.learning.bestAiWritingToolsForTeachers2025": "Best AI Writing Tools for Teachers 2025",
  ...
  "founder.hero.subheading": "I have worked in learning and education for over twenty years - in universities, corporate education, and edtech. One thing has always been true: teaching is human work.",
  ...
  "founder.journey.p1": "During my PhD in Professional Education, I focused on how learners develop critical thinking and problem-solving skills in real-world environments. I saw how technology could support learning when used well. But I also saw how easily it could create stress, waste time, or work against what educators are trying to achieve.",
  "founder.journey.p2": "As Chief Learning Officer at Communardo, I lead work in AI-powered learning design, digital content development, LMS innovation, and teacher training. I have written and spoken widely on learning science, e-learning strategy, and the role of AI in education.",
  "founder.journey.p3": "But here is the truth: most edtech tools are not built for teachers. They are built for sales decks.",
  "founder.journey.p4": "I have watched technology sold as 'revolutionary' only to become another system teachers have to manage. I have seen AI products that generate content that looks impressive at first glance - but collapses the moment a teacher tries to use it with real students.",
  ...
  "founder.principle.rule": "If a tool cannot reduce workload in a real school environment, it does not belong in Zaza.",
  ...
  "founder.commitments.item1.body": "When AI outputs are not trustworthy, teachers end up doing more work checking and fixing. That is why we engineer for accuracy, clarity, and classroom reality.",
  "founder.commitments.item2.title": "Reduce workload, not shift it.",
  "founder.commitments.item2.body": "A tool that requires training, manuals, and complex workflows is not support. It is rebadged work.",
  "founder.commitments.item3.title": "Respect professional expertise.",
  "founder.commitments.item3.body": "You do not need technology that replaces your judgement. You need technology that amplifies it.",
  "founder.commitments.closing": "Teaching is incredibly complex, intellectually demanding work. It is also emotionally taxing work. Good tools should lighten that burden.",

  // Founder Why Zaza Section (English)
  "founder.whyZaza.title": "Why Zaza exists",
  "founder.whyZaza.p1": "Zaza is not trying to 'disrupt education.' Teachers do not need disruption. They need support. They need time. They need tools that recognise the value of their experience - rather than trying to standardise it or replace it.",
  ...
  "founder.whyZaza.p3": "If that is the kind of future for education you believe in, you are in the right place.",
  ...
  "founder.whyZaza.card1.body": "I have spent my career working alongside teachers and learning designers - refining tools directly with educators who understand the reality of classrooms. Every feature in Zaza is shaped by real feedback and real practice, not theory.",
  "founder.whyZaza.card2.title": "Boutique, not Big Tech",
  "founder.whyZaza.card2.body": "We are not a huge company trying to sell to everyone. We are a focused team building specialised tools for one audience: teachers. Your needs come first, always.",
  "founder.whyZaza.card3.title": "Building a legacy",
  "founder.whyZaza.card3.body": "This is not about quick profits. It is about creating something that genuinely helps teachers thrive and changes education for the better. That is the legacy I want to leave.",
  // Founder Personal Message Section (English)
  "founder.personal.title": "A personal note",
  "founder.personal.message1": "If you are reading this, you are probably a teacher who is curious about AI but sceptical about whether it can really help. I get it. I was sceptical too. Most AI tools feel like they were built by people who have never set foot in a classroom.",
  "founder.personal.message2": "That is why I built Zaza differently. Every feature is designed with real teachers, tested in real classrooms, and refined based on real feedback. We are not just building software - we are building partnerships with educators who help us create tools that actually work.",
  "founder.personal.message3": "I would love to hear from you. Whether you have questions, feedback, or just want to talk about education and technology, my door is always open. Let us shape the future of teacher technology together.",
  ...
  "contact.form.dataNote": "We respect your privacy. Your information will never be shared.",
  ...
  "about.company.hero.subheading": "We're a team of educators, engineers, and designers building the future of teacher technology.",
  "about.company.origin.title": "How We Started",
  "about.company.origin.p1": "Zaza Technologies was founded in 2023 by teachers who were frustrated with generic AI tools that didn't understand education. We saw teachers spending hours on administrative writing tasks that could be automated, but existing AI tools were either unsafe for student data or produced output that sounded nothing like a teacher.",
  "about.company.origin.p2": "So we built something different: AI tools trained specifically on educational communications and pedagogy. Tools that understand the nuances of parent-teacher communication, the importance of constructive feedback, and the need to maintain your authentic voice. Tools that are hallucination-safe, FERPA-compliant, and designed from the ground up for education.",
  "about.company.vision.title": "Our Vision",
  "about.company.vision.p1": "Today, Zaza serves over 500 teachers across 15 countries, saving them 10+ hours per week on writing tasks. But we're just getting started. Our vision is to build a complete suite of AI tools that help teachers reclaim their time and focus on what matters most: their students.",
  "about.company.values.title": "Our Values",
  "about.company.values.teacherFirst.title": "Teachers First",
  "about.company.values.teacherFirst.description": "Every decision we make starts with one question: does this help teachers?",
  "about.company.values.trustSafety.title": "Trust & Safety",
  "about.company.values.trustSafety.description": "Student data protection and output accuracy are non-negotiable.",
  "about.company.values.authentic.title": "Authentic Voice",
  "about.company.values.authentic.description": "Our AI preserves your unique communication style and professional judgement.",
  "about.company.team.title": "Our Team",
  "about.company.team.description": "We're a small team of educators, learning scientists, and engineers who believe technology should serve teachers, not the other way around.",
...
const translationsDe: Record<string, string> = {
  ...
  "pricing.hero.subheadline": "Sparen Sie jede Woche Stunden, reduzieren Sie Stress nach Feierabend und schreiben Sie selbstbewusst - mit einfachen und fairen Preisen.",
  ...
  "pricing.identity.point3": "sich um Grenzen, Selbstvertrauen und Ruhe in ihrer Woche kümmern",
  ...
  // Outcome Proof
  "pricing.outcome.text": "Die meisten Lehrkräfte verbringen 3-5 Stunden/Woche mit Nachrichten und Kommentaren. Draft reduziert dies um 50-70%, während Ihr Ton und Ihre Absicht erhalten bleiben.",
  ...
  "pricing.teacher.description": "Unbegrenztes, halluzinationsfreies Schreiben ohne Vertragsbindung.",
  ...
  "pricing.bundle.title": "Draft + Teach",
  "pricing.bundle.description": "Ein Ort zum Planen, Schreiben und Kommunizieren - mit lehrkraftzentriertem Wohlbefinden im Mittelpunkt.",
  ...
  "pricing.testimonials.1.quote": "Draft gab mir meine Abende zurück. Ich verlasse jetzt pünktlich die Schule - und Eltern sagen, meine Nachrichten fühlen sich wärmer an.",
  "pricing.testimonials.2.name": "Mark R.",
  "pricing.testimonials.2.role": "Abteilungsleiter",
  "pricing.testimonials.2.quote": "Unsere Abteilung hat den Ton abgestimmt und Feedback beschleunigt. Die Korrekturzeit sank um ein Drittel.",
  "pricing.testimonials.3.name": "Emma K.",
  "pricing.testimonials.3.role": "Grundschullehrerin",
  "pricing.testimonials.3.quote": "Die Preisgestaltung ist transparent und fair. Keine versteckten Gebühren, keine Vertragsbindung. Funktioniert einfach.",
  
  // Wellbeing Metric
  "pricing.metric.text": "Über 90 Tage berichten Lehrkräfte von 38% weniger Nachrichten nach Feierabend und +24% Vertrauen in die Elternkommunikation.",
  
  // FAQs
  "pricing.faq.title": "Preis- & Abrechnungs-FAQs",
  "pricing.faq.q1": "Gibt es einen kostenlosen Plan?",
  "pricing.faq.a1": "Ja - starten Sie mit 5 Entwürfen/Monat, um den Unterschied zu spüren. Keine Kreditkarte erforderlich.",
  ...
  "pricing.faq.a3": "Ja. Wir verwenden Ihre Inhalte nicht zum Trainieren öffentlicher Modelle. Siehe unsere Datenschutzseite für Details.",
  "pricing.faq.q4": "Kann ich jederzeit kündigen?",
  "pricing.faq.a4": "Absolut - keine Vertragsbindung. Kündigen Sie mit einem Klick in Ihren Kontoeinstellungen.",
  "pricing.faq.q5": "Unterstützen Sie Schulen?",
  "pricing.faq.a5": "Ja - wir haben Team- und Bezirkspläne. Kontaktieren Sie den Vertrieb für Details.",
  
  // Footer CTA
  "pricing.cta.headline": "Bereit, Ihre Zeit zurückzugewinnen?",
  "pricing.cta.subheadline": "Schließen Sie sich Lehrkräften an, die 4-7 Stunden pro Woche sparen",
  "pricing.cta.button": "Starten Sie Ihre 7-tägige kostenlose Testversion",
  
  // Footer Features
  "footer.tagline": "Der Schreibpartner für Lehrkräfte. Überwinden Sie das leere Blatt, sparen Sie Stunden und behalten Sie die Kontrolle bei Eltern-E-Mails, Schülerberichten und Mitarbeiternotizen.",
  ...
  "footer.learning.videoTutorials": "Video-Tutorials",
  "footer.learning.bestAiToolForParentEmails": "Bestes KI-Tool für Eltern-E-Mails",
  "footer.learning.reduceStressWritingParentMessages": "Reduzieren Sie Stress beim Schreiben von Elternnachrichten",
  "footer.learning.bestAiWritingToolsForTeachers2025": "Beste KI-Schreibtools für Lehrkräfte 2025",
