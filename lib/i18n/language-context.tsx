...
const translationsDe: Record<string, string> = {
  ...
  "webinars.stats.teachers": "Geschulte Lehrkrfte",
  ...
  "webinars.related.desc": "Ergnzen Sie Ihr Webinar‑Lernen mit diesen Ressourcen",
  "webinars.related.courses.title": "KI‑Kurse fr Lehrkrfte",
  "webinars.related.courses.desc": "Selbstlernkurse mit Zertifikatsprogrammen",
  "webinars.related.glossary.title": "KI‑Glossar",
  "webinars.related.glossary.desc": "150+ KI‑Begriffe fr Lehrkrfte erklrt",
  "webinars.related.community.title": "Community‑Forum",
  ...
  "webinars.benefits.pd.body": "Erhalten Sie fr jedes absolvierte Webinar ein Zertifikat.",
  "webinars.benefits.experts.title": "Expertinnen und Experten",
  "webinars.benefits.experts.body": "Lernen Sie von erfahrenen Pdagoginnen, Pdagogen und KI‑Spezialistinnen, ‑Spezialisten.",
  "webinars.benefits.resources.title": "Download‑Ressourcen",
  "webinars.benefits.resources.body": "Vorlagen, Leitfden und Materialien fr den sofortigen Einsatz.",
  ...
  "webinars.cta.title": "Bereit fr den nhsten Schritt?",
  "webinars.cta.body": "Schlieen Sie sich Tausenden Lehrkrften an, die ihre Praxis mit KI verbessern. Melden Sie sich noch heute fr Ihr erstes Webinar an.",
...
export function useLanguage() {
  ...
  "aiLiteracy.hero.title": "KI‑Kompetenz fr Lehrkrfte",
  "aiLiteracy.hero.subtitle": "Kostenlose Kurse, Zertifikate und Ressourcen fr einen sicheren und souvernen KI‑Einsatz.",
  "aiLiteracy.paths.title": "Whlen Sie Ihren Pfad",
  "aiLiteracy.filters.all": "alle",
  "aiLiteracy.filters.beginner": "anfnger",
  ...
  "aiLiteracy.cert.certifiedTeachers": "zertifizierte Lehrkrfte",
  "aiLiteracy.related.title": "Ihre KI‑Reise fortsetzen",
  "aiLiteracy.related.description": "Weitere Ressourcen fr den KI‑Einsatz im Unterricht",
  "aiLiteracy.related.webinars.title": "Live‑Webinare",
  "aiLiteracy.related.webinars.desc": "Experten‑Sessions mit Fortbildungszertifikat",
  "aiLiteracy.related.community.title": "Lehrkrfte‑Community",
  "aiLiteracy.related.community.desc": "Vernetzen Sie sich mit Lehrkrften, die KI einsetzen",
  ...
  "aiLiteracy.cta.body": "Lehrkrfte setzen KI selbstbewusst ein  verbessern so ihren Unterricht.",
