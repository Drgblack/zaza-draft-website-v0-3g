...
// Replace/add to the existing pricing.* keys
  ...
  "pricing.hero.subheadline": "Save hours every week, reduce after-hours stress, and write with confidence ï¿½ with pricing that's simple and fair.",
  ...
  "pricing.identity.point1": "want to spend less time writing and more time teaching",
  "pricing.identity.point2": "need trusted language support without losing their voice",
  "pricing.identity.point3": "care about boundaries, confidence, and calm in their week",
  ...
  // Outcome Proof
  "pricing.outcome.text": "Most teachers spend 3ï¿½5 hours/week on messages and comments. Draft cuts that by 50ï¿½70% while preserving your tone and intent.",
  
  // Free Plan
  "pricing.free.badge": "FREE",
  "pricing.free.title": "Starter",
  "pricing.free.description": "Everything you need to try Draft and save your first hours.",
  ...
  "pricing.teacher.description": "Unlimited, hallucination-safe writing with no lock-ins.",
  ...
  "pricing.teacher.timeSaved": "Typical time saved: 4ï¿½7 hours/week",
  
  // Department Plan
  "pricing.department.badge": "TEAMS",
  "pricing.department.title": "Department",
  "pricing.department.description": "Collaborative writing with shared quality and consistency.",
  "pricing.department.perTeacher": "/teacher",
  "pricing.department.billing": "Billed annually â¬¢ 5ï¿½50 seats",
  ...
  "pricing.bundle.description": "One place to plan, write, and communicate ï¿½ with teacher-first wellbeing at the centre.",
  ...
  "pricing.testimonials.1.quote": "Draft gave me back my evenings. I now leave school on time ï¿½ and parents say my messages feel warmer.",
  "pricing.testimonials.2.name": "Mark R.",
  "pricing.testimonials.2.role": "Department Head",
  "pricing.testimonials.2.quote": "Our department aligned tone and sped up feedback. Marking time dropped by a third.",
  "pricing.testimonials.3.name": "Emma K.",
  "pricing.testimonials.3.role": "Primary Teacher",
  "pricing.testimonials.3.quote": "The pricing is transparent and fair. No hidden fees, no lock-ins. Just works.",
  
  // Wellbeing Metric
  "pricing.metric.text": "Across 90 days, teachers report 38% fewer after-hours messages and +24% confidence in parent communication.",
  
  // FAQs
  "pricing.faq.title": "Pricing & Billing FAQs",
  "pricing.faq.q1": "Is there a free plan?",
  "pricing.faq.a1": "Yes ï¿½ start with 5 drafts/month to feel the difference. No credit card required.",
  "pricing.faq.q2": "What happens to my voice?",
  "pricing.faq.a2": "Draft preserves your tone and language; you're always in control. Our Tone Tutor learns your style.",
  "pricing.faq.q3": "Are my messages private?",
  "pricing.faq.a3": "Yes. We don't use your content to train public models. See our Privacy page for details.",
  "pricing.faq.q4": "Can I cancel anytime?",
  "pricing.faq.a4": "Absolutely ï¿½ no lock-ins. Cancel from your account settings with one click.",
  "pricing.faq.q5": "Do you support schools?",
  "pricing.faq.a5": "Yes ï¿½ volume pricing, SSO, DPA/SCCs, and SLAs for districts. Contact sales@zazadraft.com",
  "pricing.faq.q6": "Do you offer refunds?",
  "pricing.faq.a6": "Yes ï¿½ 30-day money-back guarantee on all paid plans. No questions asked.",
  
  // CTA Section
  "pricing.cta.title": "Ready to save hours every week?",
  "pricing.cta.subtitle": "Start free today â¬¢ No credit card required â¬¢ Cancel anytime",
  ...
  "founder.principle.rule": "If a tool can't reduce workload in a real school environment, it doesn't belong in Zaza.",
  ...
  "founder.commitments.item1.body": "If AI output can't be trusted, teachers end up doing more work reviewing and correcting it. So we design for accuracy, clarity, and classroom reality.",
  "founder.commitments.item2.title": "Reduce workload, don't shift it.",
  "founder.commitments.item2.body": "A tool that requires training, manuals, and complex workflows isn't support. It's rebranded labour.",
  "founder.commitments.item3.title": "Respect professional expertise.",
  "founder.commitments.item3.body": "You don't need technology to replace your judgment. You need technology that amplifies it.",
  "founder.commitments.closing": "Teaching is incredibly complex, intellectually demanding work. It's also emotionally heavy work. Good tools should lighten that burden.",
  ...
  "contact.help.faq": "ï¿½ Frequently Asked Questions",
  "contact.help.support": "ï¿½ Support Center",

}

const translationsDe: Record<string, string> = {
  "pricing.hero.preheadline": "TRANSPARENTE PREISE",
  "pricing.hero.headline": "Preise, die die Zeit und das Wohlbefinden von LehrkrÃ¤ften respektieren",
  "pricing.hero.subheadline": "Sparen Sie jede Woche Stunden, reduzieren Sie Stress nach Feierabend und schreiben Sie mit Zuversicht ï¿½ mit Preisen, die einfach und fair sind.",
  ...
  "pricing.identity.point1": "weniger Zeit mit Schreiben und mehr Zeit mit Unterrichten verbringen mÃ¶chten",
  "pricing.identity.point2": "vertrauenswÃ¼rdige SprachunterstÃ¼tzung benÃ¶tigen, ohne ihre Stimme zu verlieren",
  "pricing.identity.point3": "sich um Grenzen, Zuversicht und Ruhe in ihrer Woche kÃ¼mmern",
  ...
  // Outcome Proof
  "pricing.outcome.text": "Die meisten LehrkrÃ¤fte verbringen 3ï¿½5 Stunden pro Woche mit Nachrichten und Kommentaren. Draft reduziert dies um 50ï¿½70 %, wÃ¤hrend Ihr Ton und Ihre Absicht erhalten bleiben.",
  
  // Free Plan
  "pricing.free.badge": "KOSTENLOS",
  "pricing.free.title": "Starter",
  "pricing.free.description": "Alles, was Sie brauchen, um Draft auszuprobieren und Ihre ersten Stunden zu sparen.",
  ...
  "pricing.teacher.title": "Teacher",
  "pricing.teacher.description": "Unbegrenztes, halluzinationssicheres Schreiben ohne Lock-ins.",
  ...
  "pricing.teacher.feature1": "Unbegrenzte EntwÃ¼rfe & ï¿½Sberarbeitungen",
  "pricing.teacher.feature2": "Ton-Tutor, ï¿½Sbersetzungen, Kontext-GedÃ¤chtnis",
  ...
  "pricing.teacher.timeSaved": "Typischerweise gespart: 4ï¿½7 Stunden pro Woche",
  
  // Department Plan
  "pricing.department.badge": "TEAMS",
  "pricing.department.title": "Department",
  "pricing.department.description": "Kollaboratives Schreiben mit gemeinsamer QualitÃ¤t und Konsistenz.",
  "pricing.department.perTeacher": "/Lehrkraft",
  "pricing.department.billing": "JÃ¤hrliche Abrechnung â¬¢ 5ï¿½50 PlÃ¤tze",
  ...
  "pricing.department.feature3": "ï¿½SberprÃ¼fung & Freigabe",
  "pricing.department.feature4": "Priorisiertes Onboarding & Erfolg",
  
  // Schools & Districts
  "pricing.enterprise.badge": "ENTERPRISE",
  "pricing.enterprise.title": "Schulen & Bezirke",
  "pricing.enterprise.description": "Alles fÃ¼r groï¿½xflÃ¤chige Bereitstellungen.",
  ...
  "pricing.bundle.title": "Draft + Teach",
  "pricing.bundle.description": "Ein Ort zum Planen, Schreiben und Kommunizieren ï¿½ mit lehrerorientierten Wohlbefinden im Mittelpunkt.",
  ...
  "pricing.testimonials.1.quote": "Draft gab mir meine Abende zurÃ¼ck. Ich verlasse jetzt die Schule pÃ¼nktlich ï¿½ und Eltern sagen, meine Nachrichten fÃ¼hlen sich wÃ¤rmer an.",
  "pricing.testimonials.2.name": "Mark R.",
  "pricing.testimonials.2.role": "Abteilungsleiter",
  "pricing.testimonials.2.quote": "Unsere Abteilung hat Ton abgestimmt und Feedback beschleunigt. Die Benotungszeit sank um ein Drittel.",
  "pricing.testimonials.3.name": "Emma K.",
  "pricing.testimonials.3.role": "Grundschullehrerin",
  "pricing.testimonials.3.quote": "Die Preisgestaltung ist transparent und fair. Keine versteckten GebÃ¼hren, keine Lock-ins. Funktioniert einfach.",
  
  // Wellbeing Metric
  "pricing.metric.text": "ï¿½Sber 90 Tage berichten LehrkrÃ¤fte von 38 % weniger Nachrichten nach Feierabend und +24 % Zuversicht in der Elternkommunikation.",
  
  // FAQs
  "pricing.faq.title": "Preis- und Abrechnungs-FAQs",
  "pricing.faq.q1": "Gibt es einen kostenlosen Plan?",
  "pricing.faq.a1": "Ja ï¿½ beginnen Sie mit 5 EntwÃ¼rfen pro Monat, um den Unterschied zu spÃ¼ren. Keine Kreditkarte erforderlich.",
  "pricing.faq.q2": "Was passiert mit meiner Stimme?",
  "pricing.faq.a2": "Draft bewahrt Ihren Ton und Ihre Sprache; Sie haben immer die Kontrolle. Unser Ton-Tutor lernt Ihren Stil.",
  "pricing.faq.q3": "Sind meine Nachrichten privat?",
  "pricing.faq.a3": "Ja. Wir verwenden Ihre Inhalte nicht, um Ã¶ffentliche Modelle zu trainieren. Weitere Details finden Sie auf unserer Datenschutzseite.",
  "pricing.faq.q4": "Kann ich jederzeit kÃ¼ndigen?",
  "pricing.faq.a4": "Absolut ï¿½ keine Lock-ins. KÃ¼ndigen Sie mit einem Klick in Ihren Kontoeinstellungen.",
  "pricing.faq.q5": "UnterstÃ¼tzen Sie Schulen?",
  "pricing.faq.a5": "Ja ï¿½ Mengenpreise, SSO, DPA/SCCs und SLAs fÃ¼r Bezirke. Kontakt: sales@zazadraft.com",
  "pricing.faq.q6": "Bieten Sie RÃ¼ckerstattungen an?",
  "pricing.faq.a6": "Ja ï¿½ 30-Tage-Geld-zurÃ¼ck-Garantie auf alle kostenpflichtigen PlÃ¤ne. Keine Fragen gestellt.",
  
  // CTA Section
  "pricing.cta.title": "Bereit, jede Woche Stunden zu sparen?",
  "pricing.cta.subtitle": "Heute kostenlos starten â¬¢ Keine Kreditkarte erforderlich â¬¢ Jederzeit kÃ¼ndbar",
  ...
  "nav.faq": "FAQ",
  "nav.about": "ï¿½Sber uns",
  "nav.getStarted": "Jetzt starten",

  // Suite Page Hero (DE)
  "suite.hero.title": "Zaza ist eine Familie sicherer, lehrerzentrierter KI-Apps, die zusammenarbeiten, um den Arbeitsaufwand zu reduzieren und die Effizienz sowie das Wohlbefinden von LehrkrÃ¤ften zu stÃ¤rken.",
  "suite.hero.subhead": "Jede App wird von der Zaza KnowledgeCore Plattform betrieben und bietet vertrauenswÃ¼rdige, erklÃ¤rbare KI sowie konsistente, schulbereite Schutzmechanismen.",

  // Suite - Teacher First (DE)
  "suite.teacherFirst.title": "FÃ¼r LehrkrÃ¤fte entwickelt",
  "suite.teacherFirst.body": "Zaza gibt Zeit zurÃ¼ck und lÃ¤sst PÃ¤dagoginnen und PÃ¤dagogen sich aufs Unterrichten konzentrieren. Alles ist mit Datenschutz, Schutzkonzepten und PÃ¤dagogik im Kern gestaltet, sodass Schulen dem Einsatz vertrauen kÃ¶nnen.",

  // Suite - Core Apps (DE)
  "suite.coreApps.title": "Die vier Kern-Apps",
  "suite.teach.body": "KI-gestÃ¼tzte Unterrichtsplanung, die sich an Ihren Lehrplan anpasst, Stunden Vorbereitungszeit spart und den Unterricht spannend sowie standardkonform hÃ¤lt.",
  ...
  "features.how.step1.desc": "Tippen oder fÃ¼gen Sie Ihren Entwurf zum SchÃ¼ler ein",
  ...
  "features.how.step3.desc": "Exportieren Sie Ihre Ã¼berarbeitete Nachricht in Sekunden",
  ...
  "resources.subtitle": "Zeitspartools fÃ¼r den sofortigen Einsatz. Als PDF oder DOCX herunterladen.",
  "resources.download": "Herunterladen",
  "resources.comingSoon": "DemnÃ¤chst",
  "resources.published": "VerÃ¶ffentlicht",
  "suite.teach.li2": "Lehrplanbewusst: Common Core + internationale RahmenplÃ¤ne",
  "suite.teach.li3": "Hilfen zur Differenzierung und kreative AktivitÃ¤tsideen",
  "suite.teach.cta": "Mehr Ã¼ber Teach erfahren",

  "suite.draft.body": "Kommentare und Berichte ohne Burnout - klare, wertschÃ¤tzende Kommunikation, fundiert in Forschung zum Wohlbefinden von LehrkrÃ¤ften.",
  "suite.draft.li1": "Vorlagen fÃ¼r Berichte und Kommentare, die Sie anpassen kÃ¶nnen",
  "suite.draft.li2": "TonleitfÃ¤den und Bias-PrÃ¼fungen fÃ¼r faires, unterstÃ¼tzendes Feedback",
  "suite.draft.li3": "StandardmÃ¤ï¿½xig privat; fÃ¼r professionelle, elternreife Texte entwickelt",
  "suite.draft.cta": "Mehr Ã¼ber Draft erfahren",

  "suite.gradeflow.body": "Ein erklÃ¤rbarer Bewertungs-Copilot mit OCR, Rubriken und evidenzbasiertem Feedback - schneller korrigieren mit Fairness und Konsistenz.",
  "suite.gradeflow.li1": "Rubrik-konformes, prÃ¼ffÃ¤higes Feedback mit Nachweisen",
  ...
  "suite.shield.body": "Kommunikationsmanagement, das das Wohlbefinden von LehrkrÃ¤ften schÃ¼tzt - entwirft schwierige E-Mails und hilft, gesunde Grenzen zu wahren.",
  "suite.shield.li1": "Entwurfs-Assistent fÃ¼r sensible Eltern- und Verwaltungsnachrichten",
  ...
  "suite.platform.li2": "Geteilter Kontext Ã¼ber alle Apps (kein erneutes Hochladen)",
  ...
  "suite.why.timeSaved": "Zeitersparnis: LehrkrÃ¤fte gewinnen jede Woche Stunden zurÃ¼ck.",
  "suite.why.retention": "Bindung unterstÃ¼tzt: Weniger Stress und gerechtere Arbeitslast.",
  "suite.why.safety": "Sicher und konform: Datenschutz und Schutz standardmÃ¤ï¿½xig.",
  "suite.why.evidence": "Evidenzbasiert: PÃ¤dagogik und Nachvollziehbarkeit, nicht nur Tempo.",

  // Suite - Roadmap (DE)
  "suite.roadmap.title": "Bereit fÃ¼r die Roadmap",
  "suite.roadmap.body": "Geplante Erweiterungen umfassen intelligentere Elternkommunikation, Synthese formativer Bewertungen und UnterstÃ¼tzung bei Differenzierung - alles Ã¼ber KnowledgeCore bereitgestellt, damit der Nutzen Ã¼berall ankommt, nicht nur in einem einzelnen Tool.",

  // Suite - CTA (DE)
  "suite.cta.title": "Jetzt entdecken",
  "suite.cta.body": "Ob Sie als Lehrkraft Entlastung suchen oder als Schule skalierbare UnterstÃ¼tzung: Zaza hilft Ihrem Team zu gedeihen.",
  ...
  "suite.hiw.step1.desc": "Teach fÃ¼rs Planen, Draft fÃ¼rs Schreiben, GradeFlow fÃ¼rs Bewerten, Shield fÃ¼r Grenzen.",
  "suite.hiw.step2.title": "Eigenen Kontext hinzufÃ¼gen",
  "suite.hiw.step2.desc": "Lehrplan, Klassendetails, Rubriken und Ton flieï¿½xen einmal in KnowledgeCore ein und gelten Ã¼berall.",
  "suite.hiw.step3.title": "Schulreife Ergebnisse erhalten",
  "suite.hiw.step3.desc": "VertrauenswÃ¼rdige, erklÃ¤rbare Resultate mit konsistenten Schutzmechanismen in jedem Workflow.",

  // Suite - Testimonials (DE)
  "suite.testimonials.title": "Stimmen aus der Praxis",
  "suite.testimonials.1.quote": "Ich bekomme meinen Sonntag zurÃ¼ck. Planung und Elternkommunikation dauern jetzt Minuten statt Stunden.",
  "suite.testimonials.1.author": "Sarah Mitchell",
  "suite.testimonials.1.role": "Grundschullehrerin, UK",
  "suite.testimonials.2.quote": "Konsistente Bewertung mit klaren Nachweisen. GradeFlow hat die QualitÃ¤t klassenÃ¼bergreifend erhÃ¶ht.",
  "suite.testimonials.2.author": "Michael Brown",
  "suite.testimonials.2.role": "Oberstufenlehrer, USA",
  "suite.testimonials.3.quote": "Draft schÃ¼tzt Ton und Wohlbefinden. Ich kommuniziere mehr ï¿½ mit weniger Stress.",
  "suite.testimonials.3.author": "Emma Rodriguez",
  ...
  "suite.screens.caption": "Ein schneller Blick auf Planungs-, Schreib- und BewertungsablÃ¤ufe.",
  ...
  "webinars.cta.body": "Schlieï¿½xen Sie sich Tausenden LehrkrÃ¤ften an, die ihre Praxis mit KI transformieren. Melden Sie sich noch heute fÃ¼r Ihr erstes Webinar an.",
  ...
  "community.hero.subtitle": "Vernetzen Sie sich weltweit mit LehrkrÃ¤ften. Teilen Sie Strategien, stellen Sie Fragen und lernen Sie von erfolgreichen Praxisbeispielen zum Einsatz von KI im Unterricht.",
  ...
  "community.categories.prompt-engineering.name": "Prompt-Engineering",
  "community.categories.prompt-engineering.desc": "Teilen und diskutieren Sie wirksame Prompts fÃ¼r unterschiedliche Unterrichtsszenarien.",
  "community.categories.lesson-planning.name": "Unterrichtsplanung",
  "community.categories.lesson-planning.desc": "Gemeinsam KI-gestÃ¼tzte Unterrichts- und Einheitenplanung erarbeiten.",
  "community.categories.parent-communication.name": "Elternkommunikation",
  "community.categories.parent-communication.desc": "Tipps fÃ¼r den KIï¿½Einsatz zur Verbesserung der Eltern-Lehrer-Kommunikation.",
  "community.categories.assessment-feedback.name": "Bewertung & Feedback",
  "community.categories.assessment-feedback.desc": "KI-Tools fÃ¼r Korrektur, Feedback und formative Beurteilung diskutieren.",
  "community.categories.differentiation.name": "Differenzierung & FÃ¶rderplÃ¤ne",
  "community.categories.differentiation.desc": "Mit KI vielfÃ¤ltige Lernende unterstÃ¼tzen und Nachteilsausgleiche erstellen.",
  ...
  "community.categories.off-topic.name": "Off-Topic-Lounge",
  "community.categories.off-topic.desc": "Austausch zu Themen auï¿½xerhalb von KI.",
  // Abzeichen
  ...
  "community.badges.helpful.desc": "ï¿½Sber 50 Likes erhalten",
  ...
  "community.badges.ambassador.desc": "Offizieller Zazaï¿½Botschafter",
  // Richtlinien
  ...
  "community.related.desc": "Vertiefen Sie Ihr Communityï¿½Erlebnis mit diesen Lernressourcen",
  "community.related.aiLiteracy.title": "KIï¿½Kompetenzkurse",
  "community.related.aiLiteracy.desc": "Grundlagen lernen, die in der Community diskutiert werden",
  "community.related.webinars.title": "Expertenï¿½Webinare",
  "community.related.webinars.desc": "Liveï¿½Sessions zu aktuellen Communityï¿½Themen",
  "community.related.glossary.title": "KIï¿½Glossar",
  ...
  "community.cta.body": "Erstellen Sie kostenlos ein Konto und vernetzen Sie sich mit Tausenden LehrkrÃ¤ften, die KI im Unterricht einsetzen.",
  "community.cta.primary": "Kostenloses Konto erstellen",
  "community.cta.secondary": "Als Gast stÃ¶bern",

  "about.nav.title": "ï¿½Sber uns",
  ...
  // Hero Section
  "hero.eyebrow": "Fï¿½SR LEHRKRï¿½FTE",
  ...
  "hallucinationSafe.tooltip.body":
    "Im Gegensatz zu generischen KI-Tools ist Zaza Draft speziell darauf trainiert, keine SchÃ¼lerinformationen zu erfinden, keine ElterngesprÃ¤che zu fabrizieren oder Details Ã¼ber Ihre Klasse zu konstruieren. Jede Ausgabe basiert ausschlieï¿½xlich auf Ihren tatsÃ¤chlichen Angaben - keine erfundenen Fakten, keine fiktiven Szenarien.",

  // Problem Section
  "problem.heading": "LehrkrÃ¤fte verbringen Ã¼ber 10 Stunden pro Woche mit Schreibaufgaben",
  "problem.body":
  ...
  "stats.subtitle": "Vertraut von 500+ LehrkrÃ¤ften, die mit Zaza Draft jede Woche 10+ Stunden sparen.",
  ...
  "howItWorks.diagram.step2.example": "UnterstÃ¼tzend, Formal, PrÃ¤gnant oder Neutral",
  "howItWorks.diagram.step3.title": "Ausgefeilte Ausgabe",
  "howItWorks.diagram.step3.description": "Unterrichtsfertige Kommunikation",
  "howItWorks.diagram.step3.example": "Ich mÃ¶chte Sie bezÃ¼glich Sams jÃ¼ngster Aufmerksamkeitsschwierigkeiten...",
  "howItWorks.steps.step1.number": "1",
  "howItWorks.steps.step1.title": "FÃ¼gen Sie Ihren Entwurf ein oder beschreiben Sie, was Sie benÃ¶tigen",
  "howItWorks.steps.step1.description":
    "Beginnen Sie mit groben Notizen, Stichpunkten oder einem vollstÃ¤ndigen Entwurf",
  "howItWorks.steps.step2.number": "2",
  "howItWorks.steps.step2.title": "WÃ¤hlen Sie Ihren Ton und beobachten Sie, wie Draft verfeinert",
  "howItWorks.steps.step2.description": "UnterstÃ¼tzend, formal, prÃ¤gnant oder neutral - immer bearbeitbar",
  "howItWorks.steps.step3.number": "3",
  ...
  "demo.testimonial.quote": "Ich habe meinen Sonntag zurÃ¼ckbekommen. Draft verwandelt Stunden in Minuten.",
  "demo.testimonial.name": "Sarah Mitchell",
  ...
  "useCases.cards.reportCards.description": "Verwandeln Sie Stichpunkte in aussagekrÃ¤ftige ErzÃ¤hlungen",
  "useCases.cards.reportCards.examples": "Semesterberichte, Fortschrittszusammenfassungen, FÃ¶rderplÃ¤ne",
  ...
  "useCases.cards.schoolCommunications.description": "Erstellen Sie Newsletter und AnkÃ¼ndigungen professionell",
  ...
  "useCases.cards.referenceLetters.description": "Verfassen Sie Ã¼berzeugende Empfehlungen selbstbewusst",
  ...
  "useCases.cards.documentation.examples": "FÃ¶rderplandokumentation, ElterngesprÃ¤che",

  // Comparison Section
  "comparison.heading": "Warum LehrkrÃ¤fte Zaza gegenÃ¼ber generischen KI-Tools vertrauen",
  "comparison.subheading": "Speziell fÃ¼r Bildung entwickelt, nicht von Business-Tools adaptiert",
  ...
  "comparison.rows.training.zaza": "Trainiert mit echter Lehrerkommunikation & PÃ¤dagogik",
  "comparison.rows.safety.feature": "Sicherheit",
  "comparison.rows.safety.generic": "Kann SchÃ¼lerdetails oder Szenarien erfinden",
  ...
  "whyChoose.benefits.writeWithConfidence.description": "Professionelle QualitÃ¤t in allen Kommunikationen",
  ...
  "whyChoose.benefits.breakBarriers.description": "Sofort in Ã¼ber 20 Sprachen Ã¼bersetzen",

  // Testimonials Section
  "testimonials.heading": "Was LehrkrÃ¤fte sagen",
  "testimonials.quote1.text": "Ich habe meinen Sonntag zurÃ¼ckbekommen. Draft verwandelt Stunden in Minuten.",
  "testimonials.quote1.name": "Sarah Mitchell",
  ...
  "finalCTA.subheading": "Schlieï¿½xen Sie sich 500+ LehrkrÃ¤ften an, die mit Zaza Draft jede Woche 10+ Stunden sparen.",
  ...
  "footer.productEcosystem": "Produkt & ï¿½kosystem",
  ...
  "products.teach.hero.title": "Bessere Unterrichtsstunden in kÃ¼rzerer Zeit planen",
  "products.teach.hero.subtitle":
  ...
  "products.teach.turn.pain1": "Jede Woche Stunden damit verbringen, UnterrichtsplÃ¤ne von Grund auf zu erstellen",
  "products.teach.turn.pain2": "Schwierigkeiten bei der Differenzierung fÃ¼r verschiedene Lernende",
  "products.teach.turn.pain3": "Zeit fÃ¼r administrative Aufgaben statt fÃ¼r das Unterrichten verlieren",

  "products.teach.features.title": "Alles, was Sie fÃ¼r groï¿½xartige Unterrichtsstunden brauchen",
  ...
  "products.teach.whoItsFor.item1": "LehrkrÃ¤fte, die Zeit bei der Unterrichtsplanung sparen mÃ¶chten",
  "products.teach.whoItsFor.item2": "PÃ¤dagogen, die den Unterricht effektiver differenzieren mÃ¶chten",
  ...
  "products.teach.change.step3": "Stellen Sie die ï¿½Sbereinstimmung mit Lehrplanstandards sicher",
  ...
  "products.teach.social.quote2": "Die Lehrplan-Ausrichtungsfunktion ist ein Game-Changer fÃ¼r unsere Abteilung.",
  ...
  "products.teach.cta.subtitle": "Schlieï¿½xen Sie sich Hunderten von LehrkrÃ¤ften an, die 10+ Stunden pro Woche sparen",
  "products.teach.cta.primary": "Kostenlose Testversion starten",
  "products.teach.cta.secondary": "Demo planen",

  // Products - Draft (German)
  "products.draft.hero.eyebrow": "KI-SCHREIBASSISTENT Fï¿½SR LEHRKRï¿½FTE",
  ...
  "products.draft.turn.pain2": "Schwierigkeiten, den richtigen Ton fÃ¼r sensible Kommunikation zu finden",
  ...
  "products.draft.features.translationChecks.title": "ï¿½SbersetzungsprÃ¼fungen",
  "products.draft.features.translationChecks.desc": "Kommunizieren Sie selbstbewusst mit Familien in Ã¼ber 20 Sprachen",
  "products.draft.features.reviewSteps.title": "ï¿½SberprÃ¼fungsschritte",
  "products.draft.features.reviewSteps.desc":
    "Integrierter ï¿½SberprÃ¼fungsprozess gewÃ¤hrleistet Genauigkeit vor dem Senden",
  ...
  "products.draft.howItWorks.step2.desc": "WÃ¤hlen Sie die richtige Stimme fÃ¼r Ihre Nachricht",
  "products.draft.howItWorks.step3.title": "ï¿½SberprÃ¼fen & Senden",
  ...
  "products.draft.whoItsFor.item1": "LehrkrÃ¤fte, die Elternkommunikation schreiben",
  "products.draft.whoItsFor.item2": "PÃ¤dagogen, die Zeugniskommentare erstellen",
  "products.draft.whoItsFor.item3": "Schulen, die konsistente, professionelle Kommunikation benÃ¶tigen",
  ...
  "products.draft.social.quote1": "Ich habe meinen Sonntag zurÃ¼ckbekommen. Draft verwandelt Stunden in Minuten.",
  ...
  "products.draft.cta.subtitle": "Schlieï¿½xen Sie sich 500+ LehrkrÃ¤ften an, die jede Woche 10+ Stunden sparen",
  ...
  "products.gradeflow.turn.pain2": "Inkonsistentes Feedback bei Ã¤hnlichen SchÃ¼lerarbeiten",
  ...
  "products.gradeflow.change.step2": "KI analysiert SchÃ¼lerarbeit anhand von Kriterien",
  "products.gradeflow.change.step3": "Vorgeschlagene Noten und Feedback Ã¼berprÃ¼fen und anpassen",
  ...
  "products.gradeflow.features.fair.desc": "Stellen Sie faire, standardkonforme Bewertung fÃ¼r alle SchÃ¼ler sicher",
  "products.gradeflow.features.audit.title": "PrÃ¼fpfad",
  "products.gradeflow.features.audit.desc": "Verfolgen Sie alle Bewertungsentscheidungen mit vollstÃ¤ndiger Transparenz",
  ...
  "shield.hero.eyebrow": "KI-GOVERNANCE Fï¿½SR SCHULEN",
  ...
  "shield.solution.subtitle": "ï¿½Sberwachen, kontrollieren und prÃ¼fen Sie die gesamte KI-Nutzung in Ihrer Schule",
  ...
  "shield.solution.card2.description": "VollstÃ¤ndige Sichtbarkeit aller KI-Interaktionen und DatenflÃ¼sse",
  "shield.solution.card3.title": "Datenschutz",
  "shield.solution.card3.description": "Automatische PII-Erkennung und -SchwÃ¤rzung vor der KI-Verarbeitung",
  "shield.solution.card4.title": "Richtliniendurchsetzung",
  "shield.solution.card4.description": "Automatisierte Compliance-PrÃ¼fungen gegen die Richtlinien Ihrer Schule",
  ...
  "shield.howItWorks.step2.description": "Definieren Sie Regeln fÃ¼r KI-Nutzung, Datenverarbeitung und Compliance",
  "shield.howItWorks.step3.title": "ï¿½Sberwachen & PrÃ¼fen",
  ...
  "shield.useCases.card2.description": "ï¿½Sberwachen und leiten Sie angemessene KI-Nutzung in SchÃ¼lerarbeiten",
  "shield.useCases.card3.title": "Administrative KI",
  "shield.useCases.card3.description": "Sichere KI-Nutzung fÃ¼r Planung, Kommunikation und Betrieb",
  ...
  "shield.comparison.row3.manual": "Manuelle ï¿½SberprÃ¼fung",

  "shield.pricing.title": "Enterprise-Preise",
  "shield.pricing.description":
    "Individuelle Preisgestaltung basierend auf Ihrer SchulgrÃ¶ï¿½xe und Ihren Anforderungen. Kontaktieren Sie uns fÃ¼r ein Angebot.",
  "shield.pricing.cta": "Preise erhalten",

  "shield.finalCta.title": "Bereit, die KI Ihrer Schule zu sichern?",
  "shield.finalCta.subtitle":
    "Schlieï¿½xen Sie sich zukunftsorientierten Schulen an, die Shield nutzen, um KI sicher einzusetzen",
  ...
  // FAQ Page (German)
  "faq.hero.eyebrow": "Hï¿½UFIG GESTELLTE FRAGEN",
  "faq.hero.title": "Wie kÃ¶nnen wir Ihnen helfen?",
  "faq.hero.subtitle": "Finden Sie Antworten auf hÃ¤ufige Fragen zu Zaza Draft und unseren KI-Tools fÃ¼r LehrkrÃ¤fte.",

  // FAQ Categories (German)
  "faq.category.about.title": "ï¿½Sber Zaza Draft",
  ...
  "faq.category.languages.title": "Sprachen & ï¿½Sbersetzung",
  ...
  "faq.about.q4": "BenÃ¶tige ich technische Kenntnisse, um Zaza Draft zu verwenden?",
  "faq.about.a4":
  ...
  "faq.about.a9":
    "Ja! Zaza Draft ist weltweit verfÃ¼gbar und unterstÃ¼tzt Kommunikation in Ã¼ber 20 Sprachen. Egal, ob Sie in den USA, Groï¿½xbritannien, Kanada, Australien oder anderswo sind, Draft kann Ihnen helfen, effektiv zu kommunizieren.",
  ...
  "faq.safety.a1":
    "Ja. Wir nehmen Datensicherheit ernst. Alle Daten sind wÃ¤hrend der ï¿½Sbertragung und im Ruhezustand verschlÃ¼sselt, wir sind FERPA-konform und wir verwenden Ihre Daten niemals zum Trainieren unserer Modelle oder teilen sie mit Dritten. Ihre Kommunikation bleibt privat und sicher.",
  ...
  "faq.safety.a3":
    "Ja. Zaza Draft ist mit Blick auf FERPA-KonformitÃ¤t entwickelt. Wir implementieren angemessene Schutzmaï¿½xnahmen zum Schutz der PrivatsphÃ¤re von SchÃ¼lern und Bildungsunterlagen, und wir teilen oder verkaufen niemals SchÃ¼lerdaten.",
  ...
  "faq.safety.a6":
    "Ja. Wir erfÃ¼llen die DSGVO-Anforderungen fÃ¼r Datenschutz und PrivatsphÃ¤re. Benutzer haben volle Kontrolle Ã¼ber ihre Daten, einschlieï¿½xlich des Rechts auf Zugriff, Korrektur und LÃ¶schung ihrer Informationen.",
  ...
  "faq.features.a2":
    "Ja! Draft kann Ihre Kommunikation in Ã¼ber 20 Sprachen Ã¼bersetzen, was es einfach macht, mit Familien zu kommunizieren, die verschiedene Sprachen sprechen. ï¿½Sbersetzungen bewahren den angemessenen Ton und pÃ¤dagogischen Kontext.",
  ...
  "faq.features.q4": "Kann ich Vorlagen oder hÃ¤ufig verwendete Phrasen speichern?",
  "faq.features.a4":
  ...
  "faq.pricing.a3":
    "Ja! Wir bieten spezielle Preise fÃ¼r Schulen und Bezirke an, einschlieï¿½xlich Mengenrabatten, zentralisierter Abrechnung und zusÃ¤tzlicher Funktionen wie Teamzusammenarbeit und Admin-Kontrollen. Kontaktieren Sie unser Vertriebsteam fÃ¼r ein individuelles Angebot.",
  ...
  "faq.languages.q2": "Wie genau sind die ï¿½Sbersetzungen?",
  "faq.languages.a2":
    "Unsere ï¿½Sbersetzungen sind speziell fÃ¼r pÃ¤dagogische Kontexte kalibriert und bewahren angemessenen Ton und FormalitÃ¤t. WÃ¤hrend wir empfehlen, ï¿½Sbersetzungen fÃ¼r kritische Kommunikation von Muttersprachlern Ã¼berprÃ¼fen zu lassen, sind unsere ï¿½Sbersetzungen sehr genau und kontextuell angemessen.",
  ...
  "faq.schools.q1": "Wie funktioniert Zaza Draft fÃ¼r ganze Schulen oder Bezirke?",
  "faq.schools.a1":
  ...
  "about.overview.hero.eyebrow": "ï¿½SBER ZAZA",
  ...
  "about.overview.timeline.2024.body":
    "VerÃ¶ffentlichung von Zaza Draft fÃ¼r Ã¼ber 100 Beta-LehrkrÃ¤fte. ï¿½Sber 50.000 Stunden Schreibzeit gespart.",
  ...
  "founder.hero.headline": "Lernen Sie den Grï¿½nder kennen, der KI fï¿½r Lehrkrï¿½fte entwickelt",
  "founder.hero.subheading": "Ich habe ï¿½ber zwanzig Jahre im Bereich Lernen und Bildung gearbeitet - an Universitï¿½ten, in der Unternehmensbildung und im EdTech-Bereich. Eines war immer wahr: Unterrichten ist menschliche Arbeit.",
  "founder.hero.label": "GRï¿½NDER & CEO",
  "founder.hero.name": "Dr. Greg Blackburn",
  "founder.hero.tagline": "Grï¿½nder & CEO, Lernwissenschaftler, Lehrer-Befï¿½rworter",

  // Founder Journey Section (German)
  "founder.journey.title": "Meine Reise in der Bildung",
  "founder.journey.p1": "Wï¿½hrend meiner Promotion in Berufspï¿½dagogik habe ich mich darauf konzentriert, wie Lernende kritisches Denken und Problemlï¿½sung in realen Umgebungen entwickeln. Ich habe gesehen, wie Technologie das Lernen unterstï¿½tzen kann, wenn sie richtig eingesetzt wird. Ich habe aber auch gesehen, wie leicht sie Stress verursachen, Zeit verschwenden oder gegen das arbeiten kann, was Pï¿½dagogen erreichen wollen.",
  "founder.journey.p2": "Als Chief Learning Officer bei Communardo leite ich Arbeiten im Bereich KI-gestï¿½tztes Lerndesign, digitale Inhaltsentwicklung, LMS-Innovation und Lehrerfortbildung. Ich habe viel ï¿½ber Lernwissenschaft, eLearning-Strategie und die Rolle von KI in der Bildung geschrieben und gesprochen.",
  "founder.journey.p3": "Aber hier ist die Wahrheit: Die meisten EdTech-Tools sind nicht fï¿½r Lehrkrï¿½fte gebaut. Sie sind fï¿½r Verkaufsgesprï¿½che gebaut.",
  "founder.journey.p4": "Ich habe beobachtet, wie Technologie als 'revolutionï¿½r' verkauft wurde, nur um zu einem weiteren System zu werden, das Lehrkrï¿½fte verwalten mï¿½ssen. Ich habe KI-Produkte gesehen, die Inhalte generieren, die auf den ersten Blick beeindruckend aussehen  aber zusammenbrechen, sobald eine Lehrkraft versucht, sie mit echten Schï¿½lern zu verwenden.",
  ...
  "founder.principle.question": "Gibt dies Lehrkrï¿½ften wertvolle Zeit zurï¿½ck?",
  "founder.principle.not1": "Nicht 'Ist das clever?'",
  "founder.principle.not2": "Nicht 'Lï¿½sst sich das gut demonstrieren?'",
  "founder.principle.not3": "Nicht 'Sieht das gut in einer Roadmap aus?'",
  "founder.principle.answer": "Zeit.",
  "founder.principle.rule": "Wenn ein Tool die Arbeitsbelastung in einer echten Schulumgebung nicht reduzieren kann, gehï¿½rt es nicht in Zaza.",

  // Founder Commitments Section (German)
  "founder.commitments.title": "Meine Verpflichtungen gegenï¿½ber Lehrkrï¿½ften",
  "founder.commitments.item1.title": "Keine Halluzinationen.",
  "founder.commitments.item1.body": "Wenn KI-Ausgaben nicht vertrauenswï¿½rdig sind, leisten Lehrkrï¿½fte am Ende mehr Arbeit bei der ï¿½berprï¿½fung und Korrektur. Deshalb entwickeln wir fï¿½r Genauigkeit, Klarheit und Klassenzimmerrealitï¿½t.",
  "founder.commitments.item2.title": "Arbeitsbelastung reduzieren, nicht verlagern.",
  "founder.commitments.item2.body": "Ein Tool, das Schulungen, Handbï¿½cher und komplexe Arbeitsablï¿½ufe erfordert, ist keine Unterstï¿½tzung. Es ist umbenannte Arbeit.",
  "founder.commitments.item3.title": "Professionelle Expertise respektieren.",
  "founder.commitments.item3.body": "Sie brauchen keine Technologie, die Ihr Urteilsvermï¿½gen ersetzt. Sie brauchen Technologie, die es verstï¿½rkt.",
  "founder.commitments.closing": "Unterrichten ist unglaublich komplexe, intellektuell anspruchsvolle Arbeit. Es ist auch emotional belastende Arbeit. Gute Tools sollten diese Last erleichtern.",

  // Founder Why Zaza Section (German)
  "founder.whyZaza.title": "Warum es Zaza gibt",
  "founder.whyZaza.p1": "Zaza versucht nicht, 'Bildung zu disruptieren.' Lehrkrï¿½fte brauchen keine Disruption. Sie brauchen Unterstï¿½tzung. Sie brauchen Zeit. Sie brauchen Tools, die den Wert ihrer Erfahrung anerkennen  anstatt zu versuchen, sie zu standardisieren oder zu ersetzen.",
  "founder.whyZaza.p2": "Die Arbeit, die Lehrkrï¿½fte leisten, ist wichtig. Und das Beste, was Technologie tun kann, ist zu helfen, die Zeit, Energie und Fï¿½rsorge zu schï¿½tzen, die erforderlich sind, um diese Arbeit gut zu machen.",
  "founder.whyZaza.p3": "Wenn das die Art von Zukunft fï¿½r Bildung ist, an die Sie glauben, sind Sie hier richtig.",

  // Founder Closing (German)
  "founder.closing.name": "Greg",
  "founder.closing.title": "Dr. Greg Blackburn",
  "founder.closing.role": "Grï¿½nder & CEO, Zaza Technologies",
  "founder.personal.cta": "Kontakt aufnehmen",

  // Additional Founder Keys (German - for page compatibility)
  "founder.journey.quote": "Ich habe Zaza entwickelt, weil ich es satt hatte, Lehrkrï¿½fte in administrativer Arbeit ertrinken zu sehen, wenn Technologie sie befreien sollte.",
  "founder.mission.quote": "Jede Lehrkraft verdient Tools, die ihre Expertise respektieren, ihre Schï¿½ler schï¿½tzen und ihnen Zeit geben, das zu tun, was sie am besten kï¿½nnen: unterrichten.",
  "founder.mission.attribution": "Dr. Greg Blackburn, Grï¿½nder & CEO",
  "founder.whyZaza.subtitle": "Drei Prinzipien, die alles leiten, was wir tun",
  "founder.whyZaza.card1.title": "Fï¿½r Lehrkrï¿½fte, mit Lehrkrï¿½ften",
  "founder.whyZaza.card1.body": "Ich habe meine Karriere damit verbracht, mit Lehrkrï¿½ften und Lerndesignern zusammenzuarbeiten - Tools direkt mit Pï¿½dagogen zu verfeinern, die die Realitï¿½t von Klassenzimmern verstehen. Jede Funktion in Zaza wird durch echtes Feedback und echte Praxis geformt, nicht durch Theorie.",
  "founder.whyZaza.card2.title": "Boutique, nicht Big Tech",
  "founder.whyZaza.card2.body": "Wir sind kein riesiges Unternehmen, das an jeden verkaufen will. Wir sind ein fokussiertes Team, das spezialisierte Tools fï¿½r ein Publikum entwickelt: Lehrkrï¿½fte. Ihre Bedï¿½rfnisse stehen immer an erster Stelle.",
  "founder.whyZaza.card3.title": "Ein Vermï¿½chtnis aufbauen",
  "founder.whyZaza.card3.body": "Es geht nicht um schnelle Gewinne. Es geht darum, etwas zu schaffen, das Lehrkrï¿½ften wirklich hilft zu gedeihen und Bildung zum Besseren verï¿½ndert. Das ist das Vermï¿½chtnis, das ich hinterlassen mï¿½chte.",
  // Founder Personal Message Section (German)
  "founder.personal.title": "Eine persï¿½nliche Notiz",
  "founder.personal.message1": "Wenn Sie dies lesen, sind Sie wahrscheinlich eine Lehrkraft, die neugierig auf KI ist, aber skeptisch, ob sie wirklich helfen kann. Ich verstehe das. Ich war auch skeptisch. Die meisten KI-Tools fï¿½hlen sich an, als wï¿½ren sie von Menschen entwickelt worden, die nie einen Fuï¿½ in ein Klassenzimmer gesetzt haben.",
  "founder.personal.message2": "Deshalb habe ich Zaza anders entwickelt. Jede Funktion wird mit echten Lehrkrï¿½ften entwickelt, in echten Klassenzimmern getestet und basierend auf echtem Feedback verfeinert. Wir entwickeln nicht nur Software - wir bauen Partnerschaften mit Pï¿½dagogen auf, die uns helfen, Tools zu erstellen, die wirklich funktionieren.",
  "founder.personal.message3": "Ich wï¿½rde gerne von Ihnen hï¿½ren. Ob Sie Fragen, Feedback haben oder einfach nur ï¿½ber Bildung und Technologie sprechen mï¿½chten, meine Tï¿½r steht immer offen. Lassen Sie uns gemeinsam die Zukunft der Lehrertechnologie gestalten.",
  "founder.personal.name": "",
  "founder.personal.title2": "Dr. Greg Blackburn",
  "founder.personal.company": "Zaza Technologies",
  // Contact Page (German)
  "contact.title": "Kontakt aufnehmen",
  "contact.subtitle": "Haben Sie Fragen? Mï¿½chten Sie mehr erfahren? Wir freuen uns, von Ihnen zu hï¿½ren.",
  "contact.form.name": "Ihr Name",
  "contact.form.email": "Ihre E-Mail",
  "contact.form.message": "Ihre Nachricht",
  "contact.form.placeholder": "Sagen Sie uns, wie wir helfen kï¿½nnen...",
  "contact.form.submit": "Nachricht senden",
  "contact.form.dataNote": "Wir respektieren Ihre Privatsphï¿½re. Ihre Informationen werden niemals weitergegeben.",
  ...
  "contact.help.faq": "ï¿½ Hï¿½ufig gestellte Fragen",
  "contact.help.support": "ï¿½ Support-Center",
