...
// Replace/add to the existing pricing.* keys
  ...
  "pricing.hero.subheadline": "Save hours every week, reduce after-hours stress, and write with confidence � with pricing that's simple and fair.",
  ...
  // Outcome Proof
  "pricing.outcome.text": "Most teachers spend 3�5 hours/week on messages and comments. Draft cuts that by 50�70% while preserving your tone and intent.",
  ...
  "pricing.bundle.description": "One place to plan, write, and communicate � with teacher-first wellbeing at the centre.",
  ...
  "pricing.testimonials.1.quote": "Draft gave me back my evenings. I now leave school on time � and parents say my messages feel warmer.",
  ...
  "pricing.faq.a1": "Yes � start with 5 drafts/month to feel the difference. No credit card required.",
  ...
  "pricing.faq.a4": "Absolutely � no lock-ins. Cancel from your account settings with one click.",
  "pricing.faq.q5": "Do you support schools?",
  "pricing.faq.a5": "Yes � volume pricing, SSO, DPA/SCCs, and SLAs for districts. Contact sales@zazadraft.com",
  "pricing.faq.q6": "Do you offer refunds?",
  "pricing.faq.a6": "Yes � 30-day money-back guarantee on all paid plans. No questions asked.",
  
  // CTA Section
  "pricing.cta.title": "Ready to save hours every week?",
  "pricing.cta.subtitle": "Start free today ⬢ No credit card required ⬢ Cancel anytime",
  ...
  // Company Page (English) - CREDIBILITY-PROTECTED VERSION
...
const translationsDe: Record<string, string> = {
  ...
  "pricing.hero.headline": "Preise, die die Zeit und das Wohlbefinden von Lehrkräften respektieren",
  "pricing.hero.subheadline": "Sparen Sie jede Woche Stunden, reduzieren Sie Stress nach Feierabend und schreiben Sie mit Zuversicht � mit Preisen, die einfach und fair sind.",
  ...
  "pricing.identity.point1": "weniger Zeit mit Schreiben und mehr Zeit mit Unterrichten verbringen möchten",
  "pricing.identity.point2": "vertrauenswürdige Sprachunterstützung benötigen, ohne ihre Stimme zu verlieren",
  "pricing.identity.point3": "sich um Grenzen, Zuversicht und Ruhe in ihrer Woche kümmern",
  ...
  // Outcome Proof
  "pricing.outcome.text": "Die meisten Lehrkräfte verbringen 3�5 Stunden pro Woche mit Nachrichten und Kommentaren. Draft reduziert dies um 50�70 %, während Ihr Ton und Ihre Absicht erhalten bleiben.",
  ...
  "pricing.teacher.feature1": "Unbegrenzte Entwürfe & �Sberarbeitungen",
  "pricing.teacher.feature2": "Ton-Tutor, �Sbersetzungen, Kontext-Gedächtnis",
  ...
  "pricing.department.badge": "TEAMS",
  "pricing.department.title": "Department",
  "pricing.department.description": "Kollaboratives Schreiben mit gemeinsamer Qualität und Konsistenz.",
  ...
  "pricing.department.feature3": "�Sberprüfung & Freigabe",
  "pricing.department.feature4": "Priorisiertes Onboarding & Erfolg",
  
  // Schools & Districts
  "pricing.enterprise.badge": "ENTERPRISE",
  "pricing.enterprise.title": "Schulen & Bezirke",
  "pricing.enterprise.description": "Alles für gro�xflächige Bereitstellungen.",
  ...
  "pricing.bundle.title": "Draft + Teach",
  "pricing.bundle.description": "Ein Ort zum Planen, Schreiben und Kommunizieren � mit lehrerorientierten Wohlbefinden im Mittelpunkt.",
  ...
  "pricing.testimonials.1.quote": "Draft gab mir meine Abende zurück. Ich verlasse jetzt die Schule pünktlich � und Eltern sagen, meine Nachrichten fühlen sich wärmer an.",
  "pricing.testimonials.2.name": "Mark R.",
  ...
  "pricing.testimonials.3.quote": "Die Preisgestaltung ist transparent und fair. Keine versteckten Gebühren, keine Lock-ins. Funktioniert einfach.",
  
  // Wellbeing Metric
  "pricing.metric.text": "�Sber 90 Tage berichten Lehrkräfte von 38 % weniger Nachrichten nach Feierabend und +24 % Zuversicht in der Elternkommunikation.",
  
  // FAQs
  "pricing.faq.title": "Preis- und Abrechnungs-FAQs",
  "pricing.faq.q1": "Gibt es einen kostenlosen Plan?",
  "pricing.faq.a1": "Ja � beginnen Sie mit 5 Entwürfen pro Monat, um den Unterschied zu spüren. Keine Kreditkarte erforderlich.",
  ...
  "pricing.faq.a3": "Ja. Wir verwenden Ihre Inhalte nicht, um öffentliche Modelle zu trainieren. Weitere Details finden Sie auf unserer Datenschutzseite.",
  "pricing.faq.q4": "Kann ich jederzeit kündigen?",
  "pricing.faq.a4": "Absolut � keine Lock-ins. Kündigen Sie mit einem Klick in Ihren Kontoeinstellungen.",
  "pricing.faq.q5": "Unterstützen Sie Schulen?",
  "pricing.faq.a5": "Ja � Mengenpreise, SSO, DPA/SCCs und SLAs für Bezirke. Kontakt: sales@zazadraft.com",
  "pricing.faq.q6": "Bieten Sie Rückerstattungen an?",
  "pricing.faq.a6": "Ja � 30-Tage-Geld-zurück-Garantie auf alle kostenpflichtigen Pläne. Keine Fragen gestellt.",
  
  // CTA Section
  "pricing.cta.title": "Bereit, jede Woche Stunden zu sparen?",
  "pricing.cta.subtitle": "Heute kostenlos starten ⬢ Keine Kreditkarte erforderlich ⬢ Jederzeit kündbar",
  ...
  // Suite Page Hero (DE)
  "suite.hero.title": "Zaza ist eine Familie sicherer, lehrerzentrierter KI-Apps, die zusammenarbeiten, um den Arbeitsaufwand zu reduzieren und die Effizienz sowie das Wohlbefinden von Lehrkräften zu stärken.",
  "suite.hero.subhead": "Jede App wird von der Zaza KnowledgeCore Plattform betrieben und bietet vertrauenswürdige, erklärbare KI sowie konsistente, schulbereite Schutzmechanismen.",

  // Suite - Teacher First (DE)
  "suite.teacherFirst.title": "Für Lehrkräfte entwickelt",
  "suite.teacherFirst.body": "Zaza gibt Zeit zurück und lässt Pädagoginnen und Pädagogen sich aufs Unterrichten konzentrieren. Alles ist mit Datenschutz, Schutzkonzepten und Pädagogik im Kern gestaltet, sodass Schulen dem Einsatz vertrauen können.",

  // Suite - Core Apps (DE)
  "suite.coreApps.title": "Die vier Kern-Apps",
  "suite.teach.body": "KI-gestützte Unterrichtsplanung, die sich an Ihren Lehrplan anpasst, Stunden Vorbereitungszeit spart und den Unterricht spannend sowie standardkonform hält.",
  ...
  "features.how.step1.desc": "Tippen oder fügen Sie Ihren Entwurf zum Schüler ein",
  ...
  "features.how.step3.desc": "Exportieren Sie Ihre überarbeitete Nachricht in Sekunden",
  ...
  "resources.subtitle": "Zeitspartools für den sofortigen Einsatz. Als PDF oder DOCX herunterladen.",
  "resources.download": "Herunterladen",
  "resources.comingSoon": "Demnächst",
  "resources.published": "Veröffentlicht",
  "suite.teach.li2": "Lehrplanbewusst: Common Core + internationale Rahmenpläne",
  "suite.teach.li3": "Hilfen zur Differenzierung und kreative Aktivitätsideen",
  "suite.teach.cta": "Mehr über Teach erfahren",

  "suite.draft.body": "Kommentare und Berichte ohne Burnout - klare, wertschätzende Kommunikation, fundiert in Forschung zum Wohlbefinden von Lehrkräften.",
  "suite.draft.li1": "Vorlagen für Berichte und Kommentare, die Sie anpassen können",
  "suite.draft.li2": "Tonleitfäden und Bias-Prüfungen für faires, unterstützendes Feedback",
  "suite.draft.li3": "Standardmä�xig privat; für professionelle, elternreife Texte entwickelt",
  "suite.draft.cta": "Mehr über Draft erfahren",

  "suite.gradeflow.body": "Ein erklärbarer Bewertungs-Copilot mit OCR, Rubriken und evidenzbasiertem Feedback - schneller korrigieren mit Fairness und Konsistenz.",
  "suite.gradeflow.li1": "Rubrik-konformes, prüffähiges Feedback mit Nachweisen",
  ...
  "suite.shield.body": "Kommunikationsmanagement, das das Wohlbefinden von Lehrkräften schützt - entwirft schwierige E-Mails und hilft, gesunde Grenzen zu wahren.",
  "suite.shield.li1": "Entwurfs-Assistent für sensible Eltern- und Verwaltungsnachrichten",
  ...
  "suite.why.timeSaved": "Zeitersparnis: Lehrkräfte gewinnen jede Woche Stunden zurück.",
  "suite.why.retention": "Bindung unterstützt: Weniger Stress und gerechtere Arbeitslast.",
  "suite.why.safety": "Sicher und konform: Datenschutz und Schutz standardmä�xig.",
  "suite.why.evidence": "Evidenzbasiert: Pädagogik und Nachvollziehbarkeit, nicht nur Tempo.",

  // Suite - Roadmap (DE)
  "suite.roadmap.title": "Bereit für die Roadmap",
  "suite.roadmap.body": "Geplante Erweiterungen umfassen intelligentere Elternkommunikation, Synthese formativer Bewertungen und Unterstützung bei Differenzierung - alles über KnowledgeCore bereitgestellt, damit der Nutzen überall ankommt, nicht nur in einem einzelnen Tool.",

  // Suite - CTA (DE)
  "suite.cta.title": "Jetzt entdecken",
  "suite.cta.body": "Ob Sie als Lehrkraft Entlastung suchen oder als Schule skalierbare Unterstützung: Zaza hilft Ihrem Team zu gedeihen.",
  ...
  "suite.hiw.step1.desc": "Teach fürs Planen, Draft fürs Schreiben, GradeFlow fürs Bewerten, Shield für Grenzen.",
  "suite.hiw.step2.title": "Eigenen Kontext hinzufügen",
  "suite.hiw.step2.desc": "Lehrplan, Klassendetails, Rubriken und Ton flie�xen einmal in KnowledgeCore ein und gelten überall.",
  "suite.hiw.step3.title": "Schulreife Ergebnisse erhalten",
  "suite.hiw.step3.desc": "Vertrauenswürdige, erklärbare Resultate mit konsistenten Schutzmechanismen in jedem Workflow.",

  // Suite - Testimonials (DE)
  "suite.testimonials.title": "Stimmen aus der Praxis",
  "suite.testimonials.1.quote": "Ich bekomme meinen Sonntag zurück. Planung und Elternkommunikation dauern jetzt Minuten statt Stunden.",
  "suite.testimonials.1.author": "Sarah Mitchell",
  "suite.testimonials.1.role": "Grundschullehrerin, UK",
  "suite.testimonials.2.quote": "Konsistente Bewertung mit klaren Nachweisen. GradeFlow hat die Qualität klassenübergreifend erhöht.",
  "suite.testimonials.2.author": "Michael Brown",
  "suite.testimonials.2.role": "Oberstufenlehrer, USA",
  "suite.testimonials.3.quote": "Draft schützt Ton und Wohlbefinden. Ich kommuniziere mehr � mit weniger Stress.",
  "suite.testimonials.3.author": "Emma Rodriguez",
  ...
  "suite.screens.caption": "Ein schneller Blick auf Planungs-, Schreib- und Bewertungsabläufe.",
  ...
  "webinars.cta.body": "Schlie�xen Sie sich Tausenden Lehrkräften an, die ihre Praxis mit KI transformieren. Melden Sie sich noch heute für Ihr erstes Webinar an.",
  ...
  "community.hero.subtitle": "Vernetzen Sie sich weltweit mit Lehrkräften. Teilen Sie Strategien, stellen Sie Fragen und lernen Sie von erfolgreichen Praxisbeispielen zum Einsatz von KI im Unterricht.",
  ...
  "community.categories.prompt-engineering.name": "Prompt-Engineering",
  "community.categories.prompt-engineering.desc": "Teilen und diskutieren Sie wirksame Prompts für unterschiedliche Unterrichtsszenarien.",
  "community.categories.lesson-planning.name": "Unterrichtsplanung",
  "community.categories.lesson-planning.desc": "Gemeinsam KI-gestützte Unterrichts- und Einheitenplanung erarbeiten.",
  "community.categories.parent-communication.name": "Elternkommunikation",
  "community.categories.parent-communication.desc": "Tipps für den KI�Einsatz zur Verbesserung der Eltern-Lehrer-Kommunikation.",
  "community.categories.assessment-feedback.name": "Bewertung & Feedback",
  "community.categories.assessment-feedback.desc": "KI-Tools für Korrektur, Feedback und formative Beurteilung diskutieren.",
  "community.categories.differentiation.name": "Differenzierung & Förderpläne",
  "community.categories.differentiation.desc": "Mit KI vielfältige Lernende unterstützen und Nachteilsausgleiche erstellen.",
  ...
  "community.categories.off-topic.name": "Off-Topic-Lounge",
  "community.categories.off-topic.desc": "Austausch zu Themen au�xerhalb von KI.",
  // Abzeichen
  ...
  "community.badges.helpful.desc": "�Sber 50 Likes erhalten",
  ...
  "community.guidelines.li3": "Schülerdatenschutz wahren",
  ...
  "community.related.desc": "Vertiefen Sie Ihr Community�Erlebnis mit diesen Lernressourcen",
  ...
  "community.related.webinars.desc": "Live�Sessions zu aktuellen Community�Themen",
  ...
  "community.cta.body": "Erstellen Sie kostenlos ein Konto und vernetzen Sie sich mit Tausenden Lehrkräften, die KI im Unterricht einsetzen.",
  "community.cta.primary": "Kostenloses Konto erstellen",
  "community.cta.secondary": "Als Gast stöbern",

  "about.nav.title": "�Sber uns",
  ...
  "hallucinationSafe.tooltip.body":
    "Im Gegensatz zu generischen KI-Tools ist Zaza Draft speziell darauf trainiert, keine Schülerinformationen zu erfinden, keine Elterngespräche zu fabrizieren oder Details über Ihre Klasse zu konstruieren. Jede Ausgabe basiert ausschlie�xlich auf Ihren tatsächlichen Angaben - keine erfundenen Fakten, keine fiktiven Szenarien.",
  ...
  "finalCTA.subheading": "Schlie�xen Sie sich 500+ Lehrkräften an, die mit Zaza Draft jede Woche 10+ Stunden sparen.",
  ...
  "footer.productEcosystem": "Produkt & �kosystem",
  ...
  "products.teach.features.title": "Alles, was Sie für gro�xartige Unterrichtsstunden brauchen",
  ...
  "products.teach.change.step3": "Stellen Sie die �Sbereinstimmung mit Lehrplanstandards sicher",
  ...
  "products.teach.cta.subtitle": "Schlie�xen Sie sich Hunderten von Lehrkräften an, die 10+ Stunden pro Woche sparen",
  "products.teach.cta.primary": "Kostenlose Testversion starten",
  "products.teach.cta.secondary": "Demo planen",

  // Products - Draft (German)
  "products.draft.hero.eyebrow": "KI-SCHREIBASSISTENT F�SR LEHRKR�FTE",
  ...
  "products.draft.features.translationChecks.title": "�Sbersetzungsprüfungen",
  "products.draft.features.translationChecks.desc": "Kommunizieren Sie selbstbewusst mit Familien in über 20 Sprachen",
  "products.draft.features.reviewSteps.title": "�Sberprüfungsschritte",
  "products.draft.features.reviewSteps.desc":
    "Integrierter �Sberprüfungsprozess gewährleistet Genauigkeit vor dem Senden",
  ...
  "products.draft.howItWorks.step3.title": "�Sberprüfen & Senden",
  ...
  "products.draft.cta.subtitle": "Schlie�xen Sie sich 500+ Lehrkräften an, die jede Woche 10+ Stunden sparen",
  ...
  "shield.hero.eyebrow": "KI-GOVERNANCE F�SR SCHULEN",
  ...
  "shield.solution.subtitle": "�Sberwachen, kontrollieren und prüfen Sie die gesamte KI-Nutzung in Ihrer Schule",
  ...
  "shield.howItWorks.step3.title": "�Sberwachen & Prüfen",
  ...
  "shield.useCases.card2.description": "�Sberwachen und leiten Sie angemessene KI-Nutzung in Schülerarbeiten",
  ...
  "shield.comparison.row3.manual": "Manuelle �Sberprüfung",

  "shield.pricing.title": "Enterprise-Preise",
  "shield.pricing.description":
    "Individuelle Preisgestaltung basierend auf Ihrer Schulgrö�xe und Ihren Anforderungen. Kontaktieren Sie uns für ein Angebot.",
  "shield.pricing.cta": "Preise erhalten",

  "shield.finalCta.title": "Bereit, die KI Ihrer Schule zu sichern?",
  "shield.finalCta.subtitle":
    "Schlie�xen Sie sich zukunftsorientierten Schulen an, die Shield nutzen, um KI sicher einzusetzen",
  ...
  // FAQ Page (German)
  "faq.hero.eyebrow": "H�UFIG GESTELLTE FRAGEN",
  ...
  "faq.category.about.title": "�Sber Zaza Draft",
  ...
  "faq.category.languages.title": "Sprachen & �Sbersetzung",
  ...
  "faq.about.a9":
    "Ja! Zaza Draft ist weltweit verfügbar und unterstützt Kommunikation in über 20 Sprachen. Egal, ob Sie in den USA, Gro�xbritannien, Kanada, Australien oder anderswo sind, Draft kann Ihnen helfen, effektiv zu kommunizieren.",
  ...
  "faq.safety.a1":
    "Ja. Wir nehmen Datensicherheit ernst. Alle Daten sind während der �Sbertragung und im Ruhezustand verschlüsselt, wir sind FERPA-konform und wir verwenden Ihre Daten niemals zum Trainieren unserer Modelle oder teilen sie mit Dritten. Ihre Kommunikation bleibt privat und sicher.",
  ...
  "faq.safety.a3":
    "Ja. Zaza Draft ist mit Blick auf FERPA-Konformität entwickelt. Wir implementieren angemessene Schutzma�xnahmen zum Schutz der Privatsphäre von Schülern und Bildungsunterlagen, und wir teilen oder verkaufen niemals Schülerdaten.",
  ...
  "faq.safety.a6":
    "Ja. Wir erfüllen die DSGVO-Anforderungen für Datenschutz und Privatsphäre. Benutzer haben volle Kontrolle über ihre Daten, einschlie�xlich des Rechts auf Zugriff, Korrektur und Löschung ihrer Informationen.",
  ...
  "faq.features.a2":
    "Ja! Draft kann Ihre Kommunikation in über 20 Sprachen übersetzen, was es einfach macht, mit Familien zu kommunizieren, die verschiedene Sprachen sprechen. �Sbersetzungen bewahren den angemessenen Ton und pädagogischen Kontext.",
  ...
  "faq.pricing.a3":
    "Ja! Wir bieten spezielle Preise für Schulen und Bezirke an, einschlie�xlich Mengenrabatten, zentralisierter Abrechnung und zusätzlicher Funktionen wie Teamzusammenarbeit und Admin-Kontrollen. Kontaktieren Sie unser Vertriebsteam für ein individuelles Angebot.",
  ...
  "faq.languages.q2": "Wie genau sind die �Sbersetzungen?",
  "faq.languages.a2":
    "Unsere �Sbersetzungen sind speziell für pädagogische Kontexte kalibriert und bewahren angemessenen Ton und Formalität. Während wir empfehlen, �Sbersetzungen für kritische Kommunikation von Muttersprachlern überprüfen zu lassen, sind unsere �Sbersetzungen sehr genau und kontextuell angemessen.",
  ...
  "about.overview.hero.eyebrow": "�SBER ZAZA",
  ...
  "about.overview.timeline.2024.body":
    "Veröffentlichung von Zaza Draft für über 100 Beta-Lehrkräfte. �Sber 50.000 Stunden Schreibzeit gespart.",
  ...
  "founder.hero.headline": "Lernen Sie den Gr�nder kennen, der KI f�r Lehrkr�fte entwickelt",
  "founder.hero.subheading": "Ich habe �ber zwanzig Jahre im Bereich Lernen und Bildung gearbeitet - an Universit�ten, in der Unternehmensbildung und im EdTech-Bereich. Eines war immer wahr: Unterrichten ist menschliche Arbeit.",
  "founder.hero.label": "GR�NDER & CEO",
  "founder.hero.name": "Dr. Greg Blackburn",
  "founder.hero.tagline": "Gr�nder & CEO, Lernwissenschaftler, Lehrer-Bef�rworter",

  // Founder Journey Section (German)
  "founder.journey.title": "Meine Reise in der Bildung",
  "founder.journey.p1": "W�hrend meiner Promotion in Berufsp�dagogik habe ich mich darauf konzentriert, wie Lernende kritisches Denken und Probleml�sung in realen Umgebungen entwickeln. Ich habe gesehen, wie Technologie das Lernen unterst�tzen kann, wenn sie richtig eingesetzt wird. Ich habe aber auch gesehen, wie leicht sie Stress verursachen, Zeit verschwenden oder gegen das arbeiten kann, was P�dagogen erreichen wollen.",
  "founder.journey.p2": "Als Chief Learning Officer bei Communardo leite ich Arbeiten im Bereich KI-gest�tztes Lerndesign, digitale Inhaltsentwicklung, LMS-Innovation und Lehrerfortbildung. Ich habe viel �ber Lernwissenschaft, eLearning-Strategie und die Rolle von KI in der Bildung geschrieben und gesprochen.",
  "founder.journey.p3": "Aber hier ist die Wahrheit: Die meisten EdTech-Tools sind nicht f�r Lehrkr�fte gebaut. Sie sind f�r Verkaufsgespr�che gebaut.",
  "founder.journey.p4": "Ich habe beobachtet, wie Technologie als 'revolution�r' verkauft wurde, nur um zu einem weiteren System zu werden, das Lehrkr�fte verwalten m�ssen. Ich habe KI-Produkte gesehen, die Inhalte generieren, die auf den ersten Blick beeindruckend aussehen  aber zusammenbrechen, sobald eine Lehrkraft versucht, sie mit echten Sch�lern zu verwenden.",
  ...
  "founder.principle.question": "Gibt dies Lehrkr�ften wertvolle Zeit zur�ck?",
  "founder.principle.not1": "Nicht 'Ist das clever?'",
  "founder.principle.not2": "Nicht 'L�sst sich das gut demonstrieren?'",
  "founder.principle.not3": "Nicht 'Sieht das gut in einer Roadmap aus?'",
  "founder.principle.answer": "Zeit.",
  "founder.principle.rule": "Wenn ein Tool die Arbeitsbelastung in einer echten Schulumgebung nicht reduzieren kann, geh�rt es nicht in Zaza.",

  // Founder Commitments Section (German)
  "founder.commitments.title": "Meine Verpflichtungen gegen�ber Lehrkr�ften",
  "founder.commitments.item1.title": "Keine Halluzinationen.",
  "founder.commitments.item1.body": "Wenn KI-Ausgaben nicht vertrauensw�rdig sind, leisten Lehrkr�fte am Ende mehr Arbeit bei der �berpr�fung und Korrektur. Deshalb entwickeln wir f�r Genauigkeit, Klarheit und Klassenzimmerrealit�t.",
  "founder.commitments.item2.title": "Arbeitsbelastung reduzieren, nicht verlagern.",
  "founder.commitments.item2.body": "Ein Tool, das Schulungen, Handb�cher und komplexe Arbeitsabl�ufe erfordert, ist keine Unterst�tzung. Es ist umbenannte Arbeit.",
  "founder.commitments.item3.title": "Professionelle Expertise respektieren.",
  "founder.commitments.item3.body": "Sie brauchen keine Technologie, die Ihr Urteilsverm�gen ersetzt. Sie brauchen Technologie, die es verst�rkt.",
  ...
  "founder.whyZaza.p1": "Zaza versucht nicht, 'Bildung zu disruptieren.' Lehrkr�fte brauchen keine Disruption. Sie brauchen Unterst�tzung. Sie brauchen Zeit. Sie brauchen Tools, die den Wert ihrer Erfahrung anerkennen  anstatt zu versuchen, sie zu standardisieren oder zu ersetzen.",
  "founder.whyZaza.p2": "Die Arbeit, die Lehrkr�fte leisten, ist wichtig. Und das Beste, was Technologie tun kann, ist zu helfen, die Zeit, Energie und F�rsorge zu sch�tzen, die erforderlich sind, um diese Arbeit gut zu machen.",
  "founder.whyZaza.p3": "Wenn das die Art von Zukunft f�r Bildung ist, an die Sie glauben, sind Sie hier richtig.",

  // Founder Closing (German)
  "founder.closing.name": "Greg",
  "founder.closing.title": "Dr. Greg Blackburn",
  "founder.closing.role": "Gr�nder & CEO, Zaza Technologies",
  "founder.personal.cta": "Kontakt aufnehmen",

  // Additional Founder Keys (German - for page compatibility)
  "founder.journey.quote": "Ich habe Zaza entwickelt, weil ich es satt hatte, Lehrkr�fte in administrativer Arbeit ertrinken zu sehen, wenn Technologie sie befreien sollte.",
  "founder.mission.quote": "Jede Lehrkraft verdient Tools, die ihre Expertise respektieren, ihre Sch�ler sch�tzen und ihnen Zeit geben, das zu tun, was sie am besten k�nnen: unterrichten.",
  ...
  "founder.whyZaza.card1.title": "F�r Lehrkr�fte, mit Lehrkr�ften",
  "founder.whyZaza.card1.body": "Ich habe meine Karriere damit verbracht, mit Lehrkr�ften und Lerndesignern zusammenzuarbeiten - Tools direkt mit P�dagogen zu verfeinern, die die Realit�t von Klassenzimmern verstehen. Jede Funktion in Zaza wird durch echtes Feedback und echte Praxis geformt, nicht durch Theorie.",
  "founder.whyZaza.card2.title": "Boutique, nicht Big Tech",
  "founder.whyZaza.card2.body": "Wir sind kein riesiges Unternehmen, das an jeden verkaufen will. Wir sind ein fokussiertes Team, das spezialisierte Tools f�r ein Publikum entwickelt: Lehrkr�fte. Ihre Bed�rfnisse stehen immer an erster Stelle.",
  "founder.whyZaza.card3.title": "Ein Verm�chtnis aufbauen",
  "founder.whyZaza.card3.body": "Es geht nicht um schnelle Gewinne. Es geht darum, etwas zu schaffen, das Lehrkr�ften wirklich hilft zu gedeihen und Bildung zum Besseren ver�ndert. Das ist das Verm�chtnis, das ich hinterlassen m�chte.",
  // Founder Personal Message Section (German)
  "founder.personal.title": "Eine pers�nliche Notiz",
  "founder.personal.message1": "Wenn Sie dies lesen, sind Sie wahrscheinlich eine Lehrkraft, die neugierig auf KI ist, aber skeptisch, ob sie wirklich helfen kann. Ich verstehe das. Ich war auch skeptisch. Die meisten KI-Tools f�hlen sich an, als w�ren sie von Menschen entwickelt worden, die nie einen Fu� in ein Klassenzimmer gesetzt haben.",
  "founder.personal.message2": "Deshalb habe ich Zaza anders entwickelt. Jede Funktion wird mit echten Lehrkr�ften entwickelt, in echten Klassenzimmern getestet und basierend auf echtem Feedback verfeinert. Wir entwickeln nicht nur Software - wir bauen Partnerschaften mit P�dagogen auf, die uns helfen, Tools zu erstellen, die wirklich funktionieren.",
  "founder.personal.message3": "Ich w�rde gerne von Ihnen h�ren. Ob Sie Fragen, Feedback haben oder einfach nur �ber Bildung und Technologie sprechen m�chten, meine T�r steht immer offen. Lassen Sie uns gemeinsam die Zukunft der Lehrertechnologie gestalten.",
  "founder.personal.name": "",
  "founder.personal.title2": "Dr. Greg Blackburn",
  "founder.personal.company": "Zaza Technologies",
  // Contact Page (German)
  "contact.title": "Kontakt aufnehmen",
  "contact.subtitle": "Haben Sie Fragen? M�chten Sie mehr erfahren? Wir freuen uns, von Ihnen zu h�ren.",
  "contact.form.name": "Ihr Name",
  "contact.form.email": "Ihre E-Mail",
  "contact.form.message": "Ihre Nachricht",
  "contact.form.placeholder": "Sagen Sie uns, wie wir helfen k�nnen...",
  "contact.form.submit": "Nachricht senden",
  "contact.form.dataNote": "Wir respektieren Ihre Privatsph�re. Ihre Informationen werden niemals weitergegeben.",
  ...
  "contact.help.faq": "� H�ufig gestellte Fragen",
  "contact.help.support": "� Support-Center",
  ...
  "company.hero.headline": "Zaza Technologies",
  "company.hero.subheading": "Wir sind ein kleines, spezialisiertes Team aus Lerndesignern, Ingenieuren und Bildungsforschern, die Technologie entwickeln, die Lehrkr�ften hilft, erfolgreich zu sein.",
  "company.origin.p1": "Zaza Technologies wurde 2025 mit einer klaren �berzeugung gegr�ndet: Bildung verdient KI-Tools, die auf echtem p�dagogischem Verst�ndnis basieren, nicht auf umfunktionierten Unternehmens-KI-Modellen. Im Laufe unserer Karrieren im Bereich Lernen und Bildung haben wir immer wieder dasselbe Muster gesehen - Technologie, die versprach, die Arbeitsbelastung zu reduzieren, f�hrte oft zu noch mehr Arbeit. Wir entwickeln Technologie, die das Wohlbefinden von Lehrkr�ften sch�tzt.",
  "company.origin.p2": "Also haben wir einen anderen Ansatz gew�hlt.",
  "company.origin.p3": "Wir entwickeln Tools, die auf echter P�dagogik trainiert, mit Lehrkr�ften entwickelt und durch den Einsatz im Klassenzimmer verfeinert werden. Tools, die die Nuancen des Lehrerurteils, das emotionale Gewicht der Kommunikation und die Bedeutung konstruktiven Feedbacks verstehen. Tools, die genau, zuverl�ssig und sicher f�r Bildungseinrichtungen sind.",
  "company.origin.p4": "Unser Ziel ist einfach: Lehrkr�ften bedeutsame Zeit zur�ckgeben.",
  "company.origin.aiDifferentiator": "Unsere Modelle werden anhand echten Lehrer-Feedbacks und Klassenzimmer-Sprachmustern trainiert, durch iterative Tests mit P�dagogen verfeinert und so konzipiert, dass die Ausgabe wie eine Lehrkraft klingt - nicht wie eine Maschine.",
  "company.philosophy.title": "Unsere Philosophie",
  "company.philosophy.intro": "Wir glauben nicht an \"KI, die Lehrkr�fte ersetzt.\" Wir glauben an KI, die Lehrkr�fte unterst�tzt.",
  "company.philosophy.principle1": "Tools m�ssen die Expertise von Lehrkr�ften respektieren.",
  "company.philosophy.principle2": "Tools m�ssen die Arbeitsbelastung reduzieren, nicht verlagern.",
  "company.philosophy.principle3": "Tools m�ssen Sch�ler und deren Lernumgebung sch�tzen.",
  "company.philosophy.principle4": "Tools m�ssen vertrauensw�rdig und transparent sein.",
  "company.philosophy.closing": "Wenn Technologie Lehrkr�ften nicht dabei hilft, das zu tun, was sie am besten k�nnen - unterrichten - dann geh�rt sie nicht ins Klassenzimmer.",
  "company.boutique.title": "Ein Boutique-Ansatz",
  "company.boutique.intro": "Wir sind bewusst kein gro�es Technologieunternehmen. Wir sind ein fokussiertes Team, das ausschlie�lich f�r ein Publikum entwickelt - Lehrkr�fte.",
  "company.boutique.means": "Das bedeutet:",
  "company.boutique.point1": "Wir arbeiten eng mit Lehrkr�ften in verschiedenen Regionen und Kontexten zusammen.",
  "company.boutique.point2": "Wir testen Funktionen direkt in echten Klassenzimmern.",
  "company.boutique.point3": "Wir priorisieren Klarheit, Sicherheit und Benutzerfreundlichkeit �ber Neuheit.",
  "company.boutique.closing": "Wir optimieren nicht f�r schnelles Wachstum. Wir optimieren daf�r, was funktioniert.",
  "company.boutique.impact": "Wachstum ist nicht das Ziel. Wirkung ist es.",
  "company.today.title": "Wo wir heute stehen",
  "company.today.p1": "Zaza unterst�tzt mittlerweile �ber 500 Lehrkr�fte in mehr als 15 L�ndern. Im Durchschnitt sparen Lehrkr�fte �ber 10 Stunden pro Woche bei Schreib- und Kommunikationsaufgaben durch die Nutzung von Zaza-Tools. Und wir fangen gerade erst an.",
  "company.today.p2": "Unsere langfristige Vision ist es, eine vollst�ndige Suite von KI-Tools zu entwickeln, die Lehrkr�ften helfen, ihre Zeit zur�ckzugewinnen, ihr Wohlbefinden zu sch�tzen und mit dem Kern ihrer Arbeit verbunden zu bleiben - ihren Sch�lern.",
  "company.today.close": "Denn wenn Lehrkr�fte gedeihen, gedeihen Sch�ler.",
  "company.stats.teachers.number": "500+",
  "company.stats.teachers.label": "Lehrkr�fte nutzen Zaza",
  "company.stats.countries.number": "15",
  "company.stats.countries.label": "L�nder",
  "company.stats.hours.number": "10+",
  "company.stats.hours.label": "W�chentlich gesparte Stunden",
}
