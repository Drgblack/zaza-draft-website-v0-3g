...
- _Greet at the door_ (names if possible). Quick scan for mood/materials.
- _Do Now visible_ (on screen/board) and **doable in 3-5 min**.
- _Timer running_ before students enter.
- _Materials ready_ (tray per table or bins).
- _Attendance_ during Do Now; circulate.
