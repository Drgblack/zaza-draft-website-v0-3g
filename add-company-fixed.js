...
let enInsertPoint = content.indexOf(
...
if (enInsertPoint > -1) {
  ...
  content =
    content.slice(0, afterComma) + companyEN + content.slice(afterComma);
...
// German insertion
let deInsertPoint = content.lastIndexOf(
...
if (deInsertPoint > -1) {
  ...
  content =
    content.slice(0, afterComma) + companyDE + content.slice(afterComma);
