      ...
      <div className="min-h-screen bg-[#0B1220]">
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-10 xl:gap-12 items-center">
              ...
              <div className="space-y-6">
                <div className="inline-block px-4 py-1.5 rounded-full bg-[#1F2937] border border-[#374151]">
                  <span className="text-sm font-medium text-[#D1D5DB]">{t("products.draft.hero.eyebrow")}</span>
                </div>
          ...
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-lg text-[#D1D5DB]">{t("products.draft.turn.pain1")}</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-red-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path
                ...
                <span className="text-lg text-[#D1D5DB]">{t("products.draft.turn.pain2")}</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-6 h-6 text-red-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path
                ...
                <span className="text-lg text-[#D1D5DB]">{t("products.draft.turn.pain3")}</span>
              </li>
            </ul>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[1, 2, 3, 4].map((num) => (
                <div key={num} className="flex items-start gap-4">
                  ...
                  <p className="text-[#D1D5DB]">{t(`products.draft.change.step${num}`)}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <Card className="bg-[#1F2937] border-[#374151] p-6">
              <p className="text-sm text-[#9CA3AF] text-center">
                <strong className="text-[#D1D5DB]">{t("products.draft.techNote.title")}</strong>{" "}
        ...
        <section className="py-16 bg-gradient-to-r from-[#7C3AED] to-[#3B82F6]">
          <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">{t("products.draft.cta.title")}</h2>
            <p className="text-xl text-white/90 mb-8">{t("products.draft.cta.subtitle")}</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-white text-[#7C3AED] hover:bg-gray-100 font-medium rounded-xl">
                <Link href="/pricing#draft">{t("products.draft.cta.primary")}</Link>
              </Button>
              <Button
                onClick={() => setDemoOpen(true)}
                size="lg"
