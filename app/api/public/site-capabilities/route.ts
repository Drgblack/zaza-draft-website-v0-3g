...
import { getPublicSiteCapabilities } from "@/lib/public-api/agent-foundation";
...
export async function GET(request: NextRequest) {
  const rateLimit = checkRateLimit(request, {
    namespace: "public-site-capabilities",
  ...
  return NextResponse.json(getPublicSiteCapabilities(), {
