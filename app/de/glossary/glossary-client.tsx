...
const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    example:
      "Sentiment analysis helps ensure your parent emails strike the right toneÃ¢â‚¬â€supportive rather than critical.",
    category: "Natural Language Processing",
  ...
  // Generative AI
  {
    ...
    term: "Generative AI",
    definition:
      "AI systems that can create new contentÃ¢â‚¬â€text, images, code, or other mediaÃ¢â‚¬â€based on patterns learned from training data.",
    example:
  ...
  // Future of AI
  {
    ...
    example:
      "Current AI tools like Zaza Draft are 'narrow AI'Ã¢â‚¬â€excellent at specific tasks but not capable of general human-like reasoning.",
  ...
  },
  {
    ...
    term: "Multimodal AI",
    definition:
      "AI systems that can process and generate multiple types of contentÃ¢â‚¬â€text, images, audio, and videoÃ¢â‚¬â€simultaneously.",
    example:
