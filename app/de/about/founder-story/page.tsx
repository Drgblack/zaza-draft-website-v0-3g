...
export const metadata: Metadata = {
  title: "Gründerstory von Greg | Zaza Draft",
  description:
    "Von der Malerlehre in Hobart bis zur Promotion und Gründung von Zaza Technologies – die ausführliche Gründerstory von Greg Blackburn.",
  openGraph: {
    title: "Gründerstory von Greg | Zaza Draft",
    description:
      ...
      <section className="relative pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <header className="mb-12">
          ...
          <p className="text-base sm:text-lg text-[rgba(255,255,255,0.8)] max-w-3xl">
            Das ist die längere Version der Geschichte, wie ich von einer Lehre in einer
            tasmanischen Lackfabrik zu Zaza Technologies gekommen bin – einer Suite von
            lehrerzentrierten KI-Tools, die Lehrkräften Zeit und Kopfkapazität
            zurückgeben sollen.
          </p>
        </header>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="bg-[rgba(15,23,42,0.95)] border border-[rgba(148,163,184,0.5)] rounded-xl p-6 shadow-lg shadow-black/30">
              ...
              <p className="text-sm text-[rgba(226,232,240,0.9)]">
                ...
                berufsvorbereitenden Ausbildung an der TAFE und einer vierjährigen
                Malerlehre in der Cascade-Brauerei – harte Arbeit in einem rauen Umfeld,
                die mir Durchhaltevermögen beigebracht hat, aber auch den Wunsch nach
            ...
            <Card className="bg-[rgba(15,23,42,0.9)] border border-[rgba(148,163,184,0.3)] p-5">
              ...
              <p className="text-sm text-[rgba(226,232,240,0.9)]">
                ...
                einer Leidenschaft für Forschung und Lernumgebungen.
              </p>
            </Card>
            ...
            <Card className="bg-[rgba(15,23,42,0.9)] border border-[rgba(148,163,184,0.3)] p-5">
              ...
              <p className="text-sm text-[rgba(226,232,240,0.9)]">
                ...
                University of Queensland – der Wechsel von operativen Aufgaben hin zu
                strategischer Arbeit, Leadership und den ersten Veröffentlichungen.
              </p>
            </Card>
            ...
            <Card className="bg-[rgba(15,23,42,0.9)] border border-[rgba(148,163,184,0.3)] p-5">
              ...
              <p className="text-sm text-[rgba(226,232,240,0.9)]">
                ...
                Schwerpunkt kritisches Denken und Problemlösen in studentenzentriertem
                E-Learning. Später Chief Learning Officer bei Communardo – an der
                Schnittstelle von Technologie, Lernen und Veränderung.
              </p>
            </Card>
            ...
            <Card className="bg-[rgba(15,23,42,0.9)] border border-[rgba(148,163,184,0.3)] p-5 md:col-span-2">
              ...
              <p className="text-sm text-[rgba(226,232,240,0.9)]">
                Nach vielen Jahren im Learning & Development, in denen ich Lehrkräften
                von langen Abenden mit Korrekturen, Berichten und Elternkommunikation
                zugehört habe, gründete ich 2025 Zaza Technologies – mit dem Ziel,
                menschliche, lehrerzentrierte KI-Tools zu bauen, die Zeit zurückgeben,
                ohne professionelle Urteilsfähigkeit zu ersetzen.
              </p>
            </Card>
          </div>
        </section>
        ...
        <section className="mb-20">
          ...
          <div className="space-y-8 text-[rgba(226,232,240,0.95)] leading-[1.9] text-sm sm:text-base">
            <p>
              ...
              Disziplin beigebracht – aber auch deutlich gemacht, dass ich mir ein
              anderes Berufsleben wünsche.
            </p>

            <p>
              Reisen haben mir die Augen geöffnet. Ich habe im Ausland gelebt, Deutsch
              studiert und gesehen, wie sehr Bildung neue Wege öffnen kann. Zurück in
              ...
              Das war für mich der Beweis, dass ich trotz früher Zweifel und familiärer
            ...
            <p>
              ...
              absolviert. Das MBA öffnete mir Türen ins Management an der UQ, wo ich als
              Business Manager tätig war. In dieser Zeit begann ich, Forschung darüber zu
              veröffentlichen, wie Menschen lernen, Probleme lösen und in komplexen
              Organisationen denken.
            </p>

            <p>
              In diesen Jahren wurden auch meine beiden Töchter, Viola und Solara,
              geboren. Vater zu werden hat alles verschoben. Erfolg bedeutete plötzlich
              nicht mehr nur Titel und Beförderungen, sondern Arbeit, die eines Tages auch
              für sie Sinn ergibt – und genug Zeit und emotionale Energie, um für die
              Familie da zu sein.
            </p>

            <p>
              Getrieben von Neugier habe ich später eine Promotion in Professional
              Education an der City, University of London abgeschlossen – auf Basis von
              Publikationen. Meine Forschung drehte sich um kritisches Denken und
              Problemlösen in studentenzentriertem E-Learning. Im Laufe der Jahre habe
              ich hunderte Mitarbeitende geschult und bin schließlich Chief Learning
              Officer bei Communardo geworden. Dort war ich täglich an der Schnittstelle
            ...
            <p>
              ...
              Korrekturen, Sonntage mit Zeugnissen und die emotionale Last ständiger
              Kommunikation mit Eltern, oftmals mit wenig struktureller Unterstützung.
              Erste KI-Tools kamen zwar auf, fühlten sich aber häufig generisch an,
              ignorierten Kontext und erzeugten zusätzlichen Kontrollaufwand.
            </p>

            <p>
              Daraus entstand eine Frage: Was wäre, wenn KI-Tools speziell für
              Lehrkräfte gestaltet würden – verankert in Didaktik, respektvoll gegenüber
              professionellem Urteil und mit dem Ziel, Arbeitslast wirklich zu senken?
              Was wäre, wenn Lehrkräfte jede Woche ein paar Stunden zurückgewinnen könnten,
              ohne die Qualität ihrer Rückmeldungen oder Beziehungen zu Schülerinnen und
              Schülern zu gefährden?
            </p>
            ...
            <p>
              ...
              Von dort aus wächst die Zaza-Suite in Richtung Unterrichtsplanung,
              Bewertungsunterstützung und weitere Tools, die im Hintergrund bleiben, damit
              Lehrkräfte das tun können, was nur sie können – unterrichten, begleiten und
              Vertrauen aufbauen.
            </p>

            <p>
              Für mich ist Zaza mehr als ein Unternehmen. Es ist eine Art Gefäß für
              jahrzehntelange Erfahrung in Lernen und Entwicklung, meine Forschung zu
              kritischem Denken und Problemlösen, die Stimmen der Lehrkräfte, die ich
              gehört habe, und meinen Wunsch, etwas Sinnvolles für meine Töchter zu
              hinterlassen. Es ist mein Weg zu zeigen, dass EdTech mit Empathie, Strenge
              und Respekt vor der Profession gebaut werden kann, die es unterstützt.
            </p>
          </div>
        </section>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm sm:text-base text-[rgba(226,232,240,0.9)] max-w-xl">
                ...
                ausprobierst und schaust, wie es deine eigene Arbeit unterstützen kann.
                Und wenn du Rückmeldungen oder Ideen hast – meine Tür ist offen.
              </p>
            </div>
