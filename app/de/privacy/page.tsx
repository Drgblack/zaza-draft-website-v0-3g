...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/teacher-working-at-desk-with-laptop.jpg",
        alt: "Lehrkraft prüft Datenschutzdetails am Laptop",
      },
    ],
  },
  ...
  twitter: {
    ...
    description:
      "DSGVO-konforme Datenschutzrichtlinie für Lehrkräfte, Schulen und Partner.",
