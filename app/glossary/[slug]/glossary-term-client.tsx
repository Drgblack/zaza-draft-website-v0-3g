...
export default function GlossaryTermClient({
  ...
  const relatedTermsData = term.relatedTerms
    ?.map((relatedId) =>
      allTerms.find((t) => t.id === relatedId || t.term === relatedId),
    )
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="rounded-xl bg-white/5 border border-white/10 p-8">
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  Understanding {term.term.toLowerCase()} helps you make
                  informed decisions about using AI in your classroom. This
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300">
                      Evaluate AI tools more effectively and choose the right
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#A78BFA] mt-2 flex-shrink-0" />
                    <span className="text-gray-300">
                      Communicate confidently with administrators and colleagues
                      about AI adoption
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#A78BFA] mt-2 flex-shrink-0" />
                    <span className="text-gray-300">
                      Teach students about AI literacy and prepare them for an
                      AI-powered future
                    </span>
                  </li>
                </ul>
