...
const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    example:
      "Sentiment analysis helps ensure your parent emails strike the right toneâ€”supportive rather than critical.",
    category: "Natural Language Processing",
  ...
  // Generative AI
  {
    ...
    term: "Generative AI",
    definition:
      "AI systems that can create new contentâ€”text, images, code, or other mediaâ€”based on patterns learned from training data.",
    example:
  ...
  // Future of AI
  {
    ...
    example:
      "Current AI tools like Zaza Draft are 'narrow AI'â€”excellent at specific tasks but not capable of general human-like reasoning.",
  ...
  },
  {
    ...
    term: "Multimodal AI",
    definition:
      "AI systems that can process and generate multiple types of contentâ€”text, images, audio, and videoâ€”simultaneously.",
    example:
...
const categoryLabelsDe: Record<string, string> = {
  "AI Fundamentals": "KIâ€‘Grundlagen",
  "Machine Learning": "Maschinelles Lernen",
  "Natural Language Processing": "Verarbeitung natÃ¼rlicher Sprache",
  "Generative AI": "Generative KI",
  "AI Models & Architectures": "KIâ€‘Modelle & Architekturen",
  "Prompt Engineering": "Promptâ€‘Engineering",
  "AI Ethics & Safety": "KIâ€‘Ethik & Sicherheit",
  "Data & Privacy": "Daten & Datenschutz",
  "AI Tools & Platforms": "KIâ€‘Werkzeuge & Plattformen",
  "Educational AI Applications": "Bildungsbezogene KIâ€‘Anwendungen",
  "AI Implementation": "KIâ€‘EinfÃ¼hrung",
...
const termTranslationsDe: Record<string, Partial<GlossaryTerm>> = {
  "artificial-intelligence": {
    term: "KÃ¼nstliche Intelligenz (KI)",
    definition:
      "Computersysteme, die Aufgaben ausfÃ¼hren, die normalerweise menschliche Intelligenz erfordern â€“ z. B. Lernen, ProblemlÃ¶sen, Mustererkennung und Entscheidungen.",
    example:
      "Wenn Zaza Draft Verbesserungen fÃ¼r deine Elternâ€‘E-Mail vorschlÃ¤gt, nutzt es KI, um Kontext zu verstehen und hilfreiche Empfehlungen zu erstellen.",
  },
  "machine-learning": {
    term: "Maschinelles Lernen",
    definition:
      "Ein Teilgebiet der KI, bei dem Computer aus Daten lernen und ihre Leistung Ã¼ber die Zeit verbessern, ohne fÃ¼r jeden Fall explizit programmiert zu sein.",
    example:
      "Mit der Zeit lernt Zaza Draft deinen Schreibstil kennen und gibt zunehmend personalisierte VorschlÃ¤ge.",
  },
  "deep-learning": {
    term: "Deep Learning",
    definition:
      "Eine fortgeschrittene Form des maschinellen Lernens mit mehrschichtigen neuronalen Netzen zur Verarbeitung komplexer Muster in groÃŸen Datenmengen.",
  },
}
...
export default function GlossaryClient() {
  ...
  const L = {
    ...
    de: {
      ...
      title: "KIâ€‘Glossar fÃ¼r LehrkrÃ¤fte",
      subtitle:
        "Ãœber 150 KIâ€‘Begriffe einfach erklÃ¤rt. Suche nach Kategorie oder alphabetisch, um KIâ€‘Konzepte fÃ¼r die Bildung zu verstehen.",
      statTerms: "Definierte KIâ€‘Begriffe",
      statCategories: "Themenkategorien",
      statEdu: "Bildungsfokus",
      searchPlaceholder: "Begriffe, Definitionen oder Kategorien suchenâ€¦",
      allCategories: "Alle Kategorien",
      definition: "Definition",
      example: "Beispiel aus der Bildung",
      related: "Verwandte Begriffe",
      relatedBlockTitle: "Wissen anwenden",
      relatedBlockDesc: "Setze diese KIâ€‘Konzepte in praxisnahen Lerneinheiten um",
      relCoursesTitle: "KIâ€‘Kurse zur Grundbildung",
      relCoursesDesc: "Lerne, wie du die Konzepte im Unterricht anwendest",
      relWebinarsTitle: "Liveâ€‘Webinare",
      relWebinarsDesc: "Erlebe KIâ€‘Begriffe in Aktion mit Expertenâ€‘Demos",
      relCommunityTitle: "Communityâ€‘Diskussionen",
      relCommunityDesc: "Stelle Fragen zu unklaren Begriffen",
      ctaTitle: "Bereit, KIâ€‘Wissen praktisch einzusetzen?",
      ctaBody:
        "Setze das Glossar direkt um und erlebe, wie Zaza Draft KI fÃ¼r deinen Schulalltag nutzbar macht.",
      ctaPrimary: "Kostenlos starten",
      ctaSecondary: "KIâ€‘Kurse entdecken",
    },
  } as const
