          ...
          <Card className="bg-[#1E293B] border-[#8B5CF6]/20 p-8">
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed">
                  {language === "de"
                    ? "Die Antworten wurden mit statistischen Methoden analysiert, um Trends, Korrelationen und signifikante Muster zu identifizieren. Alle Daten wurden anonymisiert und aggregiert, um die Privatsphäre der Teilnehmer zu schützen. Fehlertoleranz: Â±0,8% bei 95% Konfidenzniveau."
