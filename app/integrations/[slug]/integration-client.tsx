...
const uiContent = {
  en: {
    banner: {
      message:
        "Coming Soon: Automated technical integration is currently in development. Please download the Setup Guide to connect manually.",
    },
    ...
    sections: {
      ...
      secureDesc:
        "All integrations are FERPA-ready and use industry-standard encryption to protect your data.",
  ...
  de: {
    banner: {
      message:
        "Demnächst verfügbar: Die automatische technische Integration befindet sich in Entwicklung. Bitte nutzen Sie die Anleitung für die manuelle Verbindung.",
    },
    ...
    sections: {
      ...
      secureDesc:
        "Alle Integrationen sind DSGVO/FERPA-ready und nutzen Industriestandard-Verschluesselung zum Schutz Ihrer Daten.",
...
const integrationsData: Record<string, Record<string, IntegrationData>> = {
  en: {
    ...
    "infinite-campus": {
      ...
      faqs: [
        {
          question: "Is it FERPA-ready?",
          answer: "Yes, all data transfer is encrypted and FERPA-ready.",
        },
        {
  ...
  de: {
    ...
    "infinite-campus": {
      ...
      faqs: [
        { question: "Konform?", answer: "Ja, FERPA-ready." },
      ...
      <div className="bg-gradient-to-r from-[#8B5CF6] to-[#A78BFA] border-b border-white/10 px-4 py-3">
        <div className="container mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-white font-medium">
            ...
            <p className="text-sm">
              {text.banner.message}{" "}
              {/* This handles DE/EN translations automatically */}
            </p>
          </div>
        </div>
      </div>
