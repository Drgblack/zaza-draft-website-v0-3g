...
const uiContent = {
  en: {
    banner: {
      message: "Coming Soon: Automated technical integration is currently in development. Please download the Setup Guide to connect manually.",
    },
  ...
  de: {
    banner: {
      message: "Demnächst verfügbar: Die automatische technische Integration befindet sich in Entwicklung. Bitte nutzen Sie die Anleitung für die manuelle Verbindung.",
    },
...
const integrationsData: Record<string, Record<string, IntegrationData>> = {
  en: {
    "google-classroom": {
      ...
      users: "45,000+",
      setupTime: "5 minutes",
      guideUrl: "/guides/google-classroom-guide.docx",
    ...
    "canvas": {
      ...
      users: "28,000+",
      setupTime: "7 minutes",
      guideUrl: "/guides/canvas-lms-integration.docx",
    ...
    "microsoft-teams": {
      ...
      users: "32,000+",
      setupTime: "4 minutes",
      guideUrl: "/guides/microsoft-teams-guide.docx",
    ...
    "infinite-campus": {
      ...
      guideUrl: "/guides/infinite-campus-guide.docx",
    ...
    "skyward": {
      ...
      guideUrl: "/guides/skyward-guide.docx",
    ...
    "remind": {
      ...
      users: "40,000+",
      setupTime: "3 minutes",
      guideUrl: "/guides/remind-guide.docx",
    ...
    "classdojo": {
      ...
      users: "35,000+",
      setupTime: "3 minutes",
      guideUrl: "/guides/classdojo-guide.docx",
    ...
    "seesaw": {
      ...
      users: "25,000+",
      setupTime: "5 minutes",
      guideUrl: "/guides/seesaw-guide.docx",
      benefits: ["Activity creation", "Journal comments", "Family announcements", "Portfolio feedback", "Drafting tools", "Media uploads"],
      setupSteps: [
    ...
    "outlook": {
      ...
      users: "42,000+",
      setupTime: "3 minutes",
      guideUrl: "/guides/outlook-guide.docx",
    ...
    "notion": {
      ...
      users: "18,000+",
      setupTime: "4 minutes",
      guideUrl: "/guides/notion-guide.docx",
    ...
    "trello": {
      ...
      users: "14,000+",
      setupTime: "3 minutes",
      guideUrl: "/guides/trello-guide.docx",
    ...
    "gmail": {
      ...
      users: "52,000+",
      setupTime: "3 minutes",
      guideUrl: "/guides/gmail-guide.docx",
    ...
    "powerschool": {
      ...
      users: "18,000+",
      setupTime: "10 minutes",
      guideUrl: "/guides/powerschool-guide.docx",
    ...
    "google-drive": {
      ...
      description: "Save and organize all your Zaza Draft content directly to Google Drive.",
      logo: "/google-drive-logo.png",
      users: "48,000+",
      setupTime: "2 minutes",
      guideUrl: "/guides/google-drive-guide.docx",
      benefits: ["Auto-save", "Folder organization", "Version history", "Sharing", "Offline access", "Unlimited storage"],
      setupSteps: [
        { step: 1, title: "Connect Drive", description: "Authorize file creation." },
      ...
      useCases: [
        { title: "Backup", description: "Securely save all work.", icon: Shield },
        { title: "Collaboration", description: "Share folders with team.", icon: Users },
        { title: "Offline", description: "Access files anywhere.", icon: Download },
      ],
      faqs: [
      ...
      relatedIntegrations: [
        { name: "OneDrive", slug: "microsoft-onedrive", category: "Cloud Storage" },
...
export default function IntegrationClient({ slug }: { slug: string }) {
  // FIX: Using .includes('/de') instead of .startsWith('/de') is safer for various deployments
  const pathname = usePathname();
  
  // Attempt to use context if available, but fail gracefully if not
  // We won't destructure to avoid breaking if context is null
  const context = useLanguage();
  
  // Logic: True if URL has /de OR if Context explicitly says 'de'
  // This ensures that if the toggle updates context but not URL (yet), we catch it.
  const isGermanPath = pathname?.includes("/de") ?? false;
  const isGermanContext = context?.language === "de"; // safely access property
  
  const isGerman = isGermanPath || isGermanContext;
            ...
            <Card className="bg-[#1E293B] border-white/10 p-6 sticky top-24">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href={integration.guideUrl} download>
