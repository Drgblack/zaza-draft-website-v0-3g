...
export default function IntegrationClient({ slug }: { slug: string }) {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white">
      {/* --- BANNER --- */}
      {/* Using z-10 to keep it below the main navigation (usually z-50).
          Using amber colors to signify "under construction/coming soon".
      */}
      <div className="bg-amber-500/10 border-b border-amber-500/20 px-4 py-3 relative z-10">
        <div className="container mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-amber-200">
            <AlertTriangle className="h-5 w-5 flex-shrink-0" />
            <p className="text-sm font-medium">{text.banner.message}</p>
          </div>
        </div>
      </div>
