...
interface IntegrationData {
  ...
  users: string;
  setupTime: string;
  guideUrl: string; // Added guideUrl property
  benefits: string[];
  setupSteps: {
    step: number;
    title: string;
...
const integrationsData: Record<string, Record<string, IntegrationData>> = {
  ...
  de: {
    "google-classroom": {
      ...
      users: "45.000+",
      setupTime: "5 Minuten",
      guideUrl: "/guides/google-classroom-guide-de.docx",
      benefits: [
    ...
    canvas: {
      ...
      users: "28.000+",
      setupTime: "7 Minuten",
      guideUrl: "/guides/canvas-lms-integration-de.docx",
      benefits: [
        "Direkt-Publishing",
        "Notenrückgabe",
        "Listen-Sync",
    ...
    schoology: {
      ...
      users: "15.000+",
      setupTime: "8 Minuten",
      guideUrl: "/guides/schoology-integration-de.docx",
      benefits: [
        "Inhaltssync",
        "Notenrückgabe",
        "Aufgabenerstellung",
    ...
    "microsoft-teams": {
      ...
      users: "32.000+",
      setupTime: "4 Minuten",
      guideUrl: "/guides/microsoft-teams-guide-de.docx",
      benefits: [
        "Kanal-Posts",
        "Dateien teilen",
        "Benachrichtigungen",
    ...
    "infinite-campus": {
      ...
      guideUrl: "/guides/infinite-campus-guide-de.docx",
      benefits: [
        "Listen-Sync",
        "Notenrückgabe",
        "Anwesenheit",
    ...
    skyward: {
      ...
      guideUrl: "/guides/skyward-guide-de.docx",
      benefits: [
        "Datensync",
        "Notenbuch",
        "Anwesenheit",
    ...
    remind: {
      ...
      users: "40.000+",
      setupTime: "3 Minuten",
      guideUrl: "/guides/remind-guide-de.docx",
      benefits: [
        "In Zaza entwerfen",
        "Via Remind senden",
        "Ankündigungen",
    ...
    classdojo: {
      ...
      users: "35.000+",
      setupTime: "3 Minuten",
      guideUrl: "/guides/classdojo-guide-de.docx",
      benefits: [
        "Storys posten",
        "Elternnachrichten",
        "Verhalten",
    ...
    seesaw: {
      ...
      users: "25.000+",
      setupTime: "5 Minuten",
      guideUrl: "/guides/seesaw-guide-de.docx",
      benefits: [
        "Aktivitäten",
        "Kommentare",
        "Ankündigungen",
    ...
    outlook: {
      ...
      users: "42.000+",
      setupTime: "3 Minuten",
      guideUrl: "/guides/outlook-guide-de.docx",
      benefits: [
        "Senden",
        "Kalender",
        "Kontakte",
    ...
    "google-calendar": {
      ...
      users: "38.000+",
      setupTime: "2 Minuten",
      guideUrl: "/guides/google-calendar-guide-de.docx",
      benefits: [
        "Events",
        "Planung",
        "Erinnerungen",
    ...
    notion: {
      ...
      users: "18.000+",
      setupTime: "4 Minuten",
      guideUrl: "/guides/notion-guide-de.docx",
      benefits: [
        "Seiten",
        "Datenbanken",
        "Vorlagen",
    ...
    trello: {
      ...
      users: "14.000+",
      setupTime: "3 Minuten",
      guideUrl: "/guides/trello-guide-de.docx",
      benefits: [
        "Karten",
        "Listen",
        "Checklisten",
    ...
    gmail: {
      ...
      users: "52.000+",
      setupTime: "3 Minuten",
      guideUrl: "/guides/gmail-guide-de.docx",
      benefits: [
        "Direkt senden",
        "Vorlagen",
        "Massenversand",
    ...
    powerschool: {
      ...
      users: "18.000+",
      setupTime: "10 Minuten",
      guideUrl: "/guides/powerschool-guide-de.docx",
      benefits: [
        "Listen-Sync",
        "Notenrückgabe",
        "Anwesenheit",
    ...
    "google-drive": {
      ...
      users: "48.000+",
      setupTime: "2 Minuten",
      guideUrl: "/guides/google-drive-guide-de.docx",
      benefits: [
        "Auto-Save",
        "Ordner",
        "Versionen",
