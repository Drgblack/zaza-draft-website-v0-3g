          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <main className="lg:col-span-9">
              ...
              <div className="mt-12 grid gap-6 md:grid-cols-2">
                <div className="p-6 bg-[#111827] border border-white/5 rounded-lg">
                ...
                <div className="p-6 bg-[#111827] border border-white/5 rounded-lg">
                  <h3 className="text-xl font-semibold text-white mb-2">
                    {content.dpaCta.title}
                  </h3>
                  <p className="text-[#D1D5DB] mb-4">{content.dpaCta.text}</p>
                  <div className="flex flex-col gap-3">
                    {content.dpaCta.links.map((link) => (
                      <a
                        key={link.href}
                        href={link.href}
                        download
...
const contentEN = {
  ...
  dpaCta: {
    title: "Need our DPA?",
    text: "Download the Zaza Draft Data Processing Agreement in English or German.",
    links: [
      {
...
const contentDE = {
  hero: {
    ...
    intro:
      'Diese Richtlinie erklärt, wie Zaza Technologies ("wir") personenbezogene Daten für Zaza Draft und verbundene Dienste verarbeitet. Sie beschreibt, welche Daten wir erheben, warum wir sie nutzen, wie lange wir sie speichern, mit wem wir sie teilen und welche Rechte Sie nach der EU/UK-DSGVO haben.',
  ...
  sections: [
    {
      title: "Wer wir sind",
      content: [
        'Zaza Draft ist ein Produkt von Zaza Technologies ("Zaza", "wir"). Wir bauen Tools, die Lehrkräften helfen, klare, empathische Kommunikation zu schreiben.',
        "Verantwortlicher: Zaza Technologies",
        "Kontakt: help@zazatechnologies.com",
      ],
    },
    {
      title: "Was diese Richtlinie abdeckt",
      content: [
    ...
    },
    {
      title: "Ihre Rechte",
      content: [
        "Nach der UK/EU-DSGVO können Sie Auskunft, Berichtigung, Löschung, Einschränkung und Datenübertragbarkeit beantragen und bestimmten Verarbeitungen widersprechen. Sie können auch Einwilligungen jederzeit widerrufen.",
  ...
  dpaCta: {
    title: "Brauchen Sie unseren AV-Vertrag?",
    text: "Laden Sie den Zaza Draft Auftragsverarbeitungsvertrag auf Englisch oder Deutsch herunter.",
    links: [
      {
        label: "Data Processing Agreement (EN)",
        href: "/legal/zaza-draft-dpa-en.pdf",
