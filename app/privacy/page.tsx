...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Privacy Policy | Zaza Draft",
    description:
      "Learn how we protect teacher and student data with privacy-first safeguards.",
    url: canonicalUrl,
    type: "website",
    siteName: "Zaza Draft",
    locale: "en_GB",
    images: [
      {
        url: ogImage,
        alt: "Teacher working at a laptop reviewing privacy details",
      },
    ],
  },
  twitter: {
    ...
    title: "Privacy Policy | Zaza Draft",
    description:
      "GDPR-ready privacy approach designed for classrooms and school partners.",
    images: [ogImage],
  },
  alternates: {
