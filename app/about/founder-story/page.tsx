      ...
      <section className="relative pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="bg-[rgba(15,23,42,0.9)] border border-[rgba(148,163,184,0.3)] rounded-xl p-6">
              ...
              <p className="text-sm text-[rgba(226,232,240,0.9)]">
                ...
                Chief Learning Officer at Communardo, working at the
                intersection of technology, learning and change.
              </p>
            </Card>
            ...
            <Card className="bg-[rgba(15,23,42,0.9)] border border-[rgba(148,163,184,0.3)] rounded-xl p-6 md:col-span-2">
              ...
              <p className="text-sm text-[rgba(226,232,240,0.9)]">
                ...
                Technologies in 2025 to build humane, teacher-first AI tools
                that give educators their time back without compromising their
        ...
        <section className="mb-20">
          ...
          <div className="space-y-8 text-[rgba(226,232,240,0.95)] leading-[1.9] text-sm sm:text-base">
            <p>
              I didn&apos;t grow up planning to work in education or technology.
              My working life began with a paintbrush in hand in Hobart,
            ...
            <p>
              My next chapter took me to Brisbane. I joined Telstra and spent
              six years there, moving from operational roles into more strategic
              work while studying for an MBA at the University of Queensland.
              The MBA opened doors into management at UQ, where I became a
              Business Manager. It was there that I began publishing research
              into how people learn, solve problems and think in complex
              organisations.
            </p>
            ...
            <p>
              ...
              taught thousands of organisational staff, and eventually moved
              into the role of Chief Learning Officer at Communardo. I found
              myself at the intersection of learning, technology and
            ...
            <p>
              ...
              and unsafe for education: they ignored context, invented
              information and often created more work to check than they saved.
            </p>
            ...
            <p>
              ...
              research into critical thinking and problem solving, the realities
              I have heard from teachers, and my desire to leave something
              meaningful to my daughters. It is my way of proving that EdTech
              can be built with empathy, rigour and a deep respect for the
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-sm sm:text-base text-[rgba(226,232,240,0.9)] max-w-xl">
                If this story resonates with you, I&apos;d love you to explore
                Zaza Draft and see how it might support your own work. And if
                you have thoughts or feedback, my door is open.
              </p>
            </div>
