...
=======
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 prose prose-slate dark:prose-invert">
        <p>
          ...
          management. Yet here we are - with burnout rates climbing and passionate educators leaving
          the profession because the bureaucratic weight has become unsustainable.
        </p>
        ...
        <p>
          ...
          not chosen by IT, but built with educators to solve the problems that actually steal your
          time and energy.
        </p>

        <h2>What makes us different?</h2>
        <p>
          We&apos;re not another tech company "discovering" education. Zaza is grounded in two decades
          of learning science and workplace education, with thousands of educators shaping our tools
          through real-world feedback. Every product is co-designed with teachers and rooted in research
          - because shortcuts that compromise pedagogy are not shortcuts at all.
        </p>
        <p>
          That&apos;s why we built the KnowledgeCore - a trusted intelligence layer that keeps every Zaza
          app explainable, privacy-first, and classroom-ready. No black boxes. No hallucinations that
          make you look foolish. No undermining your professional judgment.
        </p>

        <h2>How it works</h2>
        <p>
          From Zaza Draft (intelligent comment writing) to Zaza Teach (AI lesson planning with
          AutoPlanner) and beyond, every product shares one mission: give you your time back so you
          can focus on what you do best - teaching.
        </p>

        <h2>Our promise</h2>
        <p>
          We&apos;re not here with big tech promises. We&apos;re here with clarity, usefulness, and trust.
          Because every teacher deserves tools that respect their craft, protect their credibility,
