    ...
    <main className="max-w-4xl mx-auto px-4 py-10">
      ...
      <section className="space-y-3 mb-10">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          Zaza app explainable, privacy-first, and classroom-ready. No black boxes. No hallucinations that make
          you look foolish. No undermining your professional judgment.
        </p>
      </section>
