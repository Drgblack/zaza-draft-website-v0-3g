      ...
      <section className="container mx-auto px-4 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            ...
            to build teacher-first AI. Not a former teacher - a learning scientist and operator focused on
        ...
        <div className="container mx-auto px-4 py-14">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              If you are a teacher, you have probably tried tools that promised hours back and delivered another chore.
              I understand the scepticism. Zaza is built to be different. We will keep listening, keep improving,
              and keep choosing clarity and usefulness over noise.
            </p>
