...
export function BlogClient({ posts, language }: BlogClientProps) {
  // Posts are already filtered by language in getAllPostsByLanguage
  ...
  const getImageForPost = (post: BlogPost) => {
    if ((post as any).coverImage) return (post as any).coverImage as string;
          ...
          <div className="flex items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm sm:text-base text-slate-400">
                {language === "de"
                  ? "Praktische Tipps, Vorlagen und Strategien, damit KI dir Zeit zurückgibt - nicht mehr Stress."
