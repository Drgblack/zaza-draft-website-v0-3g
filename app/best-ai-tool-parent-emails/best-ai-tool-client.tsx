...
export default function BestAIToolClient() {
  ...
  const content = {
    en: {
      ...
      hero_subtitle:
        "Find the AI assistant purpose-built for teacher-parent communication, tone control, and FERPA compliance.",
    ...
    de: {
      ...
      related_guides: [
        ...
        { title: "KI für Schülerberichte", href: "/ai-for-student-reports" },
      ],
  ...
  // Helper for Comparison Table Check/X icons
          ...
          <div className="space-y-16">
              ...
              <div className="overflow-x-auto rounded-xl border border-white/10">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-white/10 bg-[#0F172A]">
                    {/* Hardcoding rows due to array structure mismatch (Template, Ferpa, Tone, Multi, Free, Price) */}
                    <tr className="hover:bg-[#1E293B]/50 transition-colors">
                      <td className="p-4 font-medium text-gray-300">
                        {text.comparison_features[0]}
                      </td>
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[0].template)}
                      </td>
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[1].template)}
                      </td>
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[2].template)}
                      </td>
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[3].template)}
                      </td>
                    </tr>
                    <tr className="hover:bg-[#1E293B]/50 transition-colors">
                      <td className="p-4 font-medium text-gray-300">
                      ...
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[0].ferpa)}
                      </td>
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[1].ferpa)}
                      </td>
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[2].ferpa)}
                      </td>
                      <td className="p-4 text-center">
                        {renderIcon(text.comparison_tools[3].ferpa)}
                      </td>
                    </tr>
                    <tr className="hover:bg-[#1E293B]/50 transition-colors">
                      <td className="p-4 font-medium text-gray-300">
            ...
            <section className="rounded-xl border border-[#8B5CF6]/30 bg-gradient-to-br from-[#8B5CF6]/20 to-[#A78BFA]/10 p-8 text-center">
              ...
              <Button
                ...
                className="bg-[#8B5CF6] hover:bg-[#7C3AED] text-white"
              >
                <Link href="/products/draft">{text.cta_final_button}</Link>
              </Button>
            </section>
          </div>
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-xl border border-white/10 bg-[#1E293B] p-6">
              <h3 className="mb-4 font-semibold text-white">
                {isGerman ? "Verwandte Anleitungen" : "Related Guides"}
              </h3>
              <div className="space-y-3">
                ...
                >
                  → {text.related_guides[0].title}
                </Link>
                <Link
                  href="/ai-for-student-reports"
                  className="block text-sm text-[#A78BFA] hover:text-[#8B5CF6] transition-colors"
                >
                  → {text.related_guides[1].title}
                </Link>
                <Link
                  href="/learning-centre"
                  className="block text-sm text-[#A78BFA] hover:text-[#8B5CF6] transition-colors"
                >
                  → {isGerman ? "Gesamtes Lernzentrum" : "Full Learning Centre"}
                </Link>
              </div>
            </div>
