...
const caseStudyData: Record<
  string,
  { en: CaseStudyContent; de: CaseStudyContent }
> = {
  "lincoln-elementary-parent-communication": {
    en: {
      ...
      testimonial: {
        quote:
          "I actually look forward to parent communication now. It's no longer a source of stress. I can respond thoughtfully and quickly, and parents have noticed the difference.",
    ...
    de: {
      ...
      challenge: {
        ...
        description:
          "Sarah verbrachte 15-20 Stunden pro Woche mit Elternkommunikation und arbeitete oft bis spät in den Abend, um auf E-Mails zu antworten. Bei 24 Schülern und unterschiedlichen Familienbedürfnissen fühlte sie sich ständig im Rückstand.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Sarah begann mit den E-Mail-Vorlagen von Zaza Draft und erweiterte die Nutzung schrittweise auf Fortschrittsberichte. Der Schlüssel war der Aufbau von Vertrauen durch kleine Erfolge.",
        implementation: [
          {
      ...
      results: {
        ...
        description:
          "Innerhalb eines Monats reduzierte Sarah ihre Kommunikationszeit von 15 auf nur 3 Stunden pro Woche, während sich Qualität und Konsistenz tatsächlich verbesserten.",
        metrics: [
          {
      ...
      testimonial: {
        quote:
          "Ich freue mich jetzt tatsächlich auf die Elternkommunikation. Es ist kein Stressfaktor mehr. Ich kann durchdacht und schnell antworten, und die Eltern haben den Unterschied bemerkt.",
      ...
      ui: {
        ...
        ctaSubtitle:
          "Schließen Sie sich Sarah und tausenden anderen Lehrkräften an",
  ...
  "riverside-unified-district-rollout": {
    en: {
      ...
      challenge: {
        ...
        description:
          "Riverside Unified wanted to implement AI to reduce teacher workload, but feared inconsistent adoption and privacy concerns. With 200 teachers varying in tech-savviness, a unified approach was critical.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Using Zaza Draft's enterprise features, the district implemented a 'train the trainer' model, focusing on privacy-first AI tools that integrated with existing LMS.",
        implementation: [
          {
            phase: "Phase 1: Pilot Group",
            duration: "1 Month",
            activities: [
              "Selected 20 tech-forward teachers",
              "Established usage guidelines",
              "Gathered initial feedback",
            ],
          },
          {
            phase: "Phase 2: District Training",
            duration: "2 Days",
            activities: [
              "Hands-on workshops for all staff",
              "Focus on privacy (FERPA compliance)",
              "Live demos of report writing",
            ],
          },
          {
            phase: "Phase 3: Full Adoption",
            duration: "Ongoing",
            activities: [
              "District-wide license activation",
      ...
      results: {
        ...
        description:
          "The district saw a 90% adoption rate within 3 months. Teachers reported saving an average of 5 hours per week, leading to improved morale.",
        metrics: [
          { label: "Adoption Rate", value: "90%", icon: "trending-up" },
          {
            label: "Hours Saved District-wide",
            value: "2000+ / mo",
            icon: "clock",
          },
      ...
      testimonial: {
        quote:
          "The professional development was seamless. Teachers were confident within days. Zaza Draft isn't just a tool; it's a retention strategy.",
      ...
      ui: {
        ...
        painPointsTitle: "Key Pain Points",
        keyTakeawaysTitle: "Key Takeaways",
        ctaTitle: "Empower your district",
        ctaSubtitle: "Get an enterprise quote today",
        ctaPrimary: "Talk to Sales",
        ctaSecondary: "View More Stories",
        notFound: "Case Study Not Found",
      },
    },
    de: {
      ...
      challenge: {
        ...
        description:
          "Riverside Unified wollte KI einführen, um die Arbeitsbelastung der Lehrer zu verringern, befürchtete aber inkonsistente Nutzung und Datenschutzprobleme. Bei 200 Lehrkräften mit unterschiedlichen Technikkenntnissen war ein einheitlicher Ansatz entscheidend.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Mit den Enterprise-Funktionen von Zaza Draft implementierte der Bezirk ein 'Train-the-Trainer'-Modell, das sich auf datenschutzkonforme KI-Tools konzentrierte.",
        implementation: [
          {
            phase: "Phase 1: Pilotgruppe",
            duration: "1 Monat",
            activities: [
              "20 technikaffine Lehrer ausgewählt",
              "Nutzungsrichtlinien erstellt",
              "Erstes Feedback gesammelt",
            ],
          },
          {
            phase: "Phase 2: Distrikt-Schulung",
            duration: "2 Tage",
            activities: [
              "Praxis-Workshops für alle Mitarbeiter",
              "Fokus auf Datenschutz (FERPA)",
              "Live-Demos zum Berichteschreiben",
            ],
          },
          {
            phase: "Phase 3: Volle Übernahme",
            duration: "Laufend",
            activities: [
              "Aktivierung der Distriktlizenzen",
              "Monatlicher Austausch von Best Practices",
              "Integration mit Schoology",
            ],
          },
        ],
      },
      results: {
        ...
        description:
          "Der Bezirk verzeichnete innerhalb von 3 Monaten eine Adoptionsrate von 90%. Lehrer berichteten von einer durchschnittlichen Zeitersparnis von 5 Stunden pro Woche.",
        metrics: [
          { label: "Adoptionsrate", value: "90%", icon: "trending-up" },
          {
            label: "Gesparte Std. (Distrikt)",
            value: "2000+ / Mo",
            icon: "clock",
          },
      ...
      testimonial: {
        quote:
          "Die Fortbildung war nahtlos. Die Lehrkräfte waren innerhalb weniger Tage sicher im Umgang. Zaza Draft ist nicht nur ein Werkzeug, es ist eine Strategie zur Mitarbeiterbindung.",
      ...
      ui: {
        ...
        painPointsTitle: "Hauptprobleme",
        keyTakeawaysTitle: "Wichtige Erkenntnisse",
        ctaTitle: "Stärken Sie Ihren Distrikt",
        ctaSubtitle: "Holen Sie noch heute ein Angebot ein",
        ctaPrimary: "Mit Vertrieb sprechen",
        ctaSecondary: "Mehr Geschichten",
        notFound: "Fallstudie nicht gefunden",
      },
    },
  },
  "washington-middle-language-barriers": {
    en: {
      ...
      solution: {
        ...
        description:
          "Washington Middle adopted Zaza Draft specifically for its ability to generate culturally nuanced communications in multiple languages, ensuring clarity and tone were preserved.",
        implementation: [
          {
            phase: "Step 1: Setup",
            duration: "1 Week",
            activities: [
              "Identified top 5 languages needed",
              "Configured language presets in Zaza Draft",
            ],
          },
          {
            phase: "Step 2: Outreach",
            duration: "2 Weeks",
            activities: [
              "Sent introductory newsletters in native languages",
              "Used 'Simplify' feature before translating",
            ],
          },
          {
            phase: "Step 3: Routine",
            duration: "Ongoing",
            activities: [
              "Weekly updates sent in 15 languages",
              "Two-way communication enabled via translated replies",
            ],
          },
        ],
      },
      results: {
        ...
        description:
          "Parent engagement scores doubled. Families reported feeling 'finally seen and understood' by the school administration.",
        metrics: [
      ...
      ui: {
        ...
        painPointsTitle: "Key Pain Points",
        keyTakeawaysTitle: "Key Takeaways",
        ctaTitle: "Connect with every family",
        ctaSubtitle: "Try Zaza Draft's multilingual features",
        ctaPrimary: "Start writing safely",
        ctaSecondary: "View More Stories",
        notFound: "Case Study Not Found",
      },
    },
    de: {
      ...
      challenge: {
        ...
        description:
          "Da zu Hause über 15 Sprachen gesprochen wurden, hatten die Lehrer Schwierigkeiten, effektiv zu kommunizieren. Google Translate war oft ungenau, was zu Missverständnissen führte.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Washington Middle führte Zaza Draft speziell wegen seiner Fähigkeit ein, kulturell nuancierte Kommunikation in mehreren Sprachen zu erstellen.",
        implementation: [
          {
            phase: "Schritt 1: Einrichtung",
            duration: "1 Woche",
            activities: [
              "Top 5 benötigte Sprachen identifiziert",
              "Sprachvoreinstellungen konfiguriert",
            ],
          },
          {
            phase: "Schritt 2: Kontaktaufnahme",
            duration: "2 Wochen",
            activities: [
              "Einführungs-Newsletter in Muttersprachen",
              "Nutzung der 'Vereinfachen'-Funktion vor der Übersetzung",
            ],
          },
          {
            phase: "Schritt 3: Routine",
            duration: "Laufend",
            activities: [
              "Wöchentliche Updates in 15 Sprachen",
              "Zwei-Wege-Kommunikation durch übersetzte Antworten",
            ],
          },
        ],
      },
      results: {
        ...
        description:
          "Die Elternbeteiligung verdoppelte sich. Familien berichteten, dass sie sich von der Schulverwaltung 'endlich gesehen und verstanden' fühlten.",
        metrics: [
      ...
      testimonial: {
        quote:
          "Zum ersten Mal erhält jede Familie Nachrichten in ihrer Sprache. Das ist nicht nur Übersetzung, das ist Verbindung. Der Einfluss auf das Vertrauen der Gemeinschaft ist enorm.",
      ...
      ui: {
        ...
        painPointsTitle: "Hauptprobleme",
        keyTakeawaysTitle: "Wichtige Erkenntnisse",
        ctaTitle: "Erreichen Sie jede Familie",
        ctaSubtitle: "Testen Sie die mehrsprachigen Funktionen",
  ...
  "oakwood-special-education-reports": {
    en: {
      ...
      challenge: {
        ...
        description:
          "David loved working with his students but dreaded the reporting. Creating comprehensive IEP reports that met legal standards while remaining accessible to parents was taking 40% of his time.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Using Zaza Draft's specialized IEP templates and 'Zaza Shield' for privacy, David could input observational notes and generate structured, compliant, and warm reports instantly.",
        implementation: [
          {
            phase: "Phase 1: Input",
            duration: "Daily",
            activities: [
              "Logged bullet-point observations in secure app",
              "Tagged notes by IEP goal category",
            ],
          },
          {
            ...
            activities: [
              "Used 'IEP Progress Report' generator",
              "Refined tone to be 'Professional yet Warm'",
            ],
          },
          {
      ...
      results: {
        ...
        description:
          "David completed his entire caseload's reporting in a single day, a task that used to take a week. The reports were praised by administration for their thoroughness.",
        metrics: [
      ...
      testimonial: {
        quote:
          "I can focus on the kids, not just the paperwork. Zaza Shield ensures compliance, and the writing quality is better than when I was exhausted doing it manually.",
      ...
      ui: {
        ...
        painPointsTitle: "Key Pain Points",
        keyTakeawaysTitle: "Key Takeaways",
        ctaTitle: "Simplify your paperwork",
        ctaSubtitle: "Try Zaza Draft for Special Education",
        ctaPrimary: "Start writing safely",
        ctaSecondary: "View More Stories",
        notFound: "Case Study Not Found",
      },
    ...
    de: {
      ...
      challenge: {
        ...
        description:
          "David liebte die Arbeit mit seinen Schülern, fürchtete aber die Berichte. Die Erstellung umfassender Förderpläne, die rechtlichen Standards entsprachen und dennoch für Eltern verständlich waren, nahm 40% seiner Zeit in Anspruch.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Mit den spezialisierten Vorlagen von Zaza Draft und 'Zaza Shield' für Datenschutz konnte David Beobachtungsnotizen eingeben und sofort strukturierte, konforme und herzliche Berichte erstellen.",
        implementation: [
          {
            phase: "Phase 1: Eingabe",
            duration: "Täglich",
            activities: [
              "Beobachtungen stichpunktartig in sicherer App notiert",
              "Notizen nach Förderzielen kategorisiert",
            ],
          },
          {
            phase: "Phase 2: Erstellung",
            duration: "Berichtszeitraum",
            activities: [
              "Generator für 'Fortschrittsberichte' genutzt",
              "Tonfall auf 'Professionell aber herzlich' eingestellt",
            ],
          },
          {
            phase: "Phase 3: Überprüfung",
            duration: "1 Stunde",
            activities: [
              "Abschließende Prüfung von 40 Berichten",
              "Kleine Anpassungen",
            ],
          },
        ],
      ...
      results: {
        ...
        description:
          "David erledigte die Berichte für alle seine Fälle an einem einzigen Tag - eine Aufgabe, die früher eine Woche dauerte. Die Berichte wurden von der Verwaltung für ihre Gründlichkeit gelobt.",
        metrics: [
      ...
      testimonial: {
        quote:
          "Ich kann mich auf die Kinder konzentrieren, nicht nur auf den Papierkram. Zaza Shield sichert die Compliance, und die Schreibqualität ist besser, als wenn ich es erschöpft manuell mache.",
      ...
      ui: {
        ...
        painPointsTitle: "Hauptprobleme",
        keyTakeawaysTitle: "Wichtige Erkenntnisse",
        ctaTitle: "Vereinfachen Sie Ihren Papierkram",
        ctaSubtitle: "Testen Sie Zaza Draft für Sonderpädagogik",
        ctaPrimary: "Kostenlos starten",
        ctaSecondary: "Mehr Geschichten",
        notFound: "Fallstudie nicht gefunden",
      },
  ...
  "jefferson-new-teacher-confidence": {
    en: {
      ...
      challenge: {
        ...
        description:
          "As a first-year teacher, Emily spent 45 minutes drafting a single email, terrified of saying the wrong thing. She lacked the experience to handle difficult parent conversations confidently.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Emily used Zaza Draft as a confidence booster. She would draft her rough thoughts, let the AI polish them into professional communication, and learn from the suggestions.",
        implementation: [
          {
            phase: "Phase 1: Drafting",
            duration: "Week 1-2",
            activities: [
              "Typed anxious/rough drafts into Zaza",
              "Used 'Make Professional' filter",
            ],
          },
          {
            ...
            duration: "Month 1",
            activities: [
              "Studied how the AI phrased difficult news",
              "Adopted successful phrases into her own vocabulary",
            ],
          },
          {
            phase: "Phase 3: Independence",
            duration: "Month 2",
            activities: [
              "Wrote drafts confidently",
              "Used Zaza only for final polish/check",
            ],
          },
        ],
      },
      results: {
        ...
        description:
          "Emily's mentor teacher noted she communicated like a 5-year veteran. Her anxiety decreased significantly, allowing her to enjoy her first year.",
        metrics: [
      ...
      testimonial: {
        quote:
          "My mentor teacher was impressed by my communication. Zaza gave me the confidence I needed to sound like a pro, even when I was shaking inside.",
      ...
      ui: {
        ...
        painPointsTitle: "Key Pain Points",
        keyTakeawaysTitle: "Key Takeaways",
        ctaTitle: "Start your career with confidence",
        ctaSubtitle: "Get your free account today",
    ...
    de: {
      ...
      challenge: {
        ...
        description:
          "Als Berufseinsteigerin verbrachte Emily 45 Minuten damit, eine einzige E-Mail zu entwerfen, aus Angst, das Falsche zu sagen. Ihr fehlte die Erfahrung, um schwierige Elterngespräche sicher zu führen.",
        painPoints: [
      ...
      solution: {
        ...
        description:
          "Emily nutzte Zaza Draft zur Stärkung ihres Selbstvertrauens. Sie entwarf ihre groben Gedanken, ließ sie von der KI polieren und lernte aus den Vorschlägen.",
        implementation: [
          {
            phase: "Phase 1: Entwurf",
            duration: "Woche 1-2",
            activities: [
              "Gab ängstliche/grobe Entwürfe in Zaza ein",
              "Nutzte den Filter 'Professionell formulieren'",
            ],
          },
          {
            phase: "Phase 2: Lernen",
            duration: "Monat 1",
            activities: [
              "Studierte, wie die KI schwierige Nachrichten formulierte",
              "Übernahm erfolgreiche Phrasen in ihren Wortschatz",
            ],
          },
          {
            phase: "Phase 3: Unabhängigkeit",
            duration: "Monat 2",
            activities: [
              "Schrieb Entwürfe selbstbewusst",
              "Nutzte Zaza nur noch für den Feinschliff",
            ],
          },
        ],
      },
      results: {
        ...
        description:
          "Ihr Mentor bemerkte, dass sie kommunizierte wie eine Lehrerin mit 5 Jahren Erfahrung. Ihre Angst nahm deutlich ab, sodass sie ihr erstes Jahr genießen konnte.",
        metrics: [
      ...
      testimonial: {
        quote:
          "Mein Mentor war beeindruckt von meiner Kommunikation. Zaza gab mir das nötige Selbstvertrauen, um professionell zu klingen, auch wenn ich innerlich zitterte.",
      ...
      ui: {
        ...
        painPointsTitle: "Hauptprobleme",
        keyTakeawaysTitle: "Wichtige Erkenntnisse",
        ctaTitle: "Starten Sie sicher in den Beruf",
        ctaSubtitle: "Erstellen Sie noch heute Ihr kostenloses Konto",
        ctaPrimary: "Kostenlos anmelden",
        ctaSecondary: "Mehr Geschichten",
        notFound: "Fallstudie nicht gefunden",
      },
    },
...
export function CaseStudyDetailClient({ slug }: { slug: string }) {
  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case "users":
        return <Users className="w-8 h-8 text-orange-400" />;
      case "globe":
      ...
      case "star":
        return <CheckCircle2 className="w-8 h-8 text-yellow-400" />;
      default:
        return <CheckCircle2 className="w-8 h-8 text-gray-400" />;
    }
  };
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              onClick={() =>
                trackEvent("case_study_cta_clicked", { slug, cta: "try_free" })
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                trackEvent("case_study_cta_clicked", { slug, cta: "view_more" })
              }
            >
