export default {
  ...
  "categories": {
  "getting-started": {
  "name": "Erste Schritte mit KI",
  "desc": "Neu bei KI? Starten Sie hier mit einsteigerfreundlichen Tipps und Diskussionen."
},
  "prompt-engineering": {
  ...
  "desc": "Ethische Aspekte, Policies und Best Practices diskutieren."
},
  "tool-reviews": {
  "name": "Tool-Reviews & Vergleiche",
  "desc": "Erfahrungen mit verschiedenen KI-Tools und Plattformen teilen."
},
  "success-stories": {
  "name": "Erfolgsgeschichten",
  "desc": "Erfolge feiern und funktionierende Praxis im Unterricht teilen."
},
  "troubleshooting": {
  "name": "Fehlerbehebung",
  "desc": "Hilfe bekommen, wenn etwas nicht wie erwartet funktioniert."
},
  "subject-specific": {
  "name": "Fachspezifisch",
  "desc": "Diskussionen nach Fach (Mathematik, Deutsch, Naturwissenschaften usw.)."
},
  "off-topic": {
  ...
  "firstPost": {
  "name": "Erster Beitrag",
  "desc": "Ihren ersten Beitrag verfasst"
},
  "helpful": {
  "name": "Hilfreich",
