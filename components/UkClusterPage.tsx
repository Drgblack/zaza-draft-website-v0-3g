...
import type { UkClusterPageData } from "@/lib/uk-matrix";

type UkClusterPageProps = {
  page: UkClusterPageData;
};

export function UkClusterPage({ page }: UkClusterPageProps) {
  return (
    <>
      <StructuredData
        type="Article"
      ...
      <StructuredData
        ...
        data={{
          ...
          title: "Zaza Draft",
          description:
            "Teacher-first UK writing support for parent communication, report comments, behaviour letters, and tone-sensitive school drafting.",
        }}
      />
      <StructuredData
        type="HowTo"
      ...
      <div className="min-h-screen bg-[#f6f1e8] text-slate-900">
        <section className="border-b border-[#ddd2c3] bg-[radial-gradient(circle_at_top_left,_rgba(20,78,63,0.16),_transparent_30%),radial-gradient(circle_at_top_right,_rgba(59,130,246,0.08),_transparent_30%),linear-gradient(180deg,_#fdfbf7_0%,_#f6f1e8_100%)]">
          <div className="mx-auto max-w-6xl px-6 pb-16 pt-20 lg:px-8 lg:pb-20 lg:pt-24">
            <div className="grid gap-10 xl:grid-cols-[1.08fr,0.92fr]">
                ...
                <div className="mt-6 grid gap-4">
                  ...
                  <div className="rounded-2xl border border-[#e6ddd1] bg-[#fcfaf6] p-4">
                    ...
                    <p className="mt-3 text-sm leading-7 text-slate-700">
                      Built for British schools. GDPR-aware. Teacher-first. You
                      review and approve every final word.
                    </p>
                  </div>
                </div>
              </aside>
                ...
                {page.steps.map((step, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-white text-sm font-semibold text-[#173d35]">
                        {index + 1}
                      </span>
                      <div>
          ...
          <section className="grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
            ...
            <article className="rounded-[32px] border border-[#ddd2c3] bg-[#fcfaf6] p-6 md:p-8">
              ...
              <p className="mt-4 text-base leading-8 text-slate-700">
                Use these examples to reduce blank-page stress, then adapt them
                to the pupil, the family, and the school&apos;s policy. The goal
                is calmer writing, not automatic sending.
              </p>
            </article>
          </section>
