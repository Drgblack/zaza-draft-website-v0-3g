...
description: >-
  ...
  calm examples, safer wording, and a clear route back to Safeguarding Student
  Data When Using AI Tools and Zaza Draft.
seedSlug: ai-student-data-safeguards
variant: sen-support-person-centred-language
sourceBlogTitle: Safeguarding Student Data When Using AI Tools
sourceBlogSlug: ai-student-data-safeguards
...
This page expands on [Safeguarding Student Data When Using AI Tools](/blog/ai-student-data-safeguards) and turns that broader idea into a narrower landing page with concrete wording, cleaner structure, and a calmer route into action. The aim is not to replace teacher judgement. It is to reduce blank-page stress while keeping the teacher fully in control.
...
Best practices for protecting student privacy when using third-party AI services. The issue is rarely just the words on screen. It is the uncertainty around how the message will be received, whether it could escalate things, and whether it will create more follow-up work next week.
...
If you need the broader context first, go back to [Safeguarding Student Data When Using AI Tools](/blog/ai-student-data-safeguards). If you need a wider cluster of parent communication pages, open [the hub](/teacher-parent-communication-hub). If you already know the task and want a calmer first draft, try [Zaza Draft](/early-access).

## FAQ

### Is this page different from Safeguarding Student Data When Using AI Tools?
...
- [Read the source blog: Safeguarding Student Data When Using AI Tools](/blog/ai-student-data-safeguards)
