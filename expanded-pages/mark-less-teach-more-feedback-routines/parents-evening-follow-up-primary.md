...
description: >-
  ...
  with calm examples, safer wording, and a clear route back to Mark Less, Teach
  More: Live feedback routines that build student thinking and Zaza Draft.
seedSlug: mark-less-teach-more-feedback-routines
variant: parents-evening-follow-up-primary
sourceBlogTitle: "Mark Less, Teach More: Live feedback routines that build student thinking"
sourceBlogSlug: mark-less-teach-more-feedback-routines
...
If you need the broader context first, go back to [Mark Less, Teach More: Live feedback routines that build student thinking](/blog/mark-less-teach-more-feedback-routines). If you need a wider cluster of parent communication pages, open [the hub](/teacher-parent-communication-hub). If you already know the task and want a calmer first draft, try [Zaza Draft](/early-access).

## FAQ

### Is this page different from Mark Less, Teach More: Live feedback routines that build student thinking?
...
- [Read the source blog: Mark Less, Teach More: Live feedback routines that build student thinking](/blog/mark-less-teach-more-feedback-routines)
