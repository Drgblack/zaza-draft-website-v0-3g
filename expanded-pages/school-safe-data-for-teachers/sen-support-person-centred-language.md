...
description: >-
  ...
  calm examples, safer wording, and a clear route back to Data You Can Trust:
  How school-safe AI actually works and Zaza Draft.
seedSlug: school-safe-data-for-teachers
variant: sen-support-person-centred-language
sourceBlogTitle: "Data You Can Trust: How school-safe AI actually works"
sourceBlogSlug: school-safe-data-for-teachers
...
This page expands on [Data You Can Trust: How school-safe AI actually works](/blog/school-safe-data-for-teachers) and turns that broader idea into a narrower landing page with concrete wording, cleaner structure, and a calmer route into action. The aim is not to replace teacher judgement. It is to reduce blank-page stress while keeping the teacher fully in control.
...
A plain-English guide for teachers. What to paste, what to keep out, and how to ask vendors the right questions so AI stays safe and useful. The issue is rarely just the words on screen. It is the uncertainty around how the message will be received, whether it could escalate things, and whether it will create more follow-up work next week.
...
If you need the broader context first, go back to [Data You Can Trust: How school-safe AI actually works](/blog/school-safe-data-for-teachers). If you need a wider cluster of parent communication pages, open [the hub](/teacher-parent-communication-hub). If you already know the task and want a calmer first draft, try [Zaza Draft](/early-access).

## FAQ

### Is this page different from Data You Can Trust: How school-safe AI actually works?
...
- [Read the source blog: Data You Can Trust: How school-safe AI actually works](/blog/school-safe-data-for-teachers)
