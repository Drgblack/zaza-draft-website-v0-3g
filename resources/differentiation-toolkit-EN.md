...
## Why Differentiation Feels Impossible (And How to Make It Work)

You have 30 students. They read at 7 different levels. Three have IEPs. Five are English language learners. Two are gifted and bored. One has ADHD. And you're supposed to differentiate for all of them? Every day?
...
- **Low-prep, high-impact moves** that don't require hours of planning

> **Who this is for:** K-12 teachers who want to reach every student without spending every waking hour creating 47 versions of the same lesson.

---

## The 4 Levers of Differentiation

### Lever 1: CONTENT (What Students Learn)

**The Idea:** Not all students need to learn the same content at the same time in the same depth.
...
### Lever 2: PROCESS (How Students Learn)

**The Idea:** Students process information differently. Some need visuals, some need movement, some need talk time.
...
**Pro Tip:** Change groups every 2-3 weeks so students don't feel "tracked."
...
- "This reminds me of..."
- Lowers the barrier for ELLs and shy students
...
- **Hands-On:** Let students manipulate something (model, drawing, movement)

---

### Lever 3: PRODUCT (How Students Show Learning)

**The Idea:** Not everyone shows mastery the same way. An essay isn't the only option.
...
**Example (Learning Goal: Explain the water cycle):**
| Draw and label the cycle | Write a song/rap | Create a comic strip |
| Record a video explanation | Build a 3D model | Interview a "water droplet" |
| Write a story from a droplet's POV | Make a poster | Design a quiz for classmates |
...
- **T**opic: What's the focus? (climate change, the American Revolution)
...
- **Advanced:** Complete 5 examples + explain why/create a new one
...
### Lever 4: ENVIRONMENT (Where and How Students Work)

**The Idea:** Physical and emotional environment impacts learning. Small tweaks make a big difference.
...
- Let students choose based on their needs
...
## Low-Prep Differentiation: The "Quick Adjust" Method

Don't have time to plan 3 tiers? Use these on-the-fly adjustments:
...
## Choice Board Template (Editable)

**Topic:** [Your Unit/Lesson]  
...
- Audio/video options for assignments
...
- Break assignments into smaller steps with checkpoints
...
- Compacting (skip what they've mastered, move to new content)
...
- Allow alternate ways to share (written vs. verbal)

---

## FAQ

**Q: How do I differentiate in a class of 35 students?**  
Focus on systems, not individual plans. Use tiered assignments, choice boards, and flexible grouping. You can't personalize for 35, but you can create 3 pathways that cover most needs.

**Q: What if parents complain that their child is getting "different" work?**  
Emphasize that all students are working toward the same learning goals. Differentiation ensures every student is challenged appropriately - not given easier or harder goals, just different routes to success.

**Q: How do I grade differentiated assignments fairly?**  
Grade based on growth and mastery of the learning objective, not just the product. Use rubrics that focus on the goal, not the format.

**Q: What if I don't have time to plan tiered lessons?**  
Use the "Quick Adjust" method - same assignment, but adjust time, support, or complexity on the fly. Or use choice boards where students pick their own level of challenge.
...
Differentiation isn't about perfection. It's about progress. Every small adjustment you make - a sentence starter here, a choice board there, flexible seating in the corner - adds up.
