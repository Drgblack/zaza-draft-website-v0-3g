...
> 💡 **Fragen Sie sich vor Zuweisung von Hausaufgaben:** "Was ist der Zweck? Wird das Schülern beim Lernen helfen oder sie nur beschäftigen?"
...
> 💡 **Schlüsselbotschaft:** Lernen ist nicht etwas, das Sie am Abend vor einem Test tun. Es ist ein Zyklus, der beginnt, bevor die Klasse überhaupt beginnt.
...
☐ Kapitel zuerst überflogen
☐ Überschriften in Fragen verwandelt
☐ Schlüsselbegriffe hervorgehoben
☐ Randnotizen geschrieben
☐ Jeden Abschnitt zusammengefasst
☐ Mich am Ende selbst abgefragt
```
...
☐ **Finden Sie einen Lernplatz** - Ruhig, gute Beleuchtung, keine Ablenkungen (Telefon weglegen!)

☐ **Sammeln Sie Materialien** - Lehrbuch, Heft, Stifte, Ladegerät (damit Sie nicht ständig aufstehen müssen)

☐ **Prüfen Sie die Aufgabe** - Was ist fällig? Wann? Was ist das Ziel?

☐ **Planen Sie Ihre Zeit** - Schätzen Sie, wie lange jede Aufgabe dauern wird. Timer stellen, falls nötig.
...
✓ **Beginnen Sie mit der schwersten Sache** - Erledigen Sie schwere Sachen zuerst, wenn Ihr Gehirn frisch ist.

✓ **Machen Sie Pausen** - 25 Minuten arbeiten, 5 Minuten Pause. Wiederholen. (Das heißt Pomodoro-Technik.)

✓ **Eliminieren Sie Ablenkungen** - Benachrichtigungen ausschalten. Telefon in anderem Raum. Extra-Tabs schließen.

✓ **Zeigen Sie Ihre Arbeit** - Selbst wenn nicht erforderlich. Es hilft beim Denken und macht es einfacher, Fehler zu finden.

✓ **Bitten Sie um Hilfe, wenn Sie feststecken** - Verschwenden Sie keine 30 Minuten damit, ein Problem anzustarren. Verwenden Sie die "Loskomm-Leiter" (siehe unten).
...
```
MONTAG:
☐ Mathe-Arbeitsblatt (20 Min)
☐ Geschichte Kapitel 8 lesen (30 Min)

DIENSTAG:
☐ Naturwissenschafts-Labor-Fragen (15 Min)
☐ Englisch-Aufsatz-Gliederung beginnen (25 Min)

MITTWOCH:
☐ Mathe-Übungsprobleme (20 Min)
☐ Englisch-Gliederung beenden (20 Min)
...
✓ Ruhigen Platz und Materialien bereitstellen  
✓ Konsistente Hausaufgabenzeit festlegen  
✓ Fragen "Was ist dein Plan?" (nicht "Bist du fertig?")  
✓ Ihnen helfen, große Projekte aufzuteilen  
✓ Pausen und gesunde Gewohnheiten ermutigen  
✗ Nicht die Arbeit für sie machen  
✗ Nicht schweben oder mikromanagen  
...
**Geben Sie ihnen die Werkzeuge. Sehen Sie sie gedeihen.** 🎯
