...
**Beispiel:**
```
❌ SCHLECHT: "Schreibe Feedback für Max Mustermanns Aufsatz über Klimawandel. 
Er ist ein Achtklässler mit einem Förderplan für ADHS."

✅ GUT: "Schreibe Feedback für einen Achtklässler-Aufsatz über Klimawandel. 
...
**Was das bedeutet:**
- ✅ Verwenden Sie KI, um Feedback-Entwürfe zu generieren → SIE personalisieren und finalisieren
- ✅ Verwenden Sie KI, um Aufgabenideen zu erstellen → SIE passen sie für Ihre Schüler an
- ✅ Verwenden Sie KI, um Muster zu analysieren → SIE interpretieren und handeln
- ❌ Lassen Sie KI nicht Schülerarbeiten ohne Ihre Überprüfung bewerten
- ❌ Verwenden Sie KI-generierte Berichte nicht ohne Personalisierung
- ❌ Verlassen Sie sich nicht auf KI für Platzierungs- oder Interventionsentscheidungen
...
| ✅ ERLAUBT | ⚠️ ZUERST FRAGEN | ❌ NICHT ERLAUBT |
|------------|------------------|------------------|
...
**DSGVO-Konformität:**
- ☐ Ist dieses Tool von meinem Bezirk genehmigt?
- ☐ Hat das Tool eine Datenschutzrichtlinie?
- ☐ Anonymisiere ich alle Schülerinformationen?

**Schutz minderjähriger Schüler (unter 13 Jahren):**
- ☐ Erfordert dieses Tool elterliche Zustimmung?
- ☐ Teile ich Schülerarbeiten ohne Kennungen?

**Ihr beruflicher Schutz:**
- ☐ Habe ich dokumentiert, wie ich KI verwende?
- ☐ Habe ich Schulleitung/Eltern über meine KI-Nutzung informiert?
- ☐ Befolge ich die Bezirksrichtlinien zu Bildungstechnologie?
...
- ❌ KI bitten, den Aufsatz zu schreiben
- ✅ KI bitten, 5 mögliche Blickwinkel zum Thema zu brainstormen, dann wählen und entwickeln SIE einen

**Szenario 2: Sie verstehen die Aufgabe nicht**
- ❌ KI-Erklärung kopieren und einreichen
- ✅ KI bitten, es in einfacheren Worten zu erklären, dann Ihren Lehrer fragen, ob Sie richtig verstanden haben

**Szenario 3: Sie bearbeiten Ihre Arbeit**
- ❌ KI Ihre Sätze umschreiben lassen
- ✅ KI bitten, schwache Stellen zu identifizieren, dann verbessern SIE sie in Ihrer eigenen Stimme
...
✓ Ideen für Projekte oder Aufsätze brainstormen
✓ Übungsquizfragen generieren
✓ Grammatik und Rechtschreibung prüfen
✓ Schwierige Konzepte erklären lassen (nachdem Sie versucht haben, selbst zu verstehen)
✓ Lernleitfäden oder Karteikarten erstellen

WANN SIE KI NICHT VERWENDEN KÖNNEN:
✗ Vollständige Aufsätze, Berichte oder Aufgaben schreiben
✗ Hausaufgabenprobleme erledigen, ohne die Arbeit zu verstehen
✗ Während Tests, Prüfungen oder Klassenarbeiten (außer ich sage anders)
✗ Jedes Mal, wenn ich ausdrücklich sage "Keine KI bei dieser Aufgabe"
...
**Lehren Sie sie, das Werkzeug zu nutzen. Aber noch wichtiger, lehren Sie sie zu denken.** 🧠
