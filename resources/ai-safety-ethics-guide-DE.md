...
- **Gesprächseinstiege** zur Diskussion von KI-Ethik mit Schülern
- **Klassenraum-Richtlinienvorlagen**, die Sie anpassen und teilen können

> **Für wen ist das:** Lehrkräfte der Klassen 1-12, die KI als Lernwerkzeug nutzen möchten, während sie die Sicherheit, Privatsphäre und akademische Integrität der Schüler schützen.

---

## Die 5 unverzichtbaren Regeln für KI in der Bildung

### Regel 1: Niemals persönliche Schülerinformationen in KI-Tools eingeben
...
### Regel 2: KI unterstützt, Menschen entscheiden
...
- âŒ Lassen Sie KI nicht Schülerarbeiten ohne Ihre Überprüfung bewerten
- âŒ Verwenden Sie KI-generierte Berichte nicht ohne Personalisierung
- âŒ Verlassen Sie sich nicht auf KI für Platzierungs- oder Interventionsentscheidungen

**Warum es wichtig ist:** KI kennt Ihre Schüler nicht. Sie sieht nicht den Kontext, das Wachstum oder die Menschlichkeit. Sie schon.
...
- Schützt Sie rechtlich und professionell
...
### Regel 4: Lehren Sie Schülern den Unterschied zwischen "Nutzen" und "Betrügen"

**Die Herausforderung:** Schüler wissen nicht immer, wo die Grenze verläuft.

**Die Lösung:** Erstellen Sie klare, spezifische Richtlinien.
...
- KI ist ein Ausgangspunkt, keine endgültige Antwort
...
## Datenschutz von Schülern - Checkliste
...
> **Profi-Tipp:** Wenn Ihr Bezirk noch keine KI-Richtlinie hat, wird er bald eine haben. Dokumentieren Sie jetzt alles, was Sie tun, damit Sie zeigen können, dass Sie verantwortungsvoll und durchdacht waren.

---

## Akademische Integrität: Gesprächseinstiege für Schüler

### Gespräch Nr. 1: Warum ist akademische Integrität wichtig?
...
- KI ist ein Werkzeug, keine Abkürzung, um Lernen zu vermeiden

**Diskussionsfrage:** "Wenn KI Aufsätze in Sekunden schreiben kann, warum weisen wir sie noch zu? Was ist der Sinn?"

**Antwort:** Weil Schreiben Sie lehrt zu denken, Ideen zu organisieren und zu kommunizieren. Der Aufsatz ist das Übungsfeld. KI kann Sie nicht zu einem besseren Denker machen - nur Übung kann das.

---

### Gespräch Nr. 2: Was ist das echte Risiko von KI-Betrug?
...
**Die Botschaft:** "Es lohnt sich nicht. Wenn Sie Schwierigkeiten haben, bitten Sie um Hilfe. Wenn Sie überwältigt sind, bitten Sie um eine Verlängerung. Das sind immer bessere Optionen als Betrug."

---

### Gespräch Nr. 3: Wie können Sie KI verantwortungsvoll nutzen?
...
**Die Regel:** KI sollte Ihnen helfen, besser zu denken, nicht für Sie zu denken.
...
âœ“ Ideen für Projekte oder Aufsätze brainstormen
âœ“ Übungsquizfragen generieren
âœ“ Grammatik und Rechtschreibung prüfen
âœ“ Schwierige Konzepte erklären lassen (nachdem Sie versucht haben, selbst zu verstehen)
âœ“ Lernleitfäden oder Karteikarten erstellen

WANN SIE KI NICHT VERWENDEN KÖNNEN:
âœ- Vollständige Aufsätze, Berichte oder Aufgaben schreiben
âœ- Hausaufgabenprobleme erledigen, ohne die Arbeit zu verstehen
âœ- Während Tests, Prüfungen oder Klassenarbeiten (außer ich sage anders)
âœ- Jedes Mal, wenn ich ausdrücklich sage "Keine KI bei dieser Aufgabe"
...
## FAQ: Lehrkräfte-Edition

**F: Sollte ich KI vollständig verbieten?**  
Nein. Schüler werden sie sowieso verwenden. Besser, sie ihnen beizubringen, sie verantwortungsvoll zu nutzen und ihnen sichere Übung unter Ihrer Anleitung zu geben.

**F: Was, wenn mein Bezirk keine KI-Richtlinie hat?**  
Erstellen Sie Ihre eigene Klassenraum-Richtlinie (verwenden Sie die obige Vorlage) und teilen Sie sie mit der Schulleitung. Seien Sie transparent, dokumentieren Sie alles und konzentrieren Sie sich auf Schülersicherheit.

**F: Welche KI-Tools SIND sicher für Schüler?**  
Prüfen Sie mit Ihrer Bezirks-IT-Abteilung. Einige Schulen genehmigen Tools wie Googles Gemini for Education, Microsofts Copilot for Education oder Khan Academys Khanmigo, weil sie integrierten Schülerdatenschutz haben.

**F: Wie bewerte ich Aufgaben, wenn ich KI-Nutzung vermute?**  
Haben Sie zuerst ein Gespräch. Bitten Sie den Schüler, seinen Prozess zu erklären. Oft lernen Sie, dass sie KI aus Verwirrung unangemessen verwendet haben, nicht aus Böswilligkeit. Nutzen Sie es als Lehrmoment.

**F: Was ist mit Schülern mit Förderplänen, die KI als Anpassung benötigen?**  
Unterstützende Technologie (wie Text-zu-Sprache, Sprache-zu-Text oder Grammarly) unterscheidet sich von der Verwendung von KI zur Inhaltsgenerierung. Respektieren Sie immer Anpassungen. Bei Grauzonen konsultieren Sie Ihr Förderschul-Team.
...
KI wird nicht verschwinden. Tatsächlich wird sie mächtiger und mehr in das tägliche Leben integriert werden. Unsere Aufgabe als Pädagogen ist es, Schüler darauf vorzubereiten, sie weise, ethisch und kritisch zu nutzen.

**Sie müssen kein KI-Experte sein, um KI-Ethik zu lehren.** Sie müssen nur ehrlich, nachdenklich und bereit sein, zusammen mit Ihren Schülern zu lernen.

Die Schüler, die lernen, KI verantwortungsvoll zu nutzen, werden einen massiven Vorteil in Hochschule und Karriere haben. Die Schüler, die es nicht tun, werden Schwierigkeiten haben. Das ist unsere Chance, einen Unterschied zu machen.
