...
It's report card season. You have 90 comments to write, a deadline looming, and every blank comment box feels like writer's block.

You want to write something meaningful - not generic. But you also don't have 6 hours to craft poetic paragraphs about every student's learning journey.

**The problem:** Writing 90 unique, professional, specific comments takes forever. And by student #47, they all start to sound the same.
...
- **Differentiation tips** for special education, ELL, and gifted students
- **AI prompts** to speed up comment writing even more

> **Who this is for:** Any teacher writing report cards, progress reports, or narrative assessments who wants to be specific and professional without sacrificing their weekend.

---

## The Anatomy of a Great Report Card Comment

Before you grab a template, here's what makes a comment valuable to parents and students:
...
## Section 1: English Language Arts Comments
...
## Section 2: Mathematics Comments
...
## Section 4: Social Studies Comments
...
## Section 5: Work Habits & Social-Emotional Comments
...
## Section 6: Specialized Populations
...
## Section 7: AI Prompts for Custom Comments

Want to write comments even faster? Use these prompts with ChatGPT, Claude, or Zaza Draft:

### Prompt Template 1: Strength + Growth Comment

```
Act as a [grade level] teacher. Write a report card comment for [student name] in [subject].

Include:
- One specific strength (use an example from class: [describe example])
- One area for growth
- One actionable next step for the student and family
...
### Prompt Template 2: Balanced Comment (All Subjects)

```
Write a balanced report card comment for [student name], a [grade level] student.

Context:
- Strengths: [list 2-3 specific strengths]
- Challenges: [list 1-2 challenges]
- Work habits: [on-task / easily distracted / completes work / needs reminders]

Include a specific next step and vary the language to avoid sounding generic.

Tone: Honest but kind
Length: 80-100 words
```

---

### Prompt Template 3: Comment Bank Generator

```
Create a comment bank for [grade level] [subject] with 5 comments each for:
- Exceeding expectations
- Meeting expectations
- Approaching expectations

Each comment should:
- Be specific and varied (no repetition)
- Include a strength and a next step
- Be 50-70 words
...
**Q: Will parents know I used a template?**  
Not if you customize it. Add the student's name, a specific example, and adjust the wording. Parents care about specificity, not originality.

**Q: How do I write comments for students I barely know?**  
Use data (grades, test scores, observation notes) and ask yourself: What's one thing I've noticed? What's one thing they could improve? That's your comment.

**Q: What if I have 120 students?**  
Batch by performance level. Write all "exceeding" comments first, then "meeting," and so on. Use AI prompts to speed up drafts.

**Q: Can I be honest about behavior issues?**  
Yes - but frame it constructively. Instead of "disruptive," try "learning to manage [his/her/their] energy and focus in class." Include what you're doing to support them.

**Q: How do I write comments for students with IEPs?**  
Focus on progress toward IEP goals. Be positive but honest. Collaborate with the special education team if needed.

---

## Bonus: Quick Subject Line Templates

Sometimes you need a short subject line or summary comment. Use these one-liners:

- "Exceeding grade-level expectations across all areas."
- "Meeting expectations with consistent effort and growth."
- "Approaching grade-level expectations; benefits from additional support."
- "Strong reader and critical thinker; continue challenging [him/her/them]."
- "Building foundational skills with targeted intervention and encouragement."

---

## Closing Thoughts

Report cards don't have to take over your life.

These templates aren't about cutting corners. They're about working smarter so you can write comments that are helpful, specific, and professional - without burning out.
