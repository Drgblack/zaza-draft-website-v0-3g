...
- **Student self-assessment tools** so they learn to evaluate their own work

> **Who this is for:** K-12 teachers who grade essays, projects, tests, or presentations and want to provide feedback that actually improves student learning - without drowning in 4-hour grading sessions.

---

## The 6 Feedback Methods

### Method 1: The 3+1 Framework
...
NEXT STEP:
[One actionable improvement with how-to guidance]
```
...
2. You backed up your claim with the Pew Research stat about screen time (paragraph 2). Strong use of evidence.
3. Your conclusion circles back to your opening question - that's effective framing.

NEXT STEP:
Add a counterargument in paragraph 3. Try: "Some might say social media helps teens connect, but research shows..." This will make your argument more sophisticated.
```

---

### Method 2: Glow and Grow
...
- Students use the master list to decode and revise

**Why it works:** You write each comment once, use it 100 times. Cuts grading time in half.

**Sample Code Bank (Essay Writing):**
| Code | Meaning | Student Action |
|------|---------|----------------|
| **T** | Thesis unclear | Rewrite your thesis as a single, arguable sentence |
...
### Method 5: Question-Based Feedback
...
Next draft goal: [One specific focus area]
```
...
Next draft goal: Add one counterargument with your rebuttal.
```

---

### Method 6: Rubric + Narrative
...
OVERALL FEEDBACK:
[1 sentence: biggest strength]
[1 sentence: what impressed you]
[1-2 sentences: next steps for growth]
...
OVERALL FEEDBACK:
Your organization was excellent - the flow from intro to body to conclusion was seamless. I was particularly impressed by your use of the Brookings Institute report; that elevated your argument. For next time, work on integrating quotes smoothly (avoid "dropped quotes"). You're a strong writer - keep pushing yourself to analyze deeply, not just summarize.
```

---

## Feedback Templates by Assignment Type
...
Let's revise this together. See me during office hours.
```
...
GROW: [One specific improvement for next time]
```
...
TECHNICAL SKILL:
[Craftsmanship, technique, attention to detail]

IMPACT:
[How does it make the viewer feel/think?]

NEXT LEVEL:
[One stretch goal for their next project]
```
...
4. Now grade individual papers focusing ONLY on unique feedback
...
### Tool 1: Pre-Submission Checklist

Have students complete this BEFORE turning in work:
...
**Why it works:** Students catch 60-70% of basic errors before you even see the work. Reduces your grading load.

---

### Tool 2: Glow-Grow Self-Reflection

After receiving your feedback, students complete:

```
AFTER READING FEEDBACK:

What I'm proud of (Glow):
[Student writes their own strengths]

What I'll improve next time (Grow):
...
**Why it works:** Turns feedback into action. Students own their growth.
...
**Fix:** Be specific. "Good job" becomes "Your use of the metaphor in line 12 made the theme come alive."
...
**Fix:** Choose the 1-2 most important areas for growth. Save the rest for next time.
...
**Fix:** Guide, don't dictate. "This sentence is unclear. Try rewriting it to include the three main stages of the water cycle."
...
**Fix:** Set a 48-72 hour return policy. If you can't hit that, adjust your assignment load.
...
**Why it works:** Your brain gets in a rhythm. You're faster and more consistent.
...
**Warning:** Never let AI grade for you. Use it to draft, then YOU finalize.
...
**Q: What if students don't read my feedback?**  
Make feedback a required step. Students must respond to your feedback (self-reflection tool) or revise based on it (revision assignment) to earn full credit.

**Q: How do I balance feedback speed with quality?**  
Use tiered feedback (see Strategy 4). Not every assignment needs a novel-length response.

**Q: Should I grade everything students turn in?**  
No. Grade selectively. Practice work can receive check/check-plus/check-minus or no grade at all (just feedback).

**Q: What if a student's work is so bad I can't find strengths?**  
There's always something. "You turned it in on time" or "You attempted problem 3" counts. Start there, then guide them toward improvement.
