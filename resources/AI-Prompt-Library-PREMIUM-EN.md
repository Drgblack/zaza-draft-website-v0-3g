...
Before we dive into templates, here's the framework that makes prompts work:
...
## Part 1: Parent Communication Prompts

### 1.1 The Supportive Concern Email
...
- 2 specific next steps (one for home, one for school)
- 1 sentence highlighting a student strength
...
>
> I want to note that Alex participates thoughtfully during lessons and grasps concepts quickly when engaged. Let's build on that strength.
>
> Would you be available for a brief phone call this week to discuss further? I'm confident we can turn this around together.
>
> Best regards,  
> Ms. Thompson
...
### 1.2 The Behavior Incident Report (Objective)
...
Include:
- What was observed (specific behavior, no judgement words like "disrespectful" or "lazy")
- Impact on learning (for the student and/or class)
- Action taken in the moment
- Follow-up planned
- Brief invitation to talk
...
Context: During independent reading, Jamie left their seat 6 times in 15 minutes, talked loudly to peers, and threw paper airplanes.
...
Include:
- Specific moment or achievement (what happened, when)
- Why it matters (skill demonstrated or growth shown)
- Encouragement to celebrate at home
...
## Part 2: Student Feedback Prompts

### 2.1 Essay & Writing Feedback (3+1 Method)
...
THREE STRENGTHS (specific, encouraging):
1. Thesis clarity / hook / organization
2. Use of evidence / detail / examples
3. Voice / word choice / transitions

ONE NEXT STEP (concrete, actionable):
- What to improve and how

Tone: Encouraging but honest, student-friendly language
...
Provide:
- 2 specific strengths in their reasoning/work
- 1 concrete fix (identify the line where the error occurred and suggest what to do instead)
...
### 2.3 Project/Presentation Feedback
...
Use this rubric: [paste your rubric]

For each criterion:
- Note what was done well (specific example)
...
## Part 3: Lesson Planning Prompts
...
- Activity description (what students do)
- Duration (under 10 minutes)
- Materials needed
- A question that activates prior knowledge

At least one hook should be hands-on/kinesthetic.

Tone: Student-centered, engaging
```
...
Create supports for three learner levels:

APPROACHING:
- Sentence stems (3 examples)
- Visual support (what to provide)
...
EXTENDING:
- Challenge question or task
- Depth/complexity extension

Tone: Practical, teacher-ready
```
...
Generate 6 exit ticket questions:
- 2 recall questions (easy)
- 3 application questions (on-level)
- 1 extension question (challenge)

Format: Multiple choice OR short answer (specify which you prefer)
```

---

## Part 4: Rubrics & Assessment Prompts
...
Original rubric: [paste your rubric]

For each criterion:
- Convert to "I can..." statement
- Add a one-line "Next step to improve"

Reading level: [grade level]
Tone: Clear, empowering
```

---

### 4.2 Comment Bank Generator
...
Generate 5 comments for each level:
...
- Vary in wording (no repetition)
- Be 1-2 sentences
- Include a "next step" where appropriate
...
## Part 5: Time-Saving Utility Prompts
...
[Paste your long instructions here]

Format: Numbered list, action verbs, under 30 words total
```
...
[Paste: What you taught, a highlight, upcoming work]

Tone: Warm, parent-friendly
Include: One specific way parents can support at home
```
...
## Part 7: Zaza Draft Integration Tips
...
4. Review the output and adjust constraints if needed
...
**Q: Will AI replace my judgement?**  
No. These prompts help you draft faster. You still review, edit, and add your personal touch.

**Q: Can I trust AI-generated feedback?**  
Use AI to draft, but always verify. With Zaza Draft, built-in safeguards prevent hallucinations.

**Q: How do I avoid sounding robotic?**  
Always edit AI output to match your voice. Add personal details AI can't know.

**Q: What if my school blocks AI tools?**  
These prompts work with any AI tool. If you're at home or using Zaza Draft (designed for schools), you're good to go.

---

## Closing Thoughts

Great prompts are like great lesson plans: they're adaptable, evidence-based, and save you time without cutting corners.
