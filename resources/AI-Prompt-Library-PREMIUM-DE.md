...
- Ihnen tatsächlich **Zeit sparen**, anstatt mehr Arbeit zu schaffen

> **Für wen das ist:** K-12-Lehrkräfte, Lehrerführungskräfte, Unterrichtscoaches und alle, die Eltern-E-Mails, Schülerfeedback oder Unterrichtspläne schreiben - und es schneller tun möchten, ohne Qualität zu opfern.

---

## Die Anatomie eines großartigen Prompts

Bevor wir uns in Vorlagen vertiefen, hier ist das Framework, das Prompts funktionieren lässt:
...
> ðŸ’¡ **Profi-Tipp:** Beginnen Sie mit Rolle + Aufgabe + einer Einschränkung. Überprüfen Sie die Ausgabe. Dann fügen Sie mehr Einschränkungen hinzu, um zu verfeinern. Versuchen Sie nicht, beim ersten Versuch den perfekten Prompt zu schreiben.
...
## Teil 1: Elternkommunikations-Prompts

### 1.1 Die unterstützende Anliegen-E-Mail
...
Einschließen:
- Kurze sachliche Beschreibung (2-3 Sätze)
- 2 spezifische nächste Schritte (einer für zu Hause, einer für Schule)
- 1 Satz, der eine Schülerstärke hervorhebt
- Einladung zu weiterem Gespräch

Ton: Professionell, kollaborativ, lösungsorientiert
...
>
> Ich möchte anmerken, dass Alex während des Unterrichts nachdenklich teilnimmt und Konzepte schnell erfasst, wenn engagiert. Lassen Sie uns auf dieser Stärke aufbauen.
>
> Hätten Sie diese Woche Zeit für ein kurzes Telefonat, um weiter zu besprechen? Ich bin zuversichtlich, dass wir das gemeinsam umkehren können.
>
> Viele Grüße,  
> Frau Thompson
...
### 1.2 Der Verhaltensvorfall-Bericht (Objektiv)
...
Einschließen:
- Was beobachtet wurde (spezifisches Verhalten, keine Urteilswörter wie "respektlos" oder "faul")
- Auswirkung auf Lernen (für den Schüler und/oder Klasse)
- Im Moment ergriffene Maßnahme
- Geplante Nachbereitung
- Kurze Einladung zum Gespräch

Ton: Neutral, sachlich, professionell
...
Kontext: Während des selbstständigen Lesens verließ Jamie 6 Mal in 15 Minuten den Platz, sprach laut mit Mitschülern und warf Papierflieger.
...
### 1.3 Das positive Update (Beziehungen aufbauen)
...
Einschließen:
- Spezifischer Moment oder Leistung (was passierte, wann)
- Warum es wichtig ist (demonstrierte Fähigkeit oder gezeigtes Wachstum)
- Ermutigung, zu Hause zu feiern

Ton: Warm, authentisch, kurz
Länge: 60-100 Wörter
```
...
>
> Bitte gratulieren Sie ihr zu Hause - sie hat es verdient!
>
> Viele Grüße,  
> Herr Davis
...
## Teil 2: Schülerfeedback-Prompts

### 2.1 Aufsatz- & Schreibfeedback (3+1-Methode)
...
DREI STÄRKEN (spezifisch, ermutigend):
1. These-Klarheit / Hook / Organisation
2. Verwendung von Beweisen / Detail / Beispielen
3. Stimme / Wortwahl / Übergänge

EIN NÄCHSTER SCHRITT (konkret, umsetzbar):
- Was zu verbessern ist und wie

Ton: Ermutigend aber ehrlich, schülerfreundliche Sprache
Länge: 80-120 Wörter gesamt

[Schüleraufsatz hier einfügen]
```
...
>
> **Nächster Schritt:**
> Füge ein Gegenargument in Absatz 3 hinzu. Versuche: "Einige könnten sagen, soziale Medien helfen Teenagern sich zu verbinden, aber Forschung zeigt..." Dies wird dein Argument noch stärker machen.
>
> Note: 2+ (Tolle Arbeit - noch ein Schritt zur 1!)
...
Bereitstellen:
- 2 spezifische Stärken in der Argumentation/Arbeit
- 1 konkrete Korrektur (identifiziere die Zeile, wo der Fehler auftrat, und schlage vor, was stattdessen zu tun ist)

Ton: Ermutigend, präzise
Länge: 60-80 Wörter
...
### 2.3 Projekt-/Präsentationsfeedback
...
Verwende diese Rubrik: [deine Rubrik einfügen]

Für jedes Kriterium:
- Notiere, was gut gemacht wurde (spezifisches Beispiel)
- Schlage eine Verbesserung vor

Ton: Konstruktiv, spezifisch
Länge: 100-150 Wörter
```

---

## Teil 3: Unterrichtsplanungs-Prompts
...
Für jeden Einstieg einschließen:
- Aktivitätsbeschreibung (was Schüler tun)
- Dauer (unter 10 Minuten)
- Benötigte Materialien
- Eine Frage, die Vorwissen aktiviert

Mindestens ein Einstieg sollte praktisch/kinästhetisch sein.

Ton: Schülerzentriert, ansprechend
```
...
Erstelle Unterstützungen für drei Lernstufen:

ANNÄHERND:
- Satzanfänge (3 Beispiele)
- Visuelle Unterstützung (was bereitzustellen)
- Vereinfachte Erfolgskriterien

AUF NIVEAU:
- Standard-Scaffolds
- Peer-Zusammenarbeitsstrategie

ERWEITERND:
- Herausforderungsfrage oder Aufgabe
- Tiefen-/Komplexitätserweiterung

Ton: Praktisch, lehrerfertig
```
...
Generiere 6 Exit-Ticket-Fragen:
- 2 Erinnerungsfragen (einfach)
- 3 Anwendungsfragen (auf Niveau)
- 1 Erweiterungsfrage (Herausforderung)

Format: Multiple Choice ODER Kurzantwort (gebe an, welche du bevorzugst)
```

---

## Teil 4: Rubriken & Bewertungs-Prompts
...
Original-Rubrik: [deine Rubrik einfügen]

Für jedes Kriterium:
- In "Ich kann..."-Aussage konvertieren
- Einzeiligen "Nächsten Schritt zur Verbesserung" hinzufügen
...
Generiere 5 Kommentare für jede Stufe:
...
- Spezifisch und ermutigend sein
- In Formulierung variieren (keine Wiederholung)
- 1-2 Sätze umfassen
- Wo angemessen einen "nächsten Schritt" einschließen

Ton: Professionell, konstruktiv
```

---

## Teil 5: Zeitsparende Utility-Prompts
...
[Deine langen Anweisungen hier einfügen]

Format: Nummerierte Liste, Aktionsverben, unter 30 Wörter gesamt
```
...
- 3 Kern (Anwendung)
- 1 Erweiterung (Synthese/Analyse)
...
[Einfügen: Was Sie gelehrt haben, ein Highlight, kommende Arbeit]

Ton: Warm, elternfreundlich
Einschließen: Eine spezifische Art, wie Eltern zu Hause unterstützen können
```

---

## Teil 6: Fortgeschrittene Prompting-Techniken
...
## Teil 7: Zaza Draft Integrationstipps
...
4. Überprüfen Sie die Ausgabe und passen Sie Einschränkungen bei Bedarf an
...
**F: Wird KI mein Urteilsvermögen ersetzen?**  
Nein. Diese Prompts helfen Ihnen, schneller zu entwerfen. Sie überprüfen, bearbeiten und fügen immer noch Ihre persönliche Note hinzu.

**F: Kann ich KI-generiertem Feedback vertrauen?**  
Verwenden Sie KI zum Entwerfen, aber überprüfen Sie immer. Mit Zaza Draft verhindern integrierte Schutzmaßnahmen Halluzinationen.

**F: Wie vermeide ich, roboterhaft zu klingen?**  
Bearbeiten Sie immer KI-Ausgabe, um Ihrer Stimme zu entsprechen. Fügen Sie persönliche Details hinzu, die KI nicht kennen kann.

**F: Was, wenn meine Schule KI-Tools blockiert?**  
Diese Prompts funktionieren mit jedem KI-Tool. Wenn Sie zu Hause sind oder Zaza Draft verwenden (für Schulen konzipiert), sind Sie gut aufgestellt.

---

## Abschließende Gedanken

Großartige Prompts sind wie großartige Unterrichtspläne: Sie sind anpassbar, evidenzbasiert und sparen Ihnen Zeit, ohne Abkürzungen zu nehmen.

Beginnen Sie klein. Testen Sie diese Woche einen Prompt. Verfeinern Sie ihn. Dann fügen Sie einen weiteren hinzu. Bevor Sie es wissen, haben Sie eine persönliche Bibliothek von Prompts, die sich anfühlt, als hätten Sie einen Unterrichtsassistenten in Ihrer Tasche.
