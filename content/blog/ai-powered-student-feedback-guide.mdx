...
✅ **Start small** - Begin with one subject or assignment type
✅ **Maintain your voice** - Edit AI feedback to match your communication style
✅ **Include student names** - Personalization makes feedback more impactful
✅ **Focus on specific behaviors** - AI can identify patterns in student work
✅ **Connect to learning goals** - Link feedback to class objectives

### Don'ts:

❌ **Don't use AI feedback unedited** - Always review and adjust
❌ **Don't replace all human interaction** - Some conversations need your personal touch
❌ **Don't ignore student preferences** - Some students prefer different feedback styles
❌ **Don't forget to celebrate** - AI should highlight student successes too
