...
``` **Pro Tip:** This hack works especially well for math and reading assessments where you have concrete data points. ## Hack #4: The "Strength-Based Pivot" Every student has strengths. Use AI to find and highlight them: ```
...
``` **Before:** *"John struggles with math facts and often gets frustrated during problem-solving activities."* **After:** *"John brings strong critical thinking skills to math problem-solving and shows excellent perseverance when working through challenges. We're building on his analytical strengths to develop automaticity with math facts through games and visual strategies. His thoughtful approach to learning will serve him well as these foundational skills become more automatic."* ## Hack #5: The "Time-Saver Template Bank" Create reusable AI templates for common scenarios: ### Template A: Strong Student
````
...
```### Template C: Inconsistent Student
...
`## Bonus: The "Parent Partnership" Closer End every comment with connection, not just information:`
